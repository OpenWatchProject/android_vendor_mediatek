...
public class ExportProcessor extends ProcessorBase {
    ...
    private void doProgressNotification(Uri uri, int totalCount, int currentCount) {
        /* M: [Google Issue][ALPS04189190], 1/2
         * original code: @{
        final String displayName = uri.getLastPathSegment();
         * @} new code: @{ */
        final String displayName = ExportVCardActivity.getOpenableUriDisplayName(mService, uri);
        /* @} */
    ...
    private void doCancelNotification() {
        ...
        /* M: [Google Issue][ALPS04189190], 2/2
         * original code: @{
         ...
         * @} new code: @{ */
        final String description = mService.getString(R.string.exporting_vcard_canceled_title,
                ExportVCardActivity.getOpenableUriDisplayName(mService, mExportRequest.destUri));
        /* @} */
        final Notification notification =
