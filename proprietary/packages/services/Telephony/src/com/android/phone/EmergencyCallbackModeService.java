...
public class EmergencyCallbackModeService extends Service {
    ...
    public void onDestroy() {
        ...
        // Enter ECBM then force restart phone process.
        // In this case EmergencyCallbackModeService has no chance to cancel ECBM notication.
        // So after phone process restart, ECBM notification still exist.
        // Solution:
        // Phone process will restart EmergencyCallbackModeService after itself restart,
        // But because phone is null now, service will destory and still not cancel notification.
        // Change to force cancel notification when EmergencyCallbackModeService onDestroy.
