 ...
 */
    ...
    public final static String FEATURE_ST_GROUP_CHACT = "org.3gpp.urn:urn-7:3gppapplication.ims.iari.rcs.fullsfgroupchat";

    public final static String FEATURE_SOCIAL_PRESENCE_INFO = "org.3gpp.urn:urn-7:3gpp-application.ims.iari.rcse.sp";

    public final static String FEATURE_GEOLOCATION_PULL = "org.3gpp.urn:urn-7:3gpp-application.ims.iari.rcs.geopullft";

    public final static String FEATURE_GEOLOCATION_PUSH = "org.3gpp.urn:urn-7:3gpp-application.ims.iari.rcs.geopush";

    public final static String FEATURE_CHATBOT = "org.3gpp.urn:urn-7:3gppapplication.ims.iari.rcs.chatbot";

    public final static String FEATURE_CHATBOT_SA = "org.3gpp.urn:urn-7:3gppapplication.ims.iari.rcs.chatbot.sa";

    public final static String FEATURE_CHATBOT_ROLE = "org.gsma.rcs.isbot";

    public final static String FEATURE_CALLCOMPOSER = "org.3gpp.urn:urn-7:3gppservice.ims.icsi.gsma.callcomposer";
}
