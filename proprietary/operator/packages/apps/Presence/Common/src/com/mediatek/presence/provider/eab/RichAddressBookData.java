...
public class RichAddressBookData {
     ...
     * Database URI
     */
    static final Uri CONTENT_URI = Uri.parse("content://com.mediatek.presence.eab/eab");
     ...
     * Column name
     */
    static final String KEY_CAPABILITY_VIDEO_SHARING_CS = "Capability_Video_Sharing_Cs";

    /**
     * Column name
     */
    static final String KEY_CAPABILITY_VIDEO_SHARING_OUTSIDE_VOICE_CALL =
            "Capability_Video_Sharing_Outside_VoiceCall";

    /**
     * Column name
     */
    static final String KEY_CAPABILITY_GEOLOCATION_PULL_FT = "Capability_Geolocation_Pull_Ft";

    /**
     * Column name
     */
    static final String KEY_CAPABILITY_GEOLOCATION_PULL = "Capability_Geolocation_Pull";

    /**
     * Column name
     */
    static final String KEY_CAPABILITY_RCS_VOICE_CALL = "Capability_Rcs_VoiceCall";

    /**
     * Column name
     */
    static final String KEY_CAPABILITY_RCS_VIDEO_CALL = "Capability_Rcs_VideoCall";

    /**
     * Column name
     */
    static final String KEY_CAPABILITY_RCS_VIDEO_ONLY_CALL = "Capability_Rcs_VideoOnlyCall";
     ...
     */
    static final String KEY_CAPABILITY_IR94_VOICE_CALL =  CapabilitiesLog.CAPABILITY_IR94_VOICE_CALL;
    static final String KEY_CAPABILITY_IR94_VIDEO_CALL =  CapabilitiesLog.CAPABILITY_IR94_VIDEO_CALL;
    static final String KEY_CAPABILITY_IR94_DUPLEX_MODE = CapabilitiesLog.CAPABILITY_IR94_DUPLEX_MODE;

    /**
     * Burn after reading
     */
    public static final String KEY_CAPABILITY_BURN_AFTER_READING = CapabilitiesLog.CAPABILITY_BURN_AFTER_READING;

    /**
     * Standalone Msg.
     */
    public static final String KEY_CAPABILITY_STANDALONE_MSG = "capability_standalone_msg";

    /**
     * Contact SIP URI.
     */
    public static final String KEY_CONTACT_SIP_URI = "contact_sip_uri";

    /**
     * Chatbot
     */
    public static final String KEY_CAPABILITY_CHATBOT = "chatbot";
    public static final String KEY_CAPABILITY_CHATBOT_SA = "chatbot_sa";

    /**
     * enriched calling
     */
    public static final String KEY_CAPABILITY_CALLCOMPOSER = "callcomposer";
