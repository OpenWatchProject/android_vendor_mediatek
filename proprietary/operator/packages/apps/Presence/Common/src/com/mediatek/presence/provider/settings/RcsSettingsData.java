...
public class RcsSettingsData {
     ...
     * Database URI
     */
    static final Uri CONTENT_URI_SLOT0 = Uri.parse("content://com.mediatek.presence.settings/slot0settings");
    static final Uri CONTENT_URI_SLOT1 = Uri.parse("content://com.mediatek.presence.settings/slot1settings");
    static final Uri RCS_CLIENT_SETTING_URI =
...
/**@*/
 ...
 /**
    ...
    /**
     * Capability refresh timeout used to decide when to refresh non_rcs contact capabilities
     */
    public static final String NON_RCS_CAPABILITY_EXPIRY_TIMEOUT = "NonRcsCapabilityExpiryTimeout";
    ...
    /**
     * Video sharing during a CS call support
     */
    public static final String CAPABILITY_VIDEO_SHARING_CS = "CapabilityVideoSharingCs";

    /**
     * Video sharing outside of voice call support
     */
    public static final String CAPABILITY_VIDEO_SHARING_OUTSIDE_VOICE_CALL =
            "CapabilityVideoSharingOutsideVoiceCall";

    /**
     * IP Geo location Pull using File Transfer support
     */
    public static final String CAPABILITY_GEOLOCATION_PULL_FT = "CapabilityGeolocationPullFt";

    /**
     * IP Geo location Pull support
     */
    public static final String CAPABILITY_GEOLOCATION_PULL = "CapabilityGeolocationPull";

    /**
     * RCS IP Voice call support
     */
    public static final String CAPABILITY_RCS_VOICE_CALL = "CapabilityRcsVoiceCall";

    /**
     * RCS IP Video call support
     */
    public static final String CAPABILITY_RCS_VIDEO_CALL = "CapabilityRcsVideoCall";

    /**
     * RCS IP Video only call support
     */
    public static final String CAPABILITY_RCS_VIDEO_ONLY_CALL = "CapabilityRcsVideoOnlyCall";
   ...
   */
    ...
    public static final String PROFILE_AUTH = "profileAuth";


    public static final String NAB_AUTH = "nabAuth";


    public static final String PUBLIC_ACCOUNT_AUTH = "publicAccountAuth";


    public static final String SSO_AUTH = "ssoAuth";


    public static final String PROFILE_ADDRESS = "profileAddress";


    public static final String PROFILE_ADDRESS_PORT = "profileAddressPort";


    public static final String PROFILE_ADDRESS_TYPE = "ProfileAddressType";


    public static final String NAB_ADDRESS = "nabAddress";


    public static final String NAB_ADDRESS_PORT = "nabAddressPort";


    public static final String NAB_ADDRESS_TYPE = "nabAddressType";


    public static final String PUBLIC_ACCOUNT_ADDRESS = "publicAccountAddress";


    public static final String PUBLIC_ACCOUNT_ADDRESS_PORT = "publicAccountAddressPort";


    public static final String PUBLIC_ACCOUNT_ADDRESS_TYPE = "publicAccountAddressType";


    public static final String SSO_ADDRESS = "SSOAddress";


    public static final String SSO_ADDRESS_PORT = "SSOAddressPort";


    public static final String SSO_ADDRESS_TYPE = "SSOAddressType";
    ...
    public static final String PUBLIC_USER_IDENTITY_2 = "publicUserIdentity3";

    public static final String PUBLIC_USER_IDENTITY_3 = "publicUserIdentity2";
    ...
    public static final String ENABLE_RCS_SWITCH = "enableRcsSwitch";
    ...
    */
    ...
    public static final String SIP_489_BAD_EVENT_STATE = "SipBadEventState";

    public static final String SIP_489_BAD_EVENT_TIME = "SipBadEventTime";

    public static final String SIP_489_BAD_EVENT_EXPIRED_TIME = "SipBadEventExpiredTime";

    public static final String CHATBOT_SUPPORT = "ChatbotSupport";

    public static final String CHATBOT_SA_SUPPORT = "ChatbotSaSupport";

    public static final String BOT_VERSION = "BotVersion";
    
    public static final String CALLCOMPOSER_SUPPORT = "CallcomposerSupport";
