...
typedef struct {
    ...
    MUINT32 u4UdmUpperISO;
    MUINT32 u4UdmLowerISO;
    MUINT16 u2UdmUpperIdx;
    MUINT16 u2UdmLowerIdx;
    MUINT32 u4AnrUpperISO;
    MUINT32 u4AnrLowerISO;
    MUINT16 u2AnrUpperIdx;
    MUINT16 u2AnrLowerIdx;
    MUINT16 u2Anr2UpperIdx;
    MUINT16 u2Anr2LowerIdx;
    MUINT32 u4CcrUpperISO;
    MUINT32 u4CcrLowerISO;
    MUINT16 u2CcrUpperIdx;
    MUINT16 u2CcrLowerIdx;
...
typedef struct
{
    ...
    EFlash_T isFlash; //0: no flash, 1: image with flash
...
public:
    RAWIspCamInfo()
        ...
        , eIdx_ISO_U(eIDX_ISO_100)
        , eIdx_ISO_L(eIDX_ISO_100)
        , eIdx_Zoom(eIDX_ZOOM_0)
