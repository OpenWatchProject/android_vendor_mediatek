...
#define P1_BUFFER_SIZE 4000   //2591     CAM_BNR_D_PDC_POS-CAM_CTL_START    = 687C - 4000 =287C  = 2591
#define P2_BUFFER_SIZE 4000   //2458     CAM_REG_BOK_RSV1-CAM_CTL_START    =7BBC - 4000 = 3BBC  = 3823
#define P1_REG_SIZE 4000
#define ISP_DEBUG_TAG_VERSION (9)
#define ISP_DEBUG_TAG_SUBVERSION (0)

enum { IspDebugTagVersion = ((ISP_DEBUG_TAG_SUBVERSION << 16)|ISP_DEBUG_TAG_VERSION) };
...
typedef struct IspExifDebugInfo
{
    ...
    struct P1RegInfo
    {
        ...
        MUINT32         u4Offset; // to skip isp reg reserved data
    } P1RegInfo;
