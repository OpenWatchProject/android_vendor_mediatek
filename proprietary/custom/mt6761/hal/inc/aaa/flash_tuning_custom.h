...
int cust_fillDefaultStrobeNVRam_main_second2 (void* data);
int cust_fillDefaultStrobeNVRam_main_third (void* data);
int cust_fillDefaultStrobeNVRam_main_third2 (void* data);
int cust_fillDefaultStrobeNVRam_sub_second (void* data);
int cust_fillDefaultStrobeNVRam_sub_second2 (void* data);
...
int cust_fillDefaultFlashCalibrationNVRam_main_second2(void* data);
int cust_fillDefaultFlashCalibrationNVRam_main_third(void* data);
int cust_fillDefaultFlashCalibrationNVRam_main_third2(void* data);
int cust_fillDefaultFlashCalibrationNVRam_sub_second(void* data);
int cust_fillDefaultFlashCalibrationNVRam_sub_second2(void* data);
...
void cust_getFlashMaxIDuty_main2(int dutyNum, int dutyNumLt, int* duty, int* dutyLt);
void cust_getFlashMaxIDuty_sub(int dutyNum, int dutyNumLt, int* duty, int* dutyLt);
void cust_getFlashMaxIDuty_sub2(int dutyNum, int dutyNumLt, int* duty, int* dutyLt);
...
void cust_getGoldenAvgY_main(short* avgY);
void cust_getGoldenAvgY_main2(short* avgY);
void cust_getGoldenAvgY_sub(short* avgY);
void cust_getGoldenAvgY_sub2(short* avgY);
...
void cust_getGoldenAvgY(int sensorDev, short* avgY);
