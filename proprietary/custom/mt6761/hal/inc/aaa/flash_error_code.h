...
#define E_FLASH_CALI_ENVIRONMENT_WRONG_Y_IS_LOW_ERR MTKFLASH_ERRCODE(0x0082)

#define E_FLASH_CALI_ENVIRONMENT_NOT_CONSTANT_ERR		MTKFLASH_ERRCODE(0x0085)
#define E_FLASH_CALI_UNDEREXPOSURE_ERR		MTKFLASH_ERRCODE(0x0086)
#define E_FLASH_CALI_OFFEST_ABS_TOO_LARGE		MTKFLASH_ERRCODE(0x0087)

#define E_FLASH_CALI_UNIT_GAIN_VARIANCE_ERR MTKFLASH_ERRCODE(0x0090)
