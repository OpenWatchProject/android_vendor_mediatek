...
#define YUV_INFO(_id, name, getCalData)\
    { \
    1, _id, name, \
    NSFeature::YUVSensorInfoWithoutTuning<_id>::createInstance(name, #name), \
    NSFeature::SensorInfoIdxMgr<_id>::getDefaultData, \
    getCalData, \
    }
#define RAW_INFO(_id, name, getCalData)\
    { \
    0, _id, name, \
    NSFeature::RAWSensorInfoWithoutTuning<_id>::createInstance(name, #name), \
    NSFeature::SensorInfoIdxMgr<_id>::getDefaultData, \
    getCalData, \
    }
...
/*IMX*/
    ...
    RAW_INFO(IMX499_SENSOR_ID, SENSOR_DRVNAME_IMX499_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(IMX499_MIPI_RAW_13M)
    RAW_INFO(IMX499_SENSOR_ID, SENSOR_DRVNAME_IMX499_MIPI_RAW_13M, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO(IMX398_SENSOR_ID, SENSOR_DRVNAME_IMX398_MIPI_RAW, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO(IMX386_MONO_SENSOR_ID, SENSOR_DRVNAME_IMX386_MIPI_MONO, NULL/*CAM_CALGetCalData*/),
#endif
#if defined(IMX362_MIPI_RAW)
    RAW_INFO(IMX362_SENSOR_ID, SENSOR_DRVNAME_IMX362_MIPI_RAW, NULL),
#endif
#if defined(IMX338_MIPI_RAW)
    RAW_INFO(IMX338_SENSOR_ID, SENSOR_DRVNAME_IMX338_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(IMX318_MIPI_RAW)
    RAW_INFO(IMX318_SENSOR_ID, SENSOR_DRVNAME_IMX318_MIPI_RAW, NULL),
#endif
#if defined(IMX377_MIPI_RAW)
    RAW_INFO(IMX377_SENSOR_ID, SENSOR_DRVNAME_IMX377_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(IMX230_MIPI_RAW)
    RAW_INFO(IMX230_SENSOR_ID, SENSOR_DRVNAME_IMX230_MIPI_RAW,NULL),
#endif
    ...
    RAW_INFO(IMX214_SENSOR_ID, SENSOR_DRVNAME_IMX214_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(IMX214_MIPI_MONO)
    RAW_INFO(IMX214_MONO_SENSOR_ID, SENSOR_DRVNAME_IMX214_MIPI_MONO, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO(IMX258_MONO_SENSOR_ID, SENSOR_DRVNAME_IMX258_MIPI_MONO, NULL/*CAM_CALGetCalData*/),
#endif
...
/*OV (OmniVision)*/
    ...
    RAW_INFO(OV13855_SENSOR_ID, SENSOR_DRVNAME_OV13855_MIPI_RAW,NULL),
#endif
#if defined(OV13850_MIPI_RAW)
    RAW_INFO(OV13850_SENSOR_ID, SENSOR_DRVNAME_OV13850_MIPI_RAW,NULL),
#endif
#if defined(OV12A10_MIPI_RAW)
    RAW_INFO(OV12A10_SENSOR_ID, SENSOR_DRVNAME_OV12A10_MIPI_RAW,NULL),
#endif
    ...
    RAW_INFO(OV8858_SENSOR_ID, SENSOR_DRVNAME_OV8858_MIPI_RAW, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO(OV5670MIPI_SENSOR_ID_2, SENSOR_DRVNAME_OV5670_MIPI_RAW_2, NULL),
#endif
    ...
    RAW_INFO(OV23850_SENSOR_ID, SENSOR_DRVNAME_OV23850_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(OV20880_MIPI_RAW)
    RAW_INFO(OV20880MIPI_SENSOR_ID, SENSOR_DRVNAME_OV20880_MIPI_RAW, NULL),
#endif
/*S5K*/
#if defined(S5K3P8SP_MIPI_RAW)
    RAW_INFO(S5K3P8SP_SENSOR_ID, SENSOR_DRVNAME_S5K3P8SP_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(S5K2T7SP_MIPI_RAW)
    RAW_INFO(S5K2T7SP_SENSOR_ID, SENSOR_DRVNAME_S5K2T7SP_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(S5K2T7SP_MIPI_RAW_5M)
    RAW_INFO(S5K2T7SP_SENSOR_ID, SENSOR_DRVNAME_S5K2T7SP_MIPI_RAW_5M, CAM_CALGetCalData),
#endif
#if defined(S5K4E6_MIPI_RAW)
    RAW_INFO(S5K4E6_SENSOR_ID, SENSOR_DRVNAME_S5K4E6_MIPI_RAW, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO(S5K3L6_SENSOR_ID, SENSOR_DRVNAME_S5K3L6_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(S5K3L8_MIPI_RAW)
    RAW_INFO(S5K3L8_SENSOR_ID, SENSOR_DRVNAME_S5K3L8_MIPI_RAW, NULL),
#endif
#if defined(S5K3M3_MIPI_RAW)
    RAW_INFO(S5K3M3_SENSOR_ID, SENSOR_DRVNAME_S5K3M3_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(S5K2P7_MIPI_RAW)
    RAW_INFO(S5K2P7_SENSOR_ID, SENSOR_DRVNAME_S5K2P7_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(S5K2P8_MIPI_RAW)
    RAW_INFO(S5K2P8_SENSOR_ID, SENSOR_DRVNAME_S5K2P8_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(S5K3P3SX_MIPI_RAW)
    RAW_INFO(S5K3P3SX_SENSOR_ID, SENSOR_DRVNAME_S5K3P3SX_MIPI_RAW, NULL),
#endif
#if defined(S5K2X8_MIPI_RAW)
    RAW_INFO(S5K2X8_SENSOR_ID, SENSOR_DRVNAME_S5K2X8_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(S5K3M2_MIPI_RAW)
    RAW_INFO(S5K3M2_SENSOR_ID, SENSOR_DRVNAME_S5K3M2_MIPI_RAW, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO(S5K5E2YA_SENSOR_ID, SENSOR_DRVNAME_S5K5E2YA_MIPI_RAW, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO(S5K5E8YXREAR2_SENSOR_ID, SENSOR_DRVNAME_S5K5E8YXREAR2_MIPI_RAW, NULL),
#endif
/*HI*/
...
/*GC*/
    ...
    RAW_INFO(GC5035_SENSOR_ID, SENSOR_DRVNAME_GC5035MIPI_RAW, NULL),
#endif
#if defined(GC2375H_MIPI_RAW)
    RAW_INFO(GC2375H_SENSOR_ID, SENSOR_DRVNAME_GC2375H_MIPI_RAW, NULL),
#endif
    ...
    RAW_INFO(GC8C34_SENSOR_ID, SENSOR_DRVNAME_GC8C34_MIPI_RAW, NULL),
#endif
#if defined(GC8034_MIPI_RAW)
    RAW_INFO(GC8034_SENSOR_ID, SENSOR_DRVNAME_GC8034_MIPI_RAW, CAM_CALGetCalData),
#endif
/*SP*/
#if defined(SP250A_MIPI_RAW)
    RAW_INFO(SP250A_SENSOR_ID, SENSOR_DRVNAME_SP250A_MIPI_RAW, NULL),
#endif
