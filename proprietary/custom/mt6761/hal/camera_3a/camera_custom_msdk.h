...
void GetLensDefaultPara(MUINT32 SensorId, PNVRAM_LENS_PARA_STRUCT pLensParaDefault);

int msdkGetFlickerPara(MUINT32 SensorId, int SensorMode, void* buf, int binRatio = 1);
