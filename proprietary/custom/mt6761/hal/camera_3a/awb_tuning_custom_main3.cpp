...
template <>
MBOOL
isAWBEnabled<ESensorDev_MainThird>()
{
    return MTRUE;
}
...
template <>
AWB_PARAM_T const&
getAWBParam<ESensorDev_MainThird>(MUINT32 imgsensor_id)
#else
template <>
AWB_PARAM_T const&
getAWBParam<ESensorDev_MainThird>()
#endif
{
...
getAWBStatParam<ESensorDev_MainThird>()
{
