...
MINT32 isEnableNSL2(MUINT32 u4SensorDev __unused)
{
    if(TUNING_FOR_AIS) {
        return 1;
    }
...
MINT32 isEnableSL2(MUINT32 u4SensorDev __unused)
{
    if(TUNING_FOR_AIS) {
        return 1;
    }
...
MINT32 isLscTransformFromCapture(MUINT32 u4SensorDev __unused)
{
    return 0;
}
