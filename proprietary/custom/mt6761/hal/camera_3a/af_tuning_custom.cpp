...
_getAFParam( AF_PARAM_T const **outAFParam)
{
    ...
    AAA_LOGD( "%s : dev(%d) use default setting, 0x%x, tbl_size(%d)",
              __FUNCTION__,
              eSensorDev,
              (*outAFParam),
              (*outAFParam)->i4TBLL);
...
_getAFConfig( AF_CONFIG_T const **outAFCfg)
{
    ...
    AAA_LOGD( "%s : dev(%d) use default setting, 0x%x, AF_EXT_ENABLE(%d)",
              __FUNCTION__,
              eSensorDev,
              (*outAFCfg),
...
_getAFExtendCoef( MINT32 w, MINT32 h, MINT32 SensorId, CustAF_THRES_T const **outCustAFThr)
{
    ...
    AAA_LOGD( "%s : dev(%d) use default setting, 0x%x, ISONum(%d)",
              __FUNCTION__,
              eSensorDev,
              (*outCustAFThr),
