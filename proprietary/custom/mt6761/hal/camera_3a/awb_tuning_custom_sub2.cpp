...
template <>
MBOOL
isAWBEnabled<ESensorDev_SubSecond>()
{
    return MTRUE;
}
...
template <>
AWB_PARAM_T const&
getAWBParam<ESensorDev_SubSecond>(MUINT32 imgsensor_id)
#else
template <>
AWB_PARAM_T const&
getAWBParam<ESensorDev_SubSecond>()
#endif
{
...
getAWBStatParam<ESensorDev_SubSecond>()
{
