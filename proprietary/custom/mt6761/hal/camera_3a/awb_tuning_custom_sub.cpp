...
template <>
AWB_PARAM_T const&
getAWBParam<ESensorDev_Sub>(MUINT32 imgsensor_id)
#else
template <>
AWB_PARAM_T const&
...
#endif
{
        ...
        // AWB light source weight LUT for warm fluorescent
    	{
    		...
    		{// LUT: use green offset (0~2000) as index to get fluorescent0 weight (x/256)
    	     //  0  200  400  600  800 1000 1200 1400 1600 1800 2000
    	       192, 192, 224, 256, 128,  64,  32,  16,  16,  16,  16
    		}
    	},
    ...
    static AWB_PARAM_T rAWBParam =
    {
        ...
        // AWB light source weight LUT for warm fluorescent
    	{
    		...
    		{// LUT: use green offset (0~2000) as index to get fluorescent0 weight (x/256)
    	     //  0  200  400  600  800 1000 1200 1400 1600 1800 2000
    	     //  64, 192, 224, 256, 128,  64,  32,  16,  16,  16,  16
			 64, 192, 224, 256, 256,  256,  256,  128,  64,  32,  16
    		}
    	},
        // AWB light source weight LUT for shade light
    	{
