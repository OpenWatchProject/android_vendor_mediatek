...
LOCAL_MODULE := libcustom_hal_for_hi556_tuning_headers
...
LOCAL_HEADER_LIBRARIES += libcustom_hal_for_hi556_tuning_headers
# End of common part ---------------------------------------
...
LOCAL_MODULE := libcustom_hal_for_hi556_mgx_headers
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
#-----------------------------------------------------------
include $(BUILD_HEADER_LIBRARY)
...
LOCAL_HEADER_LIBRARIES += liblog_headers libutils_headers
LOCAL_HEADER_LIBRARIES += libcustom_hal_for_hi556_mgx_headers
