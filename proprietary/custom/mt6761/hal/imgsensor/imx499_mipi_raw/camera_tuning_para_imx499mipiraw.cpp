...
#include "AE_Tuning_Para/camera_ae_tuning_para_imx499mipiraw.h"
#include "AWB_Tuning_Para/camera_awb_tuning_para_imx499mipiraw.h"
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        getAENVRAM_imx499mipiraw<CAM_SCENARIO_PREVIEW>(),
        getAENVRAM_imx499mipiraw<CAM_SCENARIO_VIDEO>(),
        getAENVRAM_imx499mipiraw<CAM_SCENARIO_CAPTURE>(),
        getAENVRAM_imx499mipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAENVRAM_imx499mipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAENVRAM_imx499mipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAENVRAM_imx499mipiraw<CAM_SCENARIO_CUSTOM4>()
    },

        // AWB NVRAM
    AWB_NVRAM_START
    {
        getAWBNVRAM_imx499mipiraw<CAM_SCENARIO_PREVIEW>(),
        getAWBNVRAM_imx499mipiraw<CAM_SCENARIO_VIDEO>(),
        getAWBNVRAM_imx499mipiraw<CAM_SCENARIO_CAPTURE>(),
        getAWBNVRAM_imx499mipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAWBNVRAM_imx499mipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAWBNVRAM_imx499mipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAWBNVRAM_imx499mipiraw<CAM_SCENARIO_CUSTOM4>()
                    },
