...
LOCAL_MODULE := libcustom_hal_for_gc2375h_tuning_headers
...
#$(info local LOCAL_EXPORT_C_INCLUDE_DIRS = $(LOCAL_EXPORT_C_INCLUDE_DIRS))
...
LOCAL_HEADER_LIBRARIES += libcustom_hal_for_gc2375h_tuning_headers
# End of common part ---------------------------------------
...
LOCAL_MODULE := libcustom_hal_for_gc2375h_mgx_headers
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
#-----------------------------------------------------------
include $(BUILD_HEADER_LIBRARY)
...
LOCAL_HEADER_LIBRARIES += liblog_headers libutils_headers
LOCAL_HEADER_LIBRARIES += libcustom_hal_for_gc2375h_mgx_headers
