...
STATIC_METADATA2_BEGIN(PLATFORM, MODULE, SENSOR_DRVNAME_OV8856_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.control
//------------------------------------------------------------------------------
    //==========================================================================
...
#if (1 == HDR_SUPPORTED && !MTKCAM_LOW_MEM)
...
STATIC_METADATA2_BEGIN(PLATFORM, MOD_OVERWRITE, SENSOR_DRVNAME_OV8856_MIPI_RAW)
