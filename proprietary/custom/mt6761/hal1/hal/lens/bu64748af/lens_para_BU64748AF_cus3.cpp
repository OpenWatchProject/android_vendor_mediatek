...
GET_BU64748AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>() // binning-size vdo record
{
    static NVRAM_LENS_DATA_PARA_STRUCT BU64748AF_LENS_PARA_DEFAULT_VALUE =
    {
        // File Path
        {
            __FILE__
    ...
    return BU64748AF_LENS_PARA_DEFAULT_VALUE;
}
