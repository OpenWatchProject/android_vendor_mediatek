...
GET_LC898217AF_T_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>() // binning-size vdo record
{
    static NVRAM_LENS_DATA_PARA_STRUCT LC898217AF_T_LENS_PARA_DEFAULT_VALUE =
    {
        // File Path
        {
            __FILE__
    ...
    return LC898217AF_T_LENS_PARA_DEFAULT_VALUE;
}
