...
struct StereoResolution
{
    ...
    MSize   szMain1;            // main1 rrz size
    MSize   szMain2;            // main2 rrz size

    MBOOL   bUseSensorMaxMain1FullSz;   // if yes, use max sensor width to crop capture size
    MSize   szMain1_Full;               // if bUseSensorMaxMain1FullSz = no, use szMain1_Full for capture size

    MUINT32 uRatioDenomerator;  //16        4
    MUINT32 uRatioNumerator;    //9         3
    MBOOL   bCropMaxMain1FullSz;
    MRect   main1FullSz_crop;
    StereoResolution()
    {
        ...
        bUseSensorMaxMain1FullSz = MTRUE;
        szMain1_Full = MSize(3072, 1728);
        uRatioDenomerator = 16;
        uRatioNumerator = 9;
        bCropMaxMain1FullSz =MTRUE;
        main1FullSz_crop = MRect(MPoint(0,396),MSize(4208,2366));
    }
    StereoResolution(MBOOL UseSensorMaxCropSz,
                               MRect p1_rrz_crop1, MRect p1_rrz_crop2,
                               MSize szMain1Cam, MSize szMain2Cam,
                               MBOOL UseSensorMaxMain1FullSz, MSize szMain1Cam_full,
                               MUINT32 uRatioD, MUINT32 uRatioN,
                               MBOOL CropMaxMain1FullSz, MRect Main1Camfull_crop)
    {
        ...
        szMain1 = szMain1Cam;
        szMain2 = szMain2Cam;
        bUseSensorMaxMain1FullSz = UseSensorMaxMain1FullSz;
        szMain1_Full = szMain1Cam_full;
        uRatioDenomerator = uRatioD;
        uRatioNumerator = uRatioN;
        bCropMaxMain1FullSz = CropMaxMain1FullSz;
        main1FullSz_crop = Main1Camfull_crop;
    }
};
