...
#define AF_PARAM_REVISION 8225008
...
typedef struct AF_AREA_t
{
    ...
    AF_AREA_t()
    {
        i4Count = 0;
        i4Score = 0;
        for(int i = 0 ; i < AF_WIN_NUM_SPOT ; i++)
        {
            sRect[i]    = AREA_t(0,0,0,0,0);
            i4Id[i]     = 0;
            i4Type[i]   = 0;

            i4Motion[i][0] = i4Motion[i][1] = 0;
            i4Landmark[i][0][0] = i4Landmark[i][0][1] = i4Landmark[i][0][2]= i4Landmark[i][0][3] = 0;
            i4Landmark[i][1][0] = i4Landmark[i][1][1] = i4Landmark[i][1][2]= i4Landmark[i][1][3] = 0;
            i4Landmark[i][2][0] = i4Landmark[i][2][1] = i4Landmark[i][2][2]= i4Landmark[i][2][3] = 0;
...
typedef struct
{
    ...
    MINT32 AF_FIL_H1[12];
    /*AF_FLT_7 ~ AF_FLT_8*/
    MINT32 AF_FIL_V[4]; /*[0]AF_VFLT_X0 ; [1]AF_VFLT_X1 ; [2]AF_VFLT_X2 ; [3] AF_VFLT_X3*/
...
typedef struct
{
    ...
    MUINT32 u4SizeBlkX;
    MUINT32 u4SizeBlkY;
    AF_STAT_T ptrStat[MAX_AF_HW_WIN];
