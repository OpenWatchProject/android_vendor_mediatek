...
#define AWB_PARAM_REVISION 5341001
...
typedef struct
{
    MINT32 i4RG;                            // R/G
    MINT32 i4BG;                            // B/G
    MINT32 i4LogRG;                         // LOG(R/G)
    MINT32 i4LogBG;                         // LOG(B/G)
    ...
    MINT32 i4GMOffset;                      // Green offset
...
typedef struct
{
    AWB_LV_THR_T rLvThr[AWB_LIGHT_NUM];
...
typedef struct
{
    ...
    MVOID *pAEHistBuf;  // Histogram buffer address
