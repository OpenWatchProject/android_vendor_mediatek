...
class PD_S5K2X8MIPIRAW : protected PDBufMgr
{
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Ctor/Dtor.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
protected :
    ...
    * @brief seprate LR PD
    */
    void seprate( unsigned int stride, unsigned char *ptr, int pd_x_num, int pd_y_num, unsigned short *ptrLROut, unsigned int bitDepth);
