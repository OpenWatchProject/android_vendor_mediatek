...
STATIC_METADATA2_BEGIN(DEVICE, SCALER, SENSOR_DRVNAME_OV23850_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.scaler
//------------------------------------------------------------------------------
    //==========================================================================
...
//    { "cropRegion",                    TYPE_INT32  },
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS)//new hidden
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //22mp 16:9
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //22mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(4224, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
#if 0
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //20mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(3168, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //20mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(4224, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
#endif
...
#if 1
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //22mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(3168, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //22mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(4224, MINT32)
                ...
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
#if 0
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //20mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(3168, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //20mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(4224, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
#endif
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //16mp 16:9
                CONFIG_ENTRY_VALUE(5376, MINT32)
                CONFIG_ENTRY_VALUE(3024, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT32) //22mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(3168, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT32) //22mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(4224, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_INPUT, MINT32)
                ...
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
#if 0
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT32) //20mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(3168, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT32) //20mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(4224, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
#endif
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT32) //16mp 16:9
                CONFIG_ENTRY_VALUE(5376, MINT32)
                CONFIG_ENTRY_VALUE(3024, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //22mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(3168, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //22mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(4224, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
#if 0
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //20mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(3168, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //20mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT32)
                CONFIG_ENTRY_VALUE(4224, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
#endif
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //16mp 16:9
                CONFIG_ENTRY_VALUE(5376, MINT32)
                CONFIG_ENTRY_VALUE(3024, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT32) //16mp 4:3
                CONFIG_ENTRY_VALUE(4032, MINT32)
                CONFIG_ENTRY_VALUE(3024, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_MIN_FRAME_DURATIONS)//new hidden
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64) //22mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT64)
                CONFIG_ENTRY_VALUE(3168, MINT64)
                CONFIG_ENTRY_VALUE(66666666, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64) //22mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT64)
                CONFIG_ENTRY_VALUE(4224, MINT64)
                CONFIG_ENTRY_VALUE(66666666, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64) //16mp 16:9
                CONFIG_ENTRY_VALUE(5376, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64) //22mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT64)
                CONFIG_ENTRY_VALUE(3168, MINT64)
                CONFIG_ENTRY_VALUE(100000000, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64) //22mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT64)
                CONFIG_ENTRY_VALUE(4224, MINT64)
                CONFIG_ENTRY_VALUE(100000000, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT64) //22mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT64)
                CONFIG_ENTRY_VALUE(3168, MINT64)
                CONFIG_ENTRY_VALUE(100000000, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT64) //22mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT64)
                CONFIG_ENTRY_VALUE(4224, MINT64)
                CONFIG_ENTRY_VALUE(100000000, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT64) //22mp 16:9
                CONFIG_ENTRY_VALUE(5632, MINT64)
                CONFIG_ENTRY_VALUE(3168, MINT64)
                CONFIG_ENTRY_VALUE(100000000, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT64) //22mp 4:3
                CONFIG_ENTRY_VALUE(5632, MINT64)
                CONFIG_ENTRY_VALUE(4224, MINT64)
                CONFIG_ENTRY_VALUE(100000000, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT64) //16mp 16:9
                CONFIG_ENTRY_VALUE(5376, MINT64)
                CONFIG_ENTRY_VALUE(3024, MINT64)
                CONFIG_ENTRY_VALUE(100000000, MINT64)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YV12, MINT64) //16mp 4:3
                CONFIG_ENTRY_VALUE(4032, MINT64)
                CONFIG_ENTRY_VALUE(3024, MINT64)
                CONFIG_ENTRY_VALUE(100000000, MINT64)
    ...
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_REPROCESS_MAX_CAPTURE_STALL)//new public
