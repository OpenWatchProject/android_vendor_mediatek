...
#undef LOG_TAG
#endif
#define LOG_TAG "pd_buf_mgr_s5k3l8mipiraw"

PDBufMgr*
PD_S5K3L8MIPIRAW::getInstance()
{
    static PD_S5K3L8MIPIRAW singleton;
    return &singleton;

}


PD_S5K3L8MIPIRAW::PD_S5K3L8MIPIRAW()
{
    AAA_LOGD("[PD Mgr] S5K3L8\n");
    m_PDBufSz = 0;
    m_PDBuf   = NULL;
    m_PDXSz   = 0;
    m_PDYSz   = 0;
...
MBOOL PD_S5K3L8MIPIRAW::IsSupport( SPDProfile_t &iPdProfile)
{
    MBOOL ret = MFALSE;
...
void PD_S5K3L8MIPIRAW::separate( int stride, unsigned char *ptr, int pd_x_num, int pd_y_num, unsigned short *ptrLROut, unsigned int bitDepth)
{
...
MUINT16* PD_S5K3L8MIPIRAW::ConvertPDBufFormat( MUINT32 /* i4Size */, MUINT32 i4Stride, MUINT8 *ptrBufAddr, MUINT32 u4BitDepth)
{
...
MBOOL PD_S5K3L8MIPIRAW::GetLRBufferInfo(MUINT32 &PDXsz, MUINT32 &PDYsz, MUINT32 &PDBufSz)
{
    PDXsz = m_PDXSz;
    PDYsz = m_PDYSz;
    PDBufSz = m_PDBufSz;
