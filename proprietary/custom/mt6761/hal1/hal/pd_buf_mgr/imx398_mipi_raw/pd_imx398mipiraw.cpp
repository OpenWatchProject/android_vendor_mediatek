...
MUINT16* PD_IMX398MIPIRAW::ConvertPDBufFormat( MUINT32 i4Size, MUINT32 i4Stride, MUINT8 *ptrBufAddr, MUINT32 u4BitDepth)
{
    /*******************************************
     * Input :
    ...
    AAA_LOGD_IF(m_bDebugEnable, "%s: va(%p) stride(%p)", __FUNCTION__, ptrBufAddr, i4Stride);
