...
#undef LOG_TAG
#endif
#define LOG_TAG "pd_buf_mgr_ov13855mipiraw"


PDBufMgr*
PD_OV13855MIPIRAW::getInstance()
{
    static PD_OV13855MIPIRAW singleton;
    return &singleton;
}

PD_OV13855MIPIRAW::PD_OV13855MIPIRAW()
{
    AAA_LOGD("OV13855");
    m_PDBufSz  = 0;
    m_PDBuf    = NULL;
...
void PD_OV13855MIPIRAW::seprate( int stride, unsigned char *ptr, int pd_x_num, int pd_y_num, int LROutSz, unsigned short *ptrLROut, unsigned int bitDepth)
{
...
MUINT16* PD_OV13855MIPIRAW::ConvertPDBufFormat( MUINT32 i4Size, MUINT32 i4Stride, MUINT8 *ptrBufAddr, MUINT32 u4BitDepth)
{
...
MBOOL PD_OV13855MIPIRAW::GetLRBufferInfo(MUINT32 &PDXsz, MUINT32 &PDYsz, MUINT32 &PDBufSz)
{
    PDXsz = m_PDXSz;
    PDYsz = m_PDYSz;
    PDBufSz = m_PDBufSz;
