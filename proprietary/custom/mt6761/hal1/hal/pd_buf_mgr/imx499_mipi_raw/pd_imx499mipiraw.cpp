...
MUINT16* PD_IMX499MIPIRAW::ConvertPDBufFormat( MUINT32 i4Size, MUINT32 i4Stride, MUINT8 *ptrBufAddr, MUINT32 u4BitDepth)
{
    AAA_LOGD("%s buffer info : size(%d), stride(%p) addr(%p) bitdepth(%d)",
             __FUNCTION__,
             i4Size,
             i4Stride,
             ptrBufAddr,
