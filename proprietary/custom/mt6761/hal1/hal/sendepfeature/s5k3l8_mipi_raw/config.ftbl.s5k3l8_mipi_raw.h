 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_S5K3L8_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::SCENE_MODE_NORMAL,
    ...
    //==========================================================================
#if 1
    //  Vsdof Scene Mode (if not define, app will use single cam setting)
    // for ISP3.x dualcam:
    // (1) hwsync does not support firework mode
    // (2) do not support Auto mode (due to auto mode will use ASD shot)
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_VSDOF_SCENE_MODE),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::SCENE_MODE_THEATRE),
            ITEM_AS_VALUES_(
                MtkCameraParameters::SCENE_MODE_PORTRAIT,
                MtkCameraParameters::SCENE_MODE_LANDSCAPE,
                MtkCameraParameters::SCENE_MODE_NIGHT,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "1920x1920",    "2560x1440",    "2576x1932",    "3264x2448",    "3328x1872",
                "2880x1728",    "3600x2160",    "4096x2304",    "4096x3072",    "4160x3120"
            )
        ),
    )
#endif
