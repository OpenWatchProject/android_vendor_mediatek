...
#include "SonyIMX519PdafLibraryWrapper.h"
#include <stdio.h>
#include <string.h>
...
#define LOG_TAG "SonyIMX519PdafLibraryWrapper"
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
SonyIMX519PdafLibraryWrapper::SonyIMX519PdafLibraryWrapper()
{
    // Initial parameters
    ...
    //
    memset( &m_PdProfile, 0, sizeof(SPDProfile_t));
    ...
    m_Libhandle = dlopen( "libSonyIMX519PdafLibrary.so", RTLD_NOW);
    error = dlerror();
    if( (m_Libhandle!=NULL)&&(error==NULL))
    {
        ...
        if( error==NULL)
        {
            ...
            if( error==NULL)
            {
                ...
                AAA_LOGD("dlopen libSonyIMX519PdafLibrary.so done. ver=%lu.%lu", ver.MajorVersion, ver.MinorVersion);
    ...
    {
        AAA_LOGE("dlopen libSonyIMX519PdafLibrary.so fail");
    }
    ...
    if( m_bLdDn)
    {
        ...
        m_pDefocusOKNGThrLine = new DefocusOKNGThrLine_t[D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL];
        m_pTransRectArgIn     = new SonyPdLibSensorCoordSetting_t;

        memset( m_pDefocusArgIn,               0, sizeof(PdLibInputData_t));
        memset( m_pDefocusOKNGThrLine,         0, sizeof(DefocusOKNGThrLine_t)*D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL);
        memset( m_pTransRectArgIn,             0, sizeof(SonyPdLibSensorCoordSetting_t));
        memset( m_aData_Slope,                 0, sizeof(signed long)*D_IMX519_SLOPE_OFFSET_BLK_NUM_TOTAL);
        memset( m_aData_Offset,                0, sizeof(signed long)*D_IMX519_SLOPE_OFFSET_BLK_NUM_TOTAL);
        memset( m_aXAddress_Knot_Slope_Offset, 0, sizeof(MUINT16)*D_IMX519_SLOPE_OFFSET_BLK_NUM_W);
        memset( m_aYAddress_Knot_Slope_Offset, 0, sizeof(MUINT16)*D_IMX519_SLOPE_OFFSET_BLK_NUM_H);

        DefocusOKNGThrLine_t *pDefocusOKNGThrLine = (DefocusOKNGThrLine_t *)m_pDefocusOKNGThrLine;
        for( unsigned int i=0; i<D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL; i++)
        {
            pDefocusOKNGThrLine[i].PointNum = D_IMX519_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM;
            pDefocusOKNGThrLine[i].p_AnalogGain = new unsigned long [D_IMX519_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM];
            pDefocusOKNGThrLine[i].p_Confidence = new unsigned long [D_IMX519_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM];
        }
    }
    else
    {
...
SonyIMX519PdafLibraryWrapper::~SonyIMX519PdafLibraryWrapper()
{
    if( m_bLdDn)
    {
        ...
        if( error==NULL)
        {
            AAA_LOGD("dlclose libSonyIMX519PdafLibrary.so done");
        }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX519PdafLibraryWrapper::DbgDumpSetting()
{
    if( m_bLdDn)
    {
        ...
        if( m_bDmpSetting)
        {
            ...
            AAA_LOGD("D_IMX519_DCC_IN_EEPROM_BLK_NUM_W                  : %d", D_IMX519_DCC_IN_EEPROM_BLK_NUM_W);
            AAA_LOGD("D_IMX519_DCC_IN_EEPROM_BLK_NUM_H                  : %d", D_IMX519_DCC_IN_EEPROM_BLK_NUM_H);
            AAA_LOGD("D_IMX519_DCC_IN_EEPROM_BLK_NUM_TOTAL              : %d", D_IMX519_DCC_IN_EEPROM_BLK_NUM_TOTAL);
            AAA_LOGD("D_IMX519_PD_AREA_OFFSET_X                         : %d", D_IMX519_PD_AREA_OFFSET_X);
            AAA_LOGD("D_IMX519_PD_AREA_OFFSET_Y                         : %d", D_IMX519_PD_AREA_OFFSET_Y);
            AAA_LOGD("D_IMX519_PD_AREA_SIZE_X                           : %d", D_IMX519_PD_AREA_SIZE_X);
            AAA_LOGD("D_IMX519_PD_AREA_SIZE_Y                           : %d", D_IMX519_PD_AREA_SIZE_Y);
            AAA_LOGD("D_IMX519_SLOPE_OFFSET_BLK_NUM_W                   : %d", D_IMX519_SLOPE_OFFSET_BLK_NUM_W);
            AAA_LOGD("D_IMX519_SLOPE_OFFSET_BLK_NUM_H                   : %d", D_IMX519_SLOPE_OFFSET_BLK_NUM_H);
            AAA_LOGD("D_IMX519_SLOPE_OFFSET_BLK_NUM_TOTAL               : %d", D_IMX519_SLOPE_OFFSET_BLK_NUM_TOTAL);
            AAA_LOGD("D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W          : %d", D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W);
            AAA_LOGD("D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H          : %d", D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H);
            AAA_LOGD("D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL      : %d", D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL);
            AAA_LOGD("D_IMX519_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM  : %d", D_IMX519_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM);
            AAA_LOGD("D_IMX519_AF_MOTOR_DRV_CONT_CODE_RESOLUTION        : %d", D_IMX519_AF_MOTOR_DRV_CONT_CODE_RESOLUTION);
            AAA_LOGD("D_IMX519_EXTRA_SHIFT_BIT                          : %d", D_IMX519_EXTRA_SHIFT_BIT);
            AAA_LOGD("\n");
            ...
            AAA_LOGD("binning_type_ext_en   : %d", pSensorSetting->binning_type_ext_en    );
            AAA_LOGD("binning_type_h_ext    : %d", pSensorSetting->binning_type_h_ext     );
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MRESULT SonyIMX519PdafLibraryWrapper::GetVersionOfPdafLibrary( SPDLibVersion_t &tOutSWVer)
{
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX519PdafLibraryWrapper::Init( SPDProfile_t &iPdProfile)
{
    if( m_bLdDn)
    {
        PdLibInputData_t *in = (PdLibInputData_t *)m_pDefocusArgIn;
        ...
        else if( iPdProfile.uImgXsz==2328 && iPdProfile.uImgYsz==1748)
        {
            /* V2 binning mode */
            m_u8SensMode = iPdProfile.AETargetMode==0 ? SENS_MODE2_NORMAL_V2_BINNING : SENS_MODE3_HDR_V2_BINNING ;
        }
        else if( iPdProfile.uImgXsz==1164 && iPdProfile.uImgYsz==874)
        {
            /* V4 binning mode */
        ...
        memcpy( &m_PdProfile, &iPdProfile, sizeof(SPDProfile_t));
         ...
         */
        for( MUINT32 i=0; i < D_IMX519_SLOPE_OFFSET_BLK_NUM_W; i++)
        {
            m_aXAddress_Knot_Slope_Offset[i] = (unsigned short)(D_IMX519_PD_AREA_OFFSET_X + (D_IMX519_PD_AREA_SIZE_X * i) + (D_IMX519_PD_AREA_SIZE_X / 2));
        }

        for( MUINT32 i=0; i < D_IMX519_SLOPE_OFFSET_BLK_NUM_H; i++)
        {
            m_aYAddress_Knot_Slope_Offset[i] = (unsigned short)(D_IMX519_PD_AREA_OFFSET_Y + (D_IMX519_PD_AREA_SIZE_Y * i) + (D_IMX519_PD_AREA_SIZE_Y / 2));
        }

        // Set the number of knots
        in->XKnotNumSlopeOffset = D_IMX519_SLOPE_OFFSET_BLK_NUM_W;
        in->YKnotNumSlopeOffset = D_IMX519_SLOPE_OFFSET_BLK_NUM_H;
         ...
         */
        // Set the number of knots
        in->XKnotNumDefocusOKNG = D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W;
        in->YKnotNumDefocusOKNG = D_IMX519_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H;
        ...
        MUINT16 knot_size_okng_x = (D_IMX519_ALL_PIXEL_SIZE_W-1) / (in->XKnotNumDefocusOKNG-1);
        MUINT16 knot_size_okng_y = (D_IMX519_ALL_PIXEL_SIZE_H-1) / (in->YKnotNumDefocusOKNG-1);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX519PdafLibraryWrapper::SetCaliData( MUINT32 u4CaliDaSz, MUINT8 *pCaliDaBuf, MUINT32 u4RegAddDaPairSz, MUINT16 *pRegAddDaPairBuf)
{
    MBOOL ret = MFALSE;

    if( m_bLdDn)
    {
        m_u4SlopeOffsetDaNum = D_IMX519_SLOPE_OFFSET_BLK_NUM_TOTAL;
        memset( m_aData_Slope,  0, sizeof(signed long)*D_IMX519_SLOPE_OFFSET_BLK_NUM_TOTAL);
        memset( m_aData_Offset, 0, sizeof(signed long)*D_IMX519_SLOPE_OFFSET_BLK_NUM_TOTAL);
        ...
        if( pCaliDaBuf!=NULL)
        {
            ...
            if( /* normal case */
                ...
                (D_IMX519_DCC_IN_EEPROM_BLK_NUM_W ==  D_IMX519_SLOPE_OFFSET_BLK_NUM_W) &&
                (D_IMX519_DCC_IN_EEPROM_BLK_NUM_H ==  D_IMX519_SLOPE_OFFSET_BLK_NUM_H) )
            {
                AAA_LOGD("%s num:%d, sz:%d Byte, directly use DCC", __FUNCTION__, m_u4SlopeOffsetDaNum, u4CaliDaSz);

                for( j=0, k=0; j<D_IMX519_SLOPE_OFFSET_BLK_NUM_H; j++)
                {
                    for( i=0; i<D_IMX519_SLOPE_OFFSET_BLK_NUM_W; i++, k++)
                    {
                        unsigned long idx = j*D_IMX519_DCC_IN_EEPROM_BLK_NUM_W*sizeof(signed short) + (2*i);
                ...
                (D_IMX519_DCC_IN_EEPROM_BLK_NUM_W*2 ==  D_IMX519_SLOPE_OFFSET_BLK_NUM_W) &&
                (D_IMX519_DCC_IN_EEPROM_BLK_NUM_H*2 ==  D_IMX519_SLOPE_OFFSET_BLK_NUM_H) )
            {
                ...
                for( j=0, k=0; j<D_IMX519_SLOPE_OFFSET_BLK_NUM_H; j++)
                {
                    for( i=0; i<D_IMX519_SLOPE_OFFSET_BLK_NUM_W; i++, k++)
                    {
                        unsigned long idx = (j/2)*D_IMX519_DCC_IN_EEPROM_BLK_NUM_W*sizeof(signed short) + (2*i/2);
                ...
                (D_IMX519_DCC_IN_EEPROM_BLK_NUM_H == 2*D_IMX519_SLOPE_OFFSET_BLK_NUM_H) )
            {
                ...
                for( j=0, k=0; j<D_IMX519_SLOPE_OFFSET_BLK_NUM_H; j++)
                {
                    for( i=0; i<D_IMX519_SLOPE_OFFSET_BLK_NUM_W; i++, k++)
                    {
                        unsigned long idx0 = (2*j  )*D_IMX519_DCC_IN_EEPROM_BLK_NUM_W*sizeof(signed short) + (2*2*i);
                        unsigned long idx1 = (2*j+1)*D_IMX519_DCC_IN_EEPROM_BLK_NUM_W*sizeof(signed short) + (2*2*i);
        ...
        if( ret==MFALSE)
        {
            AAA_LOGE("[%s] Cali data is not valid : %p sz=%lu(%u) W:%d(%d) H:%d(%d)",
                     ...
                     u4CaliDaSz,
                     D_IMX519_DCC_IN_EEPROM_BLK_NUM_W,
                     D_IMX519_SLOPE_OFFSET_BLK_NUM_W,
                     D_IMX519_DCC_IN_EEPROM_BLK_NUM_H,
                     D_IMX519_SLOPE_OFFSET_BLK_NUM_H);
        }
        ...
        if( ret)
        {
            MUINT8 reg_addr_0x38A4=0, reg_addr_0x38A5=0, reg_addr_0x38A6=0, reg_addr_0x38A7=0;
            MUINT8 reg_addr_0x38A8=0, reg_addr_0x38A9=0, reg_addr_0x38AA=0, reg_addr_0x38AB=0;
            ...
            for( MUINT32 i=0; i<pairsz; i++)
            {
                ...
                case (0x0901) :
                    ...
                    break;
                case (0x3F42) :
                    RegData.reg_addr_0x3F42 = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x3F43) :
                    RegData.reg_addr_0x3F43 = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x38A4) :
                    reg_addr_0x38A4 = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x38A5) :
                    reg_addr_0x38A5 = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x38A6) :
                    reg_addr_0x38A6 = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x38A7) :
                    reg_addr_0x38A7 = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x38A8) :
                    reg_addr_0x38A8 = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x38A9) :
                    reg_addr_0x38A9 = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x38AA) :
                    reg_addr_0x38AA = pRegAddDaPairBuf[idx+1];
                    break;
                case (0x38AB) :
                    reg_addr_0x38AB = pRegAddDaPairBuf[idx+1];
                    break;
                default :
                    break;
                }
            ...
            m_u8PDArea_XOffset = ((reg_addr_0x38A4&0x1F)<<8) | reg_addr_0x38A5;
            m_u8PDArea_YOffset = ((reg_addr_0x38A6&0x1F)<<8) | reg_addr_0x38A7;
            m_u8PDArea_Width   = ((reg_addr_0x38A8&0x1F)<<8) | reg_addr_0x38A9;
            m_u8PDArea_Height  = ((reg_addr_0x38AA&0x1F)<<8) | reg_addr_0x38AB;

            //ret = SonyPdLibInterpretRegData1( &RegData, (SonyPdLibSensorCoordSetting_t *)m_pTransRectArgIn);

            //AAA_LOGE(" befor SonyPdLibInterpretRegData ret = %d\n",ret);

            if( SonyPdLibInterpretRegData1( &RegData, (SonyPdLibSensorCoordSetting_t *)m_pTransRectArgIn)!=D_SONY_PD_LIB_REGDATA_IS_OK)
            {
                for( MUINT32 i=0; i<pairsz; i++)
                {
                    MUINT32 idx = 2*i;
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX519PdafLibraryWrapper::SetPDCLData( MUINT32 u4PDCLDaSz, MUINT8 *pPDCLDaBuf, MINT32 &oWinMode, MUINT32 &oWinEn)
{
    MBOOL ret = MFALSE;
    ...
    if( (u4PDCLDaSz>=965) && (pPDCLDaBuf!=NULL))
    {
        ...
        AAA_LOGD("m_pPDCLDa[0] = %d m_pPDCLDa[1] = %d m_u8FiexibleWindowEn = %d m_u8WindowModeSelect = %d",m_pPDCLDa[0],m_pPDCLDa[1],m_u8FiexibleWindowEn,m_u8WindowModeSelect);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX519PdafLibraryWrapper::GetDefocus( SPDROIInput_T &iPDInputData, SPDROIResult_T &oPdOutputData)
{
    memset( &oPdOutputData, 0, sizeof(SPDROIResult_T));

    AAA_LOGD("GetDefocus11 m_pfunGetDefocus = %p m_bLdDn = %d m_bInitDn = %d ",m_pfunGetDefocus,m_bLdDn,m_bInitDn);
    ...
    if( m_pfunGetDefocus && m_bLdDn && m_bInitDn)
    {
        ...
        if( (m_u8WindowModeSelect==0x0) || (m_u8WindowModeSelect==0x1))
        {
            ...
            if( iPDInputData.mode==0x0 || iPDInputData.mode==0x1 )
            {
                ...
                AAA_LOGD("GetDefocus11 i4X = %d i4Y = %d i4W = %d i4H = %d ",
                         iPDInputData.ROI.sPDROI.i4X,iPDInputData.ROI.sPDROI.i4Y,iPDInputData.ROI.sPDROI.i4W,iPDInputData.ROI.sPDROI.i4H);
                ...
                AAA_LOGD("GetDefocus11 idxx = %d idxy = %d ",idxx,idxy);
        ...
        ImgSz_I.sta.x = 0;
        ImgSz_I.sta.y = 0;
        ImgSz_I.end.x = ( m_PdProfile.uFullXsz - ImgSz_I.sta.x - 1);
        ImgSz_I.end.y = ( m_PdProfile.uFullYsz - ImgSz_I.sta.y - 1);
        ...
        {
            AAA_LOGD( "fiexible window mode : using configured window directly");
        ...
        in->XSizeOfImage = m_PdProfile.uFullXsz;
        in->YSizeOfImage = m_PdProfile.uFullYsz;
        AAA_LOGD_IF( m_u8DbgEn,
                     " ImgSz:(%d, %d)->(%d, %d)",
         ...
         */
        AAA_LOGD("GetDefocus11 err = %d ", (int)(err));
        if( err==D_PD_LIB_E_OK)
        {
            long defocus_14bit_shift = S1714_TO_S3100(out.Defocus);
            long defocus_extra_shift;
            int  extra_shift_bit = (D_IMX519_EXTRA_SHIFT_BIT)<0 ? (-1)*(D_IMX519_EXTRA_SHIFT_BIT) : (D_IMX519_EXTRA_SHIFT_BIT);

            if( (D_IMX519_EXTRA_SHIFT_BIT)<0)
            {
            ...
            AAA_LOGD_IF( m_u8DbgEn, "   Defocus [Extra Shift]  : %d (%dbit %s shifted)", (int)defocus_extra_shift, extra_shift_bit, (D_IMX519_EXTRA_SHIFT_BIT)<0 ? "left" : "right");
            ...
            oPdOutputData.DefocusConfidence      = (int)(in->ConfidenceLevel*100/2047);
            //(3) normalize to fit API spec : confidence level is in ragne 0~100.
            oPdOutputData.DefocusConfidenceLevel = (int)(in->ConfidenceLevel*100/2047);
