...
#include "SonyIMX230PdafTransCoord.h"
}
...
#define S1713_TO_S3100(x) ((int)(-1)*((x)/(1<<13)))
...
SonyIMX230PdafLibraryWrapper::SonyIMX230PdafLibraryWrapper()
{
    ...
    if( m_bLdDn)
    {
        ...
        m_pDefocusOKNGThrLine = new DefocusOKNGThrLine_t[D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL];
        m_pTransRectArgIn     = new SonyPdLibSensorCoordSetting_t;

        memset( m_pDefocusArgIn,               0, sizeof(PdLibInputData_t));
        memset( m_pDefocusOKNGThrLine,         0, sizeof(DefocusOKNGThrLine_t)*D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL);
        memset( m_pTransRectArgIn,             0, sizeof(SonyPdLibSensorCoordSetting_t));
        memset( m_aData_Slope,                 0, sizeof(signed long)*D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL);
        memset( m_aData_Offset,                0, sizeof(signed long)*D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL);
        memset( m_aXAddress_Knot_Slope_Offset, 0, sizeof(MUINT16)*D_IMX230_SLOPE_OFFSET_BLK_NUM_W);
        memset( m_aYAddress_Knot_Slope_Offset, 0, sizeof(MUINT16)*D_IMX230_SLOPE_OFFSET_BLK_NUM_H);

        DefocusOKNGThrLine_t *pDefocusOKNGThrLine = (DefocusOKNGThrLine_t *)m_pDefocusOKNGThrLine;
        for( unsigned int i=0; i<D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL; i++)
        {
            pDefocusOKNGThrLine[i].PointNum = D_IMX230_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM;
            pDefocusOKNGThrLine[i].p_AnalogGain = new unsigned long [D_IMX230_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM];
            pDefocusOKNGThrLine[i].p_Confidence = new unsigned long [D_IMX230_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM];
        }
    }
    else
    {
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX230PdafLibraryWrapper::DbgDumpSetting()
{
    if( m_bLdDn)
    {
        ...
        if( m_bDmpSetting)
        {
            ...
            AAA_LOGD("D_IMX230_DCC_IN_EEPROM_BLK_NUM_W                  : %d", D_IMX230_DCC_IN_EEPROM_BLK_NUM_W);
            AAA_LOGD("D_IMX230_DCC_IN_EEPROM_BLK_NUM_H                  : %d", D_IMX230_DCC_IN_EEPROM_BLK_NUM_H);
            AAA_LOGD("D_IMX230_DCC_IN_EEPROM_BLK_NUM_TOTAL              : %d", D_IMX230_DCC_IN_EEPROM_BLK_NUM_TOTAL);
            AAA_LOGD("D_IMX230_PD_AREA_OFFSET_X                         : %d", D_IMX230_PD_AREA_OFFSET_X);
            AAA_LOGD("D_IMX230_PD_AREA_OFFSET_Y                         : %d", D_IMX230_PD_AREA_OFFSET_Y);
            AAA_LOGD("D_IMX230_PD_AREA_SIZE_X                           : %d", D_IMX230_PD_AREA_SIZE_X);
            AAA_LOGD("D_IMX230_PD_AREA_SIZE_Y                           : %d", D_IMX230_PD_AREA_SIZE_Y);
            AAA_LOGD("D_IMX230_SLOPE_OFFSET_BLK_NUM_W                   : %d", D_IMX230_SLOPE_OFFSET_BLK_NUM_W);
            AAA_LOGD("D_IMX230_SLOPE_OFFSET_BLK_NUM_H                   : %d", D_IMX230_SLOPE_OFFSET_BLK_NUM_H);
            AAA_LOGD("D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL               : %d", D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL);
            AAA_LOGD("D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W          : %d", D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W);
            AAA_LOGD("D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H          : %d", D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H);
            AAA_LOGD("D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL      : %d", D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL);
            AAA_LOGD("D_IMX230_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM  : %d", D_IMX230_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM);
            AAA_LOGD("D_IMX230_AF_MOTOR_DRV_CONT_CODE_RESOLUTION        : %d", D_IMX230_AF_MOTOR_DRV_CONT_CODE_RESOLUTION);
            AAA_LOGD("D_IMX230_EXTRA_SHIFT_BIT                          : %d", D_IMX230_EXTRA_SHIFT_BIT);
            AAA_LOGD("\n");
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX230PdafLibraryWrapper::Init( SPDProfile_t &iPdProfile)
{
    if( m_bLdDn)
    {
        PdLibInputData_t *in = (PdLibInputData_t *)m_pDefocusArgIn;
         ...
         */
        for( MUINT32 i=0; i < D_IMX230_SLOPE_OFFSET_BLK_NUM_W; i++)
        {
            m_aXAddress_Knot_Slope_Offset[i] = (unsigned short)(D_IMX230_PD_AREA_OFFSET_X + (D_IMX230_PD_AREA_SIZE_X * i) + (D_IMX230_PD_AREA_SIZE_X / 2));
        }

        for( MUINT32 i=0; i < D_IMX230_SLOPE_OFFSET_BLK_NUM_H; i++)
        {
            m_aYAddress_Knot_Slope_Offset[i] = (unsigned short)(D_IMX230_PD_AREA_OFFSET_Y + (D_IMX230_PD_AREA_SIZE_Y * i) + (D_IMX230_PD_AREA_SIZE_Y / 2));
        }

        // Set the number of knots
        in->XKnotNumSlopeOffset = D_IMX230_SLOPE_OFFSET_BLK_NUM_W;
        in->YKnotNumSlopeOffset = D_IMX230_SLOPE_OFFSET_BLK_NUM_H;
         ...
         */
        // Set the number of knots
        in->XKnotNumDefocusOKNG = D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W;
        in->YKnotNumDefocusOKNG = D_IMX230_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H;
        ...
        MUINT16 knot_size_okng_x = (D_IMX230_ALL_PIXEL_SIZE_W-1) / (in->XKnotNumDefocusOKNG-1);
        MUINT16 knot_size_okng_y = (D_IMX230_ALL_PIXEL_SIZE_H-1) / (in->YKnotNumDefocusOKNG-1);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX230PdafLibraryWrapper::SetCaliData( MUINT32 u4CaliDaSz, MUINT8 *pCaliDaBuf, MUINT32 u4RegAddDaPairSz, MUINT16 *pRegAddDaPairBuf)
{
    MBOOL ret = MFALSE;

    if( m_bLdDn)
    {
        m_u4SlopeOffsetDaNum = D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL;
        memset( m_aData_Slope,  0, sizeof(signed long)*D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL);
        memset( m_aData_Offset, 0, sizeof(signed long)*D_IMX230_SLOPE_OFFSET_BLK_NUM_TOTAL);
        ...
        if( pCaliDaBuf!=NULL)
        {
            ...
            if( /* normal case */
                ...
                (D_IMX230_DCC_IN_EEPROM_BLK_NUM_W ==  D_IMX230_SLOPE_OFFSET_BLK_NUM_W) &&
                (D_IMX230_DCC_IN_EEPROM_BLK_NUM_H ==  D_IMX230_SLOPE_OFFSET_BLK_NUM_H) )
            {
                AAA_LOGD("%s num:%d, sz:%d Byte, directly use DCC", __FUNCTION__, m_u4SlopeOffsetDaNum, u4CaliDaSz);

                for( j=0, k=0; j<D_IMX230_SLOPE_OFFSET_BLK_NUM_H; j++)
                {
                    for( i=0; i<D_IMX230_SLOPE_OFFSET_BLK_NUM_W; i++, k++)
                    {
                        unsigned long idx = j*D_IMX230_DCC_IN_EEPROM_BLK_NUM_W*sizeof(signed short) + (2*i);
                ...
                (D_IMX230_DCC_IN_EEPROM_BLK_NUM_W*2 ==  D_IMX230_SLOPE_OFFSET_BLK_NUM_W) &&
                (D_IMX230_DCC_IN_EEPROM_BLK_NUM_H*2 ==  D_IMX230_SLOPE_OFFSET_BLK_NUM_H) )
            {
                ...
                for( j=0, k=0; j<D_IMX230_SLOPE_OFFSET_BLK_NUM_H; j++)
                {
                    for( i=0; i<D_IMX230_SLOPE_OFFSET_BLK_NUM_W; i++, k++)
                    {
                        unsigned long idx = (j/2)*D_IMX230_DCC_IN_EEPROM_BLK_NUM_W*sizeof(signed short) + (2*i/2);
                ...
                (D_IMX230_DCC_IN_EEPROM_BLK_NUM_H == 2*D_IMX230_SLOPE_OFFSET_BLK_NUM_H) )
            {
                ...
                for( j=0, k=0; j<D_IMX230_SLOPE_OFFSET_BLK_NUM_H; j++)
                {
                    for( i=0; i<D_IMX230_SLOPE_OFFSET_BLK_NUM_W; i++, k++)
                    {
                        unsigned long idx0 = (2*j  )*D_IMX230_DCC_IN_EEPROM_BLK_NUM_W*sizeof(signed short) + (2*2*i);
                        unsigned long idx1 = (2*j+1)*D_IMX230_DCC_IN_EEPROM_BLK_NUM_W*sizeof(signed short) + (2*2*i);
        ...
        if( ret==MFALSE)
        {
            AAA_LOGE("[%s] Cali data is not valid : %p sz=%lu(%u) W:%d(%d) H:%d(%d)",
                     ...
                     u4CaliDaSz,
                     D_IMX230_DCC_IN_EEPROM_BLK_NUM_W,
                     D_IMX230_SLOPE_OFFSET_BLK_NUM_W,
                     D_IMX230_DCC_IN_EEPROM_BLK_NUM_H,
                     D_IMX230_SLOPE_OFFSET_BLK_NUM_H);
        }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX230PdafLibraryWrapper::SetPDCLData( MUINT32 u4PDCLDaSz, MUINT8 *pPDCLDaBuf, MINT32 &oWinMode, MUINT32 &oWinEn)
{
    MBOOL ret = MFALSE;
...
MBOOL SonyIMX230PdafLibraryWrapper::GetDefocus( SPDROIInput_T &iPDInputData, SPDROIResult_T &oPdOutputData)
{
    ...
    if( m_pfunGetDefocus && m_bLdDn && m_bInitDn)
    {
        ...
        {
            long defocus_14bit_shift = S1713_TO_S3100(out.Defocus);
            long defocus_extra_shift;
            int  extra_shift_bit = (D_IMX230_EXTRA_SHIFT_BIT)<0 ? (-1)*(D_IMX230_EXTRA_SHIFT_BIT) : (D_IMX230_EXTRA_SHIFT_BIT);

            if( (D_IMX230_EXTRA_SHIFT_BIT)<0)
            {
            ...
            AAA_LOGD_IF( m_u8DbgEn, "   Defocus [Extra Shift]  : %d (%dbit %s shifted)", (int)defocus_extra_shift, extra_shift_bit, (D_IMX230_EXTRA_SHIFT_BIT)<0 ? "left" : "right");
            ...
            oPdOutputData.DefocusConfidence      = (int)(in->ConfidenceLevel*100/255);
            //(3) normalize to fit API spec : confidence level is in ragne 0~100.
            oPdOutputData.DefocusConfidenceLevel = (int)(in->ConfidenceLevel*100/255);
        ...
        else
        {
            ...
            AAA_LOGE(" * failed to SonyPdLibGetDefocus * err(%d)", (int)(err));
        }
