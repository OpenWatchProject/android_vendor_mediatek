...
MBOOL
_getAFParam( AF_PARAM_T const **outAFParam)
{
    ...
    AAA_LOGD( "%s : dev(%d) use default setting, %p, tbl_size(%d)",
              __FUNCTION__,
              eSensorDev,
              (void *)(*outAFParam),
              (*outAFParam)->i4TBLL);
...
template <ESensorDev_T eSensorDev>
MBOOL
_getAFConfig( AF_CONFIG_T const **outAFCfg)
{
    ...
    AAA_LOGD( "%s : dev(%d) use default setting, %p, AF_EXT_ENABLE(%d)",
              __FUNCTION__,
              eSensorDev,
              (void *)(*outAFCfg),
              (MINT32)((*outAFCfg)->AF_EXT_ENABLE));
...
template <ESensorDev_T eSensorDev>
MBOOL
_getAFExtendCoef( MINT32 w, MINT32 h, MINT32 SensorId, CustAF_THRES_T const **outCustAFThr)
{
    ...
    for( MINT32 idx=0; idx<coefnum; idx++)
    {
    ...
    AAA_LOGD( "%s : dev(%d) use default setting, %p, ISONum(%d)",
              __FUNCTION__,
              eSensorDev,
              (void *)(*outCustAFThr),
              (MINT32)((*outCustAFThr)->i4ISONum));
...
MBOOL getAFParam( MINT32 i4SensorDev, AF_PARAM_T const **outAFParam)
{
    ...
    case ESensorDev_Main :
        ret = _getAFParam<ESensorDev_Main>( outAFParam);
        break;
    case ESensorDev_Sub:
        ret = _getAFParam<ESensorDev_Sub>( outAFParam);
        break;
    case ESensorDev_MainSecond:
        ret = _getAFParam<ESensorDev_MainSecond>( outAFParam);
        break;
    case ESensorDev_SubSecond:
        ret = _getAFParam<ESensorDev_SubSecond>( outAFParam);
        break;
    default:
        ret = _getAFParam<ESensorDev_MainThird>( outAFParam);
        break;
    }
...
MBOOL getAFConfig( MINT32 i4SensorDev, AF_CONFIG_T const **outAFCfg)
{
    ...
    {
    case ESensorDev_Main :
        ret = _getAFConfig<ESensorDev_Main>( outAFCfg);
        break;
    case ESensorDev_Sub:
        ret = _getAFConfig<ESensorDev_Sub>( outAFCfg);
        break;
    case ESensorDev_MainSecond:
        ret = _getAFConfig<ESensorDev_MainSecond>( outAFCfg);
        break;
    case ESensorDev_SubSecond:
        ret = _getAFConfig<ESensorDev_SubSecond>( outAFCfg);
        break;
    case ESensorDev_MainThird:
        ret = _getAFConfig<ESensorDev_MainThird>( outAFCfg);
        break;
    default:
        ret = _getAFConfig<ESensorDev_MainThird>( outAFCfg);
        break;
...
MBOOL getAFExtendCoef( MINT32 i4SensorDev, MINT32 w, MINT32 h, MINT32 SensorId, CustAF_THRES_T const **outCustAFThr)
{
    ...
    {
    case ESensorDev_Main :
        ret = _getAFExtendCoef<ESensorDev_Main>( w, h, SensorId, outCustAFThr);
        break;
    case ESensorDev_Sub:
        ret = _getAFExtendCoef<ESensorDev_Sub>( w, h, SensorId, outCustAFThr);
        break;
    case ESensorDev_MainSecond:
        ret = _getAFExtendCoef<ESensorDev_MainSecond>( w, h, SensorId, outCustAFThr);
        break;
    case ESensorDev_SubSecond:
        ret = _getAFExtendCoef<ESensorDev_SubSecond>( w, h, SensorId, outCustAFThr);
        break;
    case ESensorDev_MainThird:
        ret = _getAFExtendCoef<ESensorDev_MainThird>( w, h, SensorId, outCustAFThr);
        break;
    default:
        ret = _getAFExtendCoef<ESensorDev_MainThird>( w, h, SensorId, outCustAFThr);
        break;
