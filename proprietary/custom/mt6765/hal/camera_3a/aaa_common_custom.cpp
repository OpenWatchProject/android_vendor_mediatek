...
/********************************************************************************************
 * PRE_CAPTURE_TIME_OUT_MS:
 *******************************************************************************************/
#define PRE_CAPTURE_TIME_OUT_MS 3200

/********************************************************************************************
 * PRE_CAPTURE_AE_LIMIT_MS:
 *******************************************************************************************/
#define PRE_CAPTURE_AE_LIMIT_MS 1000

/********************************************************************************************
 * PRE_CAPTURE_FLASH_LIMIT_MS:
 *******************************************************************************************/
#define PRE_CAPTURE_FLASH_LIMIT_MS 1000

/********************************************************************************************
 * PRE_CAPTURE_DOAFAE_LIMIT_MS:
 *******************************************************************************************/
#define PRE_CAPTURE_DOAFAE_LIMIT_MS 1000

/********************************************************************************************
 * SYNC3A_AESTABLE_MAGIC:
 *******************************************************************************************/
#define SYNC3A_AESTABLE_MAGIC 5
#define SKIP_PRECAP_FLASH_FRAME_COUNT 12

/********************************************************************************************
 * SENSOR_S5K3L6_LONG_EXP_THRES:
 *******************************************************************************************/
#define SENSOR_LONG_EXP_THRES 668437 // S5K3L6 THRES
...
MUINT32 CUST_PRE_CAPTURE_TIME_OUT_MS(void)
{
    return PRE_CAPTURE_TIME_OUT_MS;
}

MUINT32 CUST_PRE_CAPTURE_AE_LIMIT_MS(void)
{
    return PRE_CAPTURE_AE_LIMIT_MS;
}

MUINT32 CUST_PRE_CAPTURE_FLASH_LIMIT_MS(void)
{
    return PRE_CAPTURE_FLASH_LIMIT_MS;
}

MUINT32 CUST_PRE_CAPTURE_DOAFAE_LIMIT_MS(void)
{
    return PRE_CAPTURE_DOAFAE_LIMIT_MS;
}
