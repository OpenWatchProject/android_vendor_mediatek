...
STATIC_METADATA2_BEGIN(PLATFORM, LENS, SENSOR_DRVNAME_OV8856_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.lens.info
//------------------------------------------------------------------------------
    //==========================================================================
    ...
    CONFIG_METADATA_BEGIN(MTK_LENS_INFO_AVAILABLE_FOCAL_LENGTHS)
        CONFIG_ENTRY_VALUE(2.85f, MFLOAT)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_3A_FEATURE_LENS_AVAILABLE_FOCAL_LENGTHS_35MM)
        CONFIG_ENTRY_VALUE(28, MINT32)
    CONFIG_METADATA_END()
    //==========================================================================
...
//    )
    ...
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_LENS_POSE_ROTATION)
        CONFIG_ENTRY_VALUE(0.707107/*sqrt(0.5)*/, MFLOAT)
        CONFIG_ENTRY_VALUE(0.707107/*sqrt(0.5)*/, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_LENS_POSE_TRANSLATION)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
        CONFIG_ENTRY_VALUE(0.012, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_LENS_POSE_REFERENCE)
        CONFIG_ENTRY_VALUE(MTK_LENS_POSE_REFERENCE_PRIMARY_CAMERA, MUINT8)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_LENS_INTRINSIC_CALIBRATION)
        CONFIG_ENTRY_VALUE(2828.529762, MFLOAT)
        CONFIG_ENTRY_VALUE(2828.529762, MFLOAT)
        CONFIG_ENTRY_VALUE(1632, MFLOAT)
        CONFIG_ENTRY_VALUE(1224, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_LENS_DISTORTION)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
