...
STATIC_METADATA2_BEGIN(PLATFORM, PROJECT, SENSOR_DRVNAME_S5K2P7_MIPI_RAW_bayerbayer)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    //==========================================================================
...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS)
     ...
     /*   CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_RAW16, MINT64) //ADD
        ...
        CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64)//input
        CONFIG_ENTRY_VALUE(4096, MINT64)
        CONFIG_ENTRY_VALUE(2304, MINT64)
...
STATIC_METADATA2_BEGIN(PLATFORM, PRO_OVERWRITE, SENSOR_DRVNAME_S5K2P7_MIPI_RAW_bayerbayer)
