//Gionee <Amigo_Skip> <yangym> <20170207>  begin
/* Copyright Statement:
 *
...
STATIC_METADATA2_BEGIN(PLATFORM, LENS, SENSOR_DRVNAME_S5K2P7_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.lens.info
//------------------------------------------------------------------------------
    //==========================================================================
...
//    )
    ...
    CONFIG_METADATA_BEGIN(MTK_LENS_INTRINSIC_CALIBRATION)
        CONFIG_ENTRY_VALUE(4409.494973, MFLOAT)
        CONFIG_ENTRY_VALUE(4409.494973, MFLOAT)
        CONFIG_ENTRY_VALUE(2304, MFLOAT)
        CONFIG_ENTRY_VALUE(1728, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
    CONFIG_METADATA_END()
    //==========================================================================
