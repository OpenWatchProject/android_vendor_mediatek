...
LOCAL_MODULE := libcustom_hal_for_sensor_headers
...
LOCAL_MODULE := libcustom_hal_for_common_headers
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
#-----------------------------------------------------------
include $(BUILD_HEADER_LIBRARY)
...
LOCAL_MODULE := libcustom_hal_for_sensor_idxMgr_headers
LOCAL_PROPRIETARY_MODULE := true
LOCAL_MODULE_OWNER := mtk
#-----------------------------------------------------------
include $(BUILD_HEADER_LIBRARY)
...
LOCAL_HEADER_LIBRARIES += libcustom_hal_for_sensor_headers
...
#-----------------------------------------------------------
LOCAL_HEADER_LIBRARIES += libcustom_hal_for_common_headers
#-----------------------------------------------------------
...
LOCAL_HEADER_LIBRARIES += libcustom_hal_for_sensor_idxMgr_headers
