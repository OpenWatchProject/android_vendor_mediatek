...
public:     ////            Interface.
    virtual MBOOL           GetFeatureProvider(FeatureInfoProvider_T& rFInfoProvider __attribute__((unused))) { return false; }
...
public:     ////            Interface.
    ...
    static  MUINT32         getDefaultData(CAMERA_DATA_TYPE_ENUM const CameraDataType __attribute__((unused)), MVOID*const pDataBuf __attribute__((unused)), MUINT32 const size __attribute__((unused)))
                            {
                                return  -1;
                            }
                            //
    ...
    static  MUINT32			getNullFlickerPara(MINT32 sensorMode __attribute__((unused)), MINT32 binRatio __attribute__((unused)), MVOID*const pDataBuf __attribute__((unused)))
    						{
    							return  -1;
    						}
protected:  ////            Implementation.
    virtual MUINT32         impGetDefaultData(CAMERA_DATA_TYPE_ENUM const CameraDataType __attribute__((unused)), MVOID*const pDataBuf __attribute__((unused)), MUINT32 const size __attribute__((unused))) const { return  -1; }
    static  SensorInfoBase* GetInstance();
};

template <MUINT32 _sensor_id>
class YUVSensorInfoWithoutTuning : public SensorInfo<SensorInfoBase::EType_YUV, _sensor_id>
{
    typedef YUVSensorInfoWithoutTuning<_sensor_id>   SensorInfo_T;
public:     ////            Interface.
    static  SensorInfo_T*   createInstance(char const* pszDrvName = "", char const* pszDrvMacroName = "")
                            {
                                getInstance()->mpszDrvName      = pszDrvName;;
...
template <MUINT32 _sensor_id>
class RAWSensorInfoWithoutTuning : public SensorInfo<SensorInfoBase::EType_RAW, _sensor_id>
{
    typedef RAWSensorInfoWithoutTuning<_sensor_id>   SensorInfo_T;
public:     ////            Interface.
    static  SensorInfo_T*   createInstance(char const* pszDrvName = "", char const* pszDrvMacroName = "")
                            {
                                getInstance()->mpszDrvName      = pszDrvName;;
...
template <MUINT32 _sensor_id>
class SensorInfoIdxMgr : public SensorInfo<SensorInfoBase::EType_RAW, _sensor_id>
{
    typedef SensorInfoIdxMgr<_sensor_id>   SensorInfo_T;
public:     ////            Interface.
    static  SensorInfo_T*   createInstance(char const* pszDrvName = "", char const* pszDrvMacroName = "")
                            {
                                getInstance()->mpszDrvName      = pszDrvName;;
