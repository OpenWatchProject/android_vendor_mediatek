...
public: // Set Index
    ...
    MBOOL   setIdx_HLR  (MUINT16 const idx);
    ...
    MBOOL   setIdx_ABF  (MUINT16 const idx);
...
public:     ////    Get Index
    ...
    inline  MUINT16 getIdx_HLR()  const { return HLR; }
    ...
    inline  MUINT16 getIdx_ABF()  const { return ABF; }
...
// IDX_SET
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
#define IDX_SET(DBS, OBC, BNR_BPC, BNR_NR1, BNR_PDC, RMM, HLR, RNR, UDM, ANR, ANR2, ABF, CCR, BOK, HFG, EE, NR3D, MFB, MIXER3)\
    {\
        DBS, OBC, BNR_BPC, BNR_NR1, BNR_PDC, RMM, HLR, RNR, UDM, ANR, ANR2, ABF, CCR, BOK, HFG, EE, NR3D, MFB, MIXER3\
    }
