...
typedef struct S_ANALYSIS_DATA_OPEN_t
{
    typedef struct
    {
        MUINT8           cfgInfo;
     ...
     ****************/
    MUINT32 totalsz;
    S_ANALYSIS_DATA_OPEN_t *prv;
    S_ANALYSIS_DATA_OPEN_t *nxt;
    S_ANALYSIS_DATA_OPEN_t *head;
    S_ANALYSIS_DATA_OPEN_t *tail;
