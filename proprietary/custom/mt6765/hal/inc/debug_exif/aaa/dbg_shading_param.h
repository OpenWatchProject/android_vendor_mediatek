...
typedef enum
{
    ...
    SHAD_TAG_CAM_LSC_STATW,
    SHAD_TAG_CAM_LSC_STATH,
    SHAD_TAG_CAM_LSC_BORDER,
    SHAD_TAG_CAM_LSC_ORIEN,
    SHAD_TAG_CAM_LSC_FULLW,
    SHAD_TAG_CAM_LSC_FULLH,
    SHAD_TAG_CAM_LSC_REW,
    SHAD_TAG_CAM_LSC_REH,
    SHAD_TAG_CAM_LSC_CRW,
    SHAD_TAG_CAM_LSC_CRH,
    SHAD_TAG_CAM_LSC_OFFW,
    SHAD_TAG_CAM_LSC_OFFH,
    SHAD_TAG_CAM_LSC_OTP_BORDER,
    SHAD_TAG_CAM_LSC_OTP_GX,
    SHAD_TAG_CAM_LSC_OTP_GY,

    SHAD_TAG_CAM_LSC_CP_0,
    SHAD_TAG_CAM_LSC_CP_1,
    SHAD_TAG_CAM_LSC_CP_2,
    SHAD_TAG_CAM_LSC_CP_3,
    SHAD_TAG_CAM_LSC_CP_4,
    SHAD_TAG_CAM_LSC_CP_5,
    SHAD_TAG_CAM_LSC_CP_6,
    SHAD_TAG_CAM_LSC_CP_7,
    SHAD_TAG_TSF_EN,
...
#define SHAD_DEBUG_TAG_VERSION  (3)
#define SHAD_DEBUG_TAG_SUBVERSION  (0)
#define SHAD_DEBUG_TAG_VERSION_DP ((SHAD_DEBUG_TAG_SUBVERSION << 16) | SHAD_DEBUG_TAG_VERSION)
//
