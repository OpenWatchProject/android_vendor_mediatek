//Gionee <Amigo_Skip> <yangym> <20170516> begin
/* Copyright Statement:
 *
 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_S5K2P7_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("4608x3456"),
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "640x480",      "1024x768",     "1280x720",     "1280x768",     "1280x960",
                "1600x1200",    "1920x1088",    "1920x1920",    "2048x1536",    "2560x1440",    "2560x1920",    "3168x3168",  "3264x2448",
                "3328x1872",    "2880x1728",    "3600x2160",    "3456x3456",    "4096x2304",    "4096x3072",    "4160x3120",  "4208x2368",
                "4608x2592",	"4608x3456",
            )
        ),
    )
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("1440x1080"),
            ITEM_AS_VALUES_(
                "176x144",      "320x240",      "352x288",      "480x320",      "480x368",
                "640x480",      "720x480",      "800x480",      "800x600",      "864x480",
                "960x540",      "960x720",      "1088x1088",    "1280x720",     "1440x1080",
                "1776x1080",    "1920x1080",    "1920x1088",
            )
        ),
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_USER_LIST_(
                ...
                "1",      //exposure compensation step; EV = step x index
            )
        ),
        //......................................................................
        #if 1   //  SCENE HDR
...
//                   MtkCameraParameters::CAPTURE_MODE_FACE_BEAUTY,
...
#endif
    //==========================================================================
#if (1 == HDR_DETECTION_MODE)
    //  HDR Detection
    FTABLE_CONFIG_AS_TYPE_OF_USER(
            KEY_AS_(MtkCameraParameters::KEY_HDR_DETECTION_SUPPORTED),
            SCENE_AS_DEFAULT_SCENE(
                ITEM_AS_DEFAULT_(MtkCameraParameters::TRUE),
                ),
            )
    ...
    //support MZAF
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        KEY_AS_(MtkCameraParameters::KEY_SUPPORT_MZAF_FEATURE),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::TRUE),
        ),
     )
