 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_S5K5E8YXREAR2_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::SCENE_MODE_NORMAL,
 ...
 //                MtkCameraParameters::EFFECT_F1977 ,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("2592x1944"),
            ITEM_AS_VALUES_(
			"2592x1944",       "2592x1458",       "2592x1296",       "2048x1536",       "1920x1080",       "1920x960",
			"1600x1200",       "1440x1080",       "1280x960",        "1280x768",        "1280x720",        "1200x1200",
			"1024x768",        "800x600",         "864x480",         "832x486",         "800x480",         "720x480",
			"640x480",         "640x360",         "480x640",         "480x360",         "480x320",         "352x288",
			"320x240",         "240x320",
            )
        ),
    )
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
		...
		ITEM_AS_VALUES_(
		"1920x1080",       "1280x960",       "1280x720",       "864x480",       "800x480",       "720x480",
		"640x480",         "480x640",        "640x360",        "480x360",       "480x320",       "352x288",
		"320x240",         "240x320",        "176x144",        "144x176",       "160x120",
            )
        ),
    )
#endif
