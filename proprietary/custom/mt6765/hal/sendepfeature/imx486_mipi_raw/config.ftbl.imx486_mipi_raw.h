 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_IMX486_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("4000x3000"),
            ITEM_AS_VALUES_(
				"4000x3000",      "4000x2250",      "4000x2000",      "3840x2160",      "3264x2448",      "3200x2400",
				"2976x2976",      "2592x1944",      "2592x1458",      "2592x1296",      "2688x1512",      "2048x1536",
				"1920x1080",      "1920x960",       "1600x1200",      "1440x1080",      "1280x960",       "1280x768",
				"1280x720",       "1200x1200",      "1024x768",       "800x600",        "864x480",        "832x486",
            )
        ),
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
			"1280x720",       "960x720",      "960x480",       "864x480",       "832x486",       "800x480",       "768x432",       "720x480",
			"640x640",        "640x480",      "480x640",       "640x360",       "576x432",       "480x360",       "480x320",       "384x288",
			"352x288",        "320x240",      "240x320",       "240x160",       "176x144",       "144x176",       "160x120",
            )
        ),
    )
#endif
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("3840x2160"),
            ITEM_AS_VALUES_(
			"3840x2160",      "1920x1080",       "1280x960",       "1280x720",       "864x480",       "800x480",       "720x480",       "640x480",
			"480x640",        "640x360",         "480x360",        "480x320",        "352x288",       "320x240",       "240x320",       "176x144",
			"144x176",        "160x120",
            )
        ),
    )
