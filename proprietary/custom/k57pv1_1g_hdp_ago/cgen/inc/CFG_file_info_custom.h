...
#include "../cfgfileinc/CFG_PQ_File.h"
#include "../cfgdefault/CFG_PQ_Default.h"
#include <stdio.h>
#ifdef __cplusplus
extern "C"
{
    ...
    const TCFG_FILE g_akCFG_File_Custom[]=
    {
        ...
        { "/mnt/vendor/nvdata/APCFG/APRDCL/PQ_CUSTOM",	VER(AP_CFG_RDCL_FILE_PQ_LID),	CFG_FILE_PQ_CUSTOM_REC_SIZE,
            CFG_FILE_PQ_CUSTOM_REC_TOTAL,	SIGNLE_DEFUALT_REC,	(char *)&mPQ_CUSTOM_LUT,	DataReset,	NULL
        },
    };
