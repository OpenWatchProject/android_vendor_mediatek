...
STATIC_METADATA2_BEGIN(PLATFORM, PROJECT, SENSOR_DRVNAME_S5K2T7SP_MIPI_RAW_securecamera)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS)
        ...
        CONFIG_ENTRY_VALUE(5176, MINT64)        // width
...
STATIC_METADATA2_BEGIN(PLATFORM, PRO_OVERWRITE, SENSOR_DRVNAME_S5K2T7SP_MIPI_RAW_securecamera)
