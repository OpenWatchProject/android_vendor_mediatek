...
STATIC_METADATA2_BEGIN(PLATFORM, AVAILABLE_KEYS, SENSOR_DRVNAME_IMX519_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    //==========================================================================
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        APPEND_ENTRY_VALUE(MTK_SMVR_FEATURE_SMVR_MODE, MINT32)
        APPEND_ENTRY_VALUE(MTK_STREAMING_FEATURE_HFPS_MODE, MINT32)
    APPEND_METADATA_END()
    //==========================================================================
    ...
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
        ...
        APPEND_ENTRY_VALUE(MTK_STREAMING_FEATURE_AVAILABLE_HFPS_MODES, MINT32)
        APPEND_ENTRY_VALUE(MTK_STREAMING_FEATURE_AVAILABLE_HFPS_MAX_RESOLUTIONS, MINT32)
    APPEND_METADATA_END()
    //==========================================================================
