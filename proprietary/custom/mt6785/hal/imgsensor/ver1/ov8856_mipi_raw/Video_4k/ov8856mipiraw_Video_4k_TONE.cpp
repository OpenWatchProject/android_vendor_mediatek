...
#include "ov8856mipiraw_Video_4k.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T ov8856mipiraw_LCE_0002 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov8856mipiraw_GMA_0002 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov8856mipiraw_DCE_0002 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
