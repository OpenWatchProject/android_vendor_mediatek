...
#include "s5k3m3mipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T s5k3m3mipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
/******************************************************************************/
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-597, -372}, {-597, -372}, {-597, -372}},  // TUNGSTEN
                        {{-439, -388}, {-439, -388}, {-439, -388}},  // WARM FLUORESCENT
                        {{-244, -449}, {-244, -449}, {-244, -449}},  // FLUORESCENT
                        {{-203, -531}, {-203, -531}, {-203, -531}},  // CWF
                        {{-115, -396}, {-115, -396}, {-115, -396}},  // DAYLIGHT
                        {{  14, -389}, {  14, -389}, {  14, -389}},  // SHADE
