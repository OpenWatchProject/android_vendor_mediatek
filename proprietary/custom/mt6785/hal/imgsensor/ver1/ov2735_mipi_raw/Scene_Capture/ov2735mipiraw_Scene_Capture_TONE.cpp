...
const ISP_NVRAM_LCE_TUNING_PARAM_T ov2735mipiraw_LCE_0000 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov2735mipiraw_GMA_0000 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov2735mipiraw_DCE_0000 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
