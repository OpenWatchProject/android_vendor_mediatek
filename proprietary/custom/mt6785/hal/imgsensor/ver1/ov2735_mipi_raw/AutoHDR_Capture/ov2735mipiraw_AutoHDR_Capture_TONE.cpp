...
#include "ov2735mipiraw_AutoHDR_Capture.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T ov2735mipiraw_LCE_0005 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov2735mipiraw_GMA_0005 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov2735mipiraw_DCE_0005 = {
   .rDceParam=
    {
        30, // SmoothDCESpeed
