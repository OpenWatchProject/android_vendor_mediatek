...
#include "s5k2p7mipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T s5k2p7mipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
/******************************************************************************/
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-572, -365}, {-572, -365}, {-572, -365}},  // TUNGSTEN
                        {{-422, -382}, {-422, -382}, {-422, -382}},  // WARM FLUORESCENT
                        {{-204, -408}, {-204, -408}, {-204, -408}},  // FLUORESCENT
                        {{-173, -521}, {-173, -521}, {-173, -521}},  // CWF
                        {{ -69, -401}, { -69, -401}, { -69, -401}},  // DAYLIGHT
                        {{  17, -373}, {  17, -373}, {  17, -373}},  // SHADE
