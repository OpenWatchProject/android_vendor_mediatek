...
const ISP_NVRAM_LCE_TUNING_PARAM_T imx519mipiraw_LCE_0008 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T imx519mipiraw_GMA_0008 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T imx519mipiraw_DCE_0008 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
