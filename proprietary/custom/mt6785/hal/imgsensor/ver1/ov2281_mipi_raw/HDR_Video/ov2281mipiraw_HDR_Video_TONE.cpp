...
#include "ov2281mipiraw_HDR_Video.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T ov2281mipiraw_LCE_0007 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov2281mipiraw_GMA_0007 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov2281mipiraw_DCE_0007 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
