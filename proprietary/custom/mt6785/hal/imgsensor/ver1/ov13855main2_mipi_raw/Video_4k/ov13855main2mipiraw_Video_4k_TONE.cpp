...
#include "ov13855main2mipiraw_Video_4k.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T ov13855main2mipiraw_LCE_0002 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov13855main2mipiraw_GMA_0002 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov13855main2mipiraw_DCE_0002 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
