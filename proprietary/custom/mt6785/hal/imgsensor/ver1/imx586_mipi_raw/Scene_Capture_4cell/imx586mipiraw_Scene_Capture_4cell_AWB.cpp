...
#include "imx586mipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T imx586mipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
/******************************************************************************/
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-665, -406}, {-665, -406}, {-665, -406}},  // TUNGSTEN
                        {{-505, -415}, {-505, -415}, {-505, -415}},  // WARM FLUORESCENT
                        {{-285, -450}, {-285, -450}, {-285, -450}},  // FLUORESCENT
                        {{-276, -592}, {-276, -592}, {-276, -592}},  // CWF
                        {{-163, -414}, {-163, -414}, {-163, -414}},  // DAYLIGHT
                        {{  -7, -414}, {  -7, -414}, {  -7, -414}},  // SHADE
