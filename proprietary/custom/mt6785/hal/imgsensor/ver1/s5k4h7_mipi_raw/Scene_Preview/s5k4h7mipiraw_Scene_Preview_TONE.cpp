...
const ISP_NVRAM_LCE_TUNING_PARAM_T s5k4h7mipiraw_LCE_0001 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T s5k4h7mipiraw_GMA_0001 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T s5k4h7mipiraw_DCE_0001 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
