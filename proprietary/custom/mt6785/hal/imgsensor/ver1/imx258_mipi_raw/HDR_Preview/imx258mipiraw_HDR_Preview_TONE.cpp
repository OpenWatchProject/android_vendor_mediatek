...
const ISP_NVRAM_LCE_TUNING_PARAM_T imx258mipiraw_LCE_0006 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T imx258mipiraw_GMA_0006 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T imx258mipiraw_DCE_0006 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
