...
#include "imx258mipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T imx258mipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
/******************************************************************************/
        // AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
        {
            ...
            {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  66,  30,  30,  30,  30,   0,   0,   0}}, // DF
        },
/******************************************************************************/
//Feature name:
...
/******************************************************************************/
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-653, -313}, {-653, -313}, {-653, -313}},  // TUNGSTEN
                        {{-511, -331}, {-511, -331}, {-511, -331}},  // WARM FLUORESCENT
                        {{-295, -369}, {-295, -369}, {-295, -369}},  // FLUORESCENT
                        {{-281, -480}, {-281, -480}, {-281, -480}},  // CWF
                        {{-198, -357}, {-198, -357}, {-198, -357}},  // DAYLIGHT
                        {{ -36, -329}, { -36, -329}, { -36, -329}},  // SHADE
