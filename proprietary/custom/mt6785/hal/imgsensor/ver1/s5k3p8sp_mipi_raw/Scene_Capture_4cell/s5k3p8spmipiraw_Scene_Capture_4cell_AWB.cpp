...
#include "s5k3p8spmipiraw_Scene_Capture_4cell.h"

const AWB_NVRAM_T s5k3p8spmipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
/******************************************************************************/
        // Preference gain for each light source
        {
            ...
            { // TUNGSTEN
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 512},
                //    LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17             LV18
                {502, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
            },
            { // WARM FLUORESCENT
                //    LV0              LV1              LV2              LV3              LV4              LV5              LV6              LV7              LV8              LV9
                {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {502, 512, 512},
...
/******************************************************************************/
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-552, -346}, {-552, -346}, {-552, -346}},  // TUNGSTEN
                        {{-389, -352}, {-389, -352}, {-389, -352}},  // WARM FLUORESCENT
                        {{-173, -390}, {-173, -390}, {-173, -390}},  // FLUORESCENT
                        {{-141, -504}, {-141, -504}, {-141, -504}},  // CWF
                        {{ -38, -399}, { -38, -399}, { -38, -399}},  // DAYLIGHT
                        {{  97, -356}, {  97, -356}, {  97, -356}},  // SHADE
