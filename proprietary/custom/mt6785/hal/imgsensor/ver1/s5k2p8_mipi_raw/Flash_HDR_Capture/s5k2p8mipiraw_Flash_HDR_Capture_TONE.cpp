...
#include "s5k2p8mipiraw_Flash_HDR_Capture.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T s5k2p8mipiraw_LCE_0010 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T s5k2p8mipiraw_GMA_0010 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T s5k2p8mipiraw_DCE_0010 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
