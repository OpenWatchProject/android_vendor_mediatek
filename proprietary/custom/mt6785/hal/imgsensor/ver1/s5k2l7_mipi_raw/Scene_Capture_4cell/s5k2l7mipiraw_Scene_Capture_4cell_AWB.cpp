...
#include "s5k2l7mipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T s5k2l7mipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
/******************************************************************************/
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-573, -327}, {-573, -327}, {-573, -327}},  // TUNGSTEN
                        {{-438, -341}, {-438, -341}, {-438, -341}},  // WARM FLUORESCENT
                        {{-200, -383}, {-200, -383}, {-200, -383}},  // FLUORESCENT
                        {{-172, -475}, {-172, -475}, {-172, -475}},  // CWF
                        {{-102, -355}, {-102, -355}, {-102, -355}},  // DAYLIGHT
                        {{   0, -334}, {   0, -334}, {   0, -334}},  // SHADE
