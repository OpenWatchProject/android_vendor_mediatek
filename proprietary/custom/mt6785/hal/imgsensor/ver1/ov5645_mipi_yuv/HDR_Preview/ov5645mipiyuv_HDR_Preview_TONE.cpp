...
#include "ov5645mipiyuv_HDR_Preview.h"

const ISP_NVRAM_LCE_TUNING_PARAM_T ov5645mipiyuv_LCE_0006 = {
    .i4AutoHDREnable = {
        0
    },
    .rAutoLCEParam = {
...
const ISP_NVRAM_GMA_STRUCT_T ov5645mipiyuv_GMA_0006 = {
  .GGM_Reg = {
        {.set={
...
const ISP_NVRAM_DCE_TUNING_PARAM_T ov5645mipiyuv_DCE_0006 = {
    .rDceParam=
    {
        30, // SmoothDCESpeed
