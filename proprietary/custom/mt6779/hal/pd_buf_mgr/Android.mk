...
#-----------------------------------------------------------
PDBUFMGR_ALL_FILES := $(shell find $(LOCAL_PATH)/.)
PDBUFMGR_ALL_FILES := $(PDBUFMGR_ALL_FILES:$(LOCAL_PATH)/./%=%)
PDBUFMGR_CPP_LIST := $(filter-out 3rd_party%,$(PDBUFMGR_ALL_FILES))
PDBUFMGR_CPP_LIST := $(filter %.c %.cpp,$(PDBUFMGR_CPP_LIST))
LOCAL_SRC_FILES := $(PDBUFMGR_CPP_LIST)
...
LOCAL_C_INCLUDES += $(wildcard $(LOCAL_PATH)/3rd_party/*/inc)
