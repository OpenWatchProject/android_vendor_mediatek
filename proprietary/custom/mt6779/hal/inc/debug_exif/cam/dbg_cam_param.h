...
#define CHKSUM_DBG_MF_PARAM CHKSUM_DBG_CAM_MF_PARAM11
#define CHKSUM_DBG_N3D_PARAM CHKSUM_DBG_CAM_N3D_PARAM5
...
using namespace dbg_cam_mf_param_11;
using namespace dbg_cam_n3d_param_5;
