...
LOCAL_SRC_FILES += \
  ...
  camera_custome_isp_profile_mapping.cpp \
  camera_custom_feature_table.cpp \

LOCAL_SRC_FILES += camera_nvram_query.cpp
LOCAL_SRC_FILES += camera_custom_pq.cpp
LOCAL_SRC_FILES += camera_custom_dsdn.cpp
...
LOCAL_CFLAGS += -DMTK_CAM_NEW_NVRAM_SUPPORT=$(MTK_CAM_NEW_NVRAM_SUPPORT)
