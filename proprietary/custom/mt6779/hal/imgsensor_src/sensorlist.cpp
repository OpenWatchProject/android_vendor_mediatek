...
{ \
    ...
    NSFeature::CamsvCustomDecode<_id, _moduleIndex>::getCamsvBufSize, \
    NSFeature::CamsvCustomDecode<_id, _moduleIndex>::getCamsvCustomDecode, \
    NSFeature::AECustomTransform<_id, _moduleIndex>::getAECustomTransform, \
    getCalData, \
}
...
/*IMX*/
    ...
    RAW_INFO_M(IMX519_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_IMX519DUAL_MIPI_RAW, CAM_CALGetCalData),
#endif
#if defined(IMX576_MIPI_RAW)
    RAW_INFO_M(IMX576_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_IMX576_MIPI_RAW, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO_M(IMX386_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_IMX386_MIPI_RAW, NULL),
#endif
#if defined(IMX386_MIPI_MONO)
    RAW_INFO_M(IMX386_MONO_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_IMX386_MIPI_MONO, NULL),
#endif
...
/*OV (OmniVision)*/
    ...
    RAW_INFO_M(OV16880_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_OV16880_MIPI_RAW, CAM_CALGetCalData),
#endif
    ...
    {OV3640_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_OV3640_RAW,NULL),
#endif
    ...
    YUV_INFO_M(OV2659_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_OV2659_YUV,NULL),
#endif
...
/*S5K*/
    ...
    RAW_INFO_M(S5K3M3_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_S5K3M3_MIPI_RAW, NULL),
#endif
    ...
    RAW_INFO_M(S5K2T7SP_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_S5K2T7SP_MIPI_RAW, CAM_CALGetCalData),
#endif
    ...
    RAW_INFO_M(S5K5E9_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_S5K5E9_MIPI_RAW, NULL),
#endif
/*HI*/
#if defined(HI841_MIPI_RAW)
    RAW_INFO_M(HI841_SENSOR_ID, DEFAULT_MODULE_INDEX, DEFAULT_MODULE_ID, SENSOR_DRVNAME_HI841_MIPI_RAW,HI841_MIPI_RAW_SensorInit),
#endif
...
/*  ADD sensor driver before this line */
    {0, 0, 0, 0, {0}, NULL, NULL ,NULL, NULL, NULL}//end of list
};
