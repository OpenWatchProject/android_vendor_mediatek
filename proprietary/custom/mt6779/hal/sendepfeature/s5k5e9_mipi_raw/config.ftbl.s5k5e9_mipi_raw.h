 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_S5K5E9_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    //  The largest preview-size must have same aspect ratio as the largest picture-size
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                ...
                "640x480",      "720x480",      "800x480",      "864x480",      "960x540",
                #if GMO_PROJECT
                "832x624",  //For matching ratio to biggest picture size
                #else
                "1280x720",     "1440x1080",    "1920x1080",    "1664x1248",
                #endif
            )
        ),
    )
