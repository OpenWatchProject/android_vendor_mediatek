...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     ...
                     535, // AWBGAIN_HORIZON_G
                    1687  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     603, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    -182, // TUNGSTEN RightBound
                    -861, // TUNGSTEN LeftBound
                    -330, // TUNGSTEN UpperBound
                    -420  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -182, // WARM FLUORESCENT RightBound
                    -861, // WARM FLUORESCENT LeftBound
                    -420, // WARM FLUORESCENT UpperBound
                    -615  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                     -34, // FLUORESCENT RightBound
                    -182, // FLUORESCENT LeftBound
                    -344, // FLUORESCENT UpperBound
                    -481  // FLUORESCENT LowerBound
                },
                // CWF
                {
                       4, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     185, // DAYLIGHT RightBound
                     -34, // DAYLIGHT LeftBound
                    -344, // DAYLIGHT UpperBound
                    -481  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     515, // SHADE RightBound
                     185, // SHADE LeftBound
                    -344, // SHADE UpperBound
                    -452  // SHADE LowerBound
                },
                // DF
                {
                     185, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                ...
                // CLOUDY_D
                {
                     310, // CLOUDY_D RightBound
                     135, // CLOUDY_D LeftBound
                    -344, // CLOUDY_D UpperBound
                    -481  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     410, // SHADE RightBound
                     135, // SHADE LeftBound
                    -344, // SHADE UpperBound
                    -481  // SHADE LowerBound
                },
                // TWILIGHT
                {
                     -34, // TWILIGHT RightBound
                    -194, // TWILIGHT LeftBound
                    -344, // TWILIGHT UpperBound
                    -481  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     205, // FLUORESCENT RightBound
                    -191, // FLUORESCENT LeftBound
                    -354, // FLUORESCENT UpperBound
                    -575  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -219, // WARM FLUORESCENT RightBound
                    -419, // WARM FLUORESCENT LeftBound
                    -354, // WARM FLUORESCENT UpperBound
                    -575  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -219, // INCANDESCENT RightBound
                    -419, // INCANDESCENT LeftBound
                    -344, // INCANDESCENT UpperBound
                    -481  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                     999, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                     919  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     658, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1460  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     611, // PWB_INCANDESCENT_R
                     512, // PWB_INCANDESCENT_G
                    1366  // PWB_INCANDESCENT_B
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
                ...
                {
                    -616,  // RotatedXCoordinate0
                    -474,  // RotatedXCoordinate1
                    -246,  // RotatedXCoordinate2
    ...
    /******************************************************************************/
            // AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
            {
                ...
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  75,  50,  25,   0,   0,   0}}, // TUNGSTEN
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  70,  25,  25,  25,   0,   0,   0}}, // WARM FLUORESCENT
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  70,  25,  25,  25,   0,   0,   0}}, // FLUORESCENT
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  90,  66,  30,  30,  30,  30,   0,   0,   0}}, // CWF
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  75,  50,  40,  30,  20}}, // DAYLIGHT
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  95,  50,  25,   0,   0,   0,   0}}, // SHADE
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  66,  30,  30,  30,  30,   0,   0,   0}}, // DF
            },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                        ...
                        -167,    //i4FaceRawXrR_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -217,    //i4FaceRawXrL_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        ...
                        -371,    //i4FaceRawYrU for Indoor Greenish CT dynamic, Unit = 1000
                        -421     //i4FaceRawYrD for Indoor Greenish CT dynamic, Unit = 1000
                    },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    //rRefTarget - Reference Target Setting
                    {
                        ...
                        // i4RefTargetThr
                        {
                            ...
                            {{-653, -313}, {-653, -313}, {-653, -313}},  // HORIZON
                            {{-511, -331}, {-511, -331}, {-511, -331}},  // A
                            {{-295, -369}, {-295, -369}, {-295, -369}},  // TL84
                            {{-281, -480}, {-281, -480}, {-281, -480}},  // CWF
                            {{-198, -357}, {-198, -357}, {-198, -357}},  // DNP
                            {{ -36, -329}, { -36, -329}, { -36, -329}},  // D65
                            {{ -65, -454}, { -65, -454}, { -65, -454}},  // DF
                        },
                    },
