...
#define LCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, LCE_0010)
#define GMA_TONE_BASE                                                M_CONC(TARGET_SENSOR, GMA_0010)
#define DCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, DCE_0010)
#define LTM_TONE_BASE                                                M_CONC(TARGET_SENSOR, LTM_0010)
#define HLR_TONE_BASE                                                M_CONC(TARGET_SENSOR, HLR_0010)
