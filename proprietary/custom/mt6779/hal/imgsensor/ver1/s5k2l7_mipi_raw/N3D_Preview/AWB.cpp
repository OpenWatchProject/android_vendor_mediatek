...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     ...
                     520, // AWBGAIN_HORIZON_G
                    1493  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     622, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                     -96, // TUNGSTEN RightBound
                    -781, // TUNGSTEN LeftBound
                    -324, // TUNGSTEN UpperBound
                    -389  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                     -96, // WARM FLUORESCENT RightBound
                    -781, // WARM FLUORESCENT LeftBound
                    -389, // WARM FLUORESCENT UpperBound
                    -610  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                      61, // FLUORESCENT RightBound
                     -96, // FLUORESCENT LeftBound
                    -349, // FLUORESCENT UpperBound
                    -486  // FLUORESCENT LowerBound
                },
                // CWF
                {
                      92, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     221, // DAYLIGHT RightBound
                      61, // DAYLIGHT LeftBound
                    -349, // DAYLIGHT UpperBound
                    -486  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     551, // SHADE RightBound
                     221, // SHADE LeftBound
                    -349, // SHADE UpperBound
                    -453  // SHADE LowerBound
                },
                // DF
                {
                     221, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                ...
                // CLOUDY_D
                {
                     346, // CLOUDY_D RightBound
                     171, // CLOUDY_D LeftBound
                    -349, // CLOUDY_D UpperBound
                    -486  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     446, // SHADE RightBound
                     171, // SHADE LeftBound
                    -349, // SHADE UpperBound
                    -486  // SHADE LowerBound
                },
                // TWILIGHT
                {
                      61, // TWILIGHT RightBound
                     -99, // TWILIGHT LeftBound
                    -349, // TWILIGHT UpperBound
                    -486  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     241, // FLUORESCENT RightBound
                     -96, // FLUORESCENT LeftBound
                    -359, // FLUORESCENT UpperBound
                    -570  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -146, // WARM FLUORESCENT RightBound
                    -346, // WARM FLUORESCENT LeftBound
                    -359, // WARM FLUORESCENT UpperBound
                    -570  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -146, // INCANDESCENT RightBound
                    -346, // INCANDESCENT LeftBound
                    -349, // INCANDESCENT UpperBound
                    -486  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                    1039, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                     892  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     665, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1352  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     626, // PWB_INCANDESCENT_R
                     512, // PWB_INCANDESCENT_G
                    1266  // PWB_INCANDESCENT_B
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
                ...
                {
                    -572,  // RotatedXCoordinate0
                    -437,  // RotatedXCoordinate1
                    -187,  // RotatedXCoordinate2
                    -102,  // RotatedXCoordinate3
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                         ...
                         -79,    //i4FaceRawXrR_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -129,    //i4FaceRawXrL_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        ...
                        -380,    //i4FaceRawYrU for Indoor Greenish CT dynamic, Unit = 1000
                        -430     //i4FaceRawYrD for Indoor Greenish CT dynamic, Unit = 1000
                    },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    //rRefTarget - Reference Target Setting
                    {
                        ...
                        // i4RefTargetThr
                        {
                            ...
                            {{-573, -327}, {-573, -327}, {-573, -327}},  // HORIZON
                            {{-438, -341}, {-438, -341}, {-438, -341}},  // A
                            {{-200, -383}, {-200, -383}, {-200, -383}},  // TL84
                            {{-172, -475}, {-172, -475}, {-172, -475}},  // CWF
                            {{-102, -355}, {-102, -355}, {-102, -355}},  // DNP
                            {{   0, -334}, {   0, -334}, {   0, -334}},  // D65
                            {{  -4, -440}, {  -4, -440}, {  -4, -440}},  // DF
                        },
                    },
