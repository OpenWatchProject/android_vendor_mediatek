...
const ISP_NVRAM_CNR_CCR_T CNR_CCR_BASE[8] = {
    // IDX_0
    {
        ...
        .l4lut2    ={.bits ={.CNR_CCR_SL2_GAIN0=16, .rsv_6=0, .CNR_CCR_SL2_GAIN1=20, .rsv_14=0, .CNR_CCR_SL2_GAIN2=24, .rsv_22=0, .CNR_CCR_SL2_GAIN3=32, .rsv_30=0}},
        .l4lut3    ={.bits ={.CNR_CCR_SL2_SP0=8, .rsv_6=0, .CNR_CCR_SL2_SP1=8, .rsv_14=0, .CNR_CCR_SL2_SP2=16, .rsv_22=0, .CNR_CCR_SL2_SP3=16, .rsv_30=0}},
    },
    // IDX_1
    {
        .con       ={.bits ={.CNR_CCR_EN=0, .CNR_CCR_SL2_LINK=1, .CNR_CCR_SL2_MODE=0, .rsv_4=0, .CNR_CCR_OR_MODE=0, .rsv_6=0, .CNR_CCR_UV_GAIN_MODE=1, .rsv_9=0, .CNR_CCR_UV_GAIN2=0, .rsv_23=0, .CNR_CCR_Y_CPX3=255}},
...
const ISP_NVRAM_CNR_ABF_T CNR_ABF_BASE[8] = {
    // IDX_0
    {
        ...
        .cxlut     ={.bits ={.CNR_ABF_CX0=96, .CNR_ABF_CX1=108, .CNR_ABF_CX2=196, .CNR_ABF_CX3=210}},
        .cylut     ={.bits ={.CNR_ABF_CY0=122, .CNR_ABF_CY1=130, .CNR_ABF_CY2=184, .CNR_ABF_CY3=205}},
        .ysp       ={.bits ={.CNR_ABF_Y_SP0=511, .rsv_10=0, .CNR_ABF_Y_SP1=1016, .rsv_26=0}},
        .cxsp      ={.bits ={.CNR_ABF_CX_SP0=42, .rsv_10=0, .CNR_ABF_CX_SP1=988, .rsv_26=0}},
