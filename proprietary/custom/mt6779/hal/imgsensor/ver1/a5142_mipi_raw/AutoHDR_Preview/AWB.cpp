...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     542, // AWBGAIN_HORIZON_R
                     512, // AWBGAIN_HORIZON_G
                    1231  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     650, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                     -87, // TUNGSTEN RightBound
                    -685, // TUNGSTEN LeftBound
                    -285, // TUNGSTEN UpperBound
                    -404  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                     -87, // WARM FLUORESCENT RightBound
                    -685, // WARM FLUORESCENT LeftBound
                    -404, // WARM FLUORESCENT UpperBound
                    -545  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                      46, // FLUORESCENT RightBound
                     -87, // FLUORESCENT LeftBound
                    -323, // FLUORESCENT UpperBound
                    -442  // FLUORESCENT LowerBound
                },
                // CWF
                {
                      74, // CWF RightBound
                ...
                // SHADE
                {
                     550, // SHADE RightBound
                     220, // SHADE LeftBound
                    -323, // SHADE UpperBound
                    -412  // SHADE LowerBound
                },
                // DF
                {
                     220, // DF RightBound
    ...
    /******************************************************************************/
                ...
                {
                    -475,  // RotatedXCoordinate0
                    -365,  // RotatedXCoordinate1
    ...
    /******************************************************************************/
            // Preference gain for each light source
            {
                ...
                { // CWF
                    //    LV-4             LV-3            LV-2             LV-1              LV0              LV1              LV2              LV3              LV4              LV5            LV6            LV7
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {505, 512, 512}, {505, 512, 512}, {505, 512, 512},
                    //    LV8              LV9              LV10             LV11             LV12             LV13             LV14             LV15             LV16             LV17           LV18
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                },
                { // DAYLIGHT
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                        ...
                        -356,    //i4FaceRawYrU for Indoor Greenish CT dynamic, Unit = 1000
                        -406     //i4FaceRawYrD for Indoor Greenish CT dynamic, Unit = 1000
                    },
    /******************************************************************************/
    //Feature name:
