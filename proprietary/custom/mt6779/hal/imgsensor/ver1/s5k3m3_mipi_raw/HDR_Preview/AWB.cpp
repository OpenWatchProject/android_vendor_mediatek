...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     530, // AWBGAIN_HORIZON_R
                     512, // AWBGAIN_HORIZON_G
                    1616  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     673, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    -123, // TUNGSTEN RightBound
                    -805, // TUNGSTEN LeftBound
                    -369, // TUNGSTEN UpperBound
                    -434  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -123, // WARM FLUORESCENT RightBound
                    -805, // WARM FLUORESCENT LeftBound
                    -434, // WARM FLUORESCENT UpperBound
                    -666  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                      38, // FLUORESCENT RightBound
                    -123, // FLUORESCENT LeftBound
                    -404, // FLUORESCENT UpperBound
                    -547  // FLUORESCENT LowerBound
                },
                // CWF
                {
                      79, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     235, // DAYLIGHT RightBound
                      38, // DAYLIGHT LeftBound
                    -404, // DAYLIGHT UpperBound
                    -547  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     565, // SHADE RightBound
                     235, // SHADE LeftBound
                    -404, // SHADE UpperBound
                    -509  // SHADE LowerBound
                },
                // DF
                {
                     235, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                ...
                // CLOUDY_D
                {
                     360, // CLOUDY_D RightBound
                     185, // CLOUDY_D LeftBound
                    -404, // CLOUDY_D UpperBound
                    -547  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     460, // SHADE RightBound
                     185, // SHADE LeftBound
                    -404, // SHADE UpperBound
                    -547  // SHADE LowerBound
                },
                // TWILIGHT
                {
                      38, // TWILIGHT RightBound
                    -122, // TWILIGHT LeftBound
                    -404, // TWILIGHT UpperBound
                    -547  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     255, // FLUORESCENT RightBound
                    -140, // FLUORESCENT LeftBound
                    -414, // FLUORESCENT UpperBound
                    -626  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -147, // WARM FLUORESCENT RightBound
                    -347, // WARM FLUORESCENT LeftBound
                    -414, // WARM FLUORESCENT UpperBound
                    -626  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -147, // INCANDESCENT RightBound
                    -347, // INCANDESCENT LeftBound
                    -404, // INCANDESCENT UpperBound
                    -547  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                    1108, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                     969  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     729, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1454  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     687, // PWB_INCANDESCENT_R
                     512, // PWB_INCANDESCENT_G
                    1368  // PWB_INCANDESCENT_B
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
                // Rotated X coordinate 
                {
                    ...
                    -452,  // RotatedXCoordinate1
                    -245,  // RotatedXCoordinate2
                    -129,  // RotatedXCoordinate3
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                        ...
                        -109,    //i4FaceRawXrR_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -159,    //i4FaceRawXrL_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        ...
                        -441,    //i4FaceRawYrU for Indoor Greenish CT dynamic, Unit = 1000
                        -491     //i4FaceRawYrD for Indoor Greenish CT dynamic, Unit = 1000
                    },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    //rRefTarget - Reference Target Setting
                    {
                        ...
                        // i4RefTargetThr
                        {
                            ...
                            {{-597, -372}, {-597, -372}, {-597, -372}},  // HORIZON
                            {{-439, -388}, {-439, -388}, {-439, -388}},  // A
                            {{-244, -449}, {-244, -449}, {-244, -449}},  // TL84
                            {{-203, -531}, {-203, -531}, {-203, -531}},  // CWF
                            {{-115, -396}, {-115, -396}, {-115, -396}},  // DNP
                            {{  14, -389}, {  14, -389}, {  14, -389}},  // D65
                            {{   5, -496}, {   5, -496}, {   5, -496}},  // DF
                        },
                    },
