...
#define LCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, LCE_0008)
#define GMA_TONE_BASE                                                M_CONC(TARGET_SENSOR, GMA_0008)
#define DCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, DCE_0008)
#define LTM_TONE_BASE                                                M_CONC(TARGET_SENSOR, LTM_0008)
#define HLR_TONE_BASE                                                M_CONC(TARGET_SENSOR, HLR_0008)
#define CA_LTM_CA_LTM_BASE                                           M_CONC(TARGET_SENSOR, CA_LTM_0009)
