...
//camera_info_header
#include "camera_info_ov13855main2mipiraw.h"
...
CAMSV_CUSTOM_BUFFER_INFO getAeBufSize_ov13855main2mipiraw();
CAMSV_CUSTOM_BUFFER_INFO getFlkBufsize_ov13855main2mipiraw();
UINT32 DecodeAe_ov13855main2mipiraw(VOID* const pData);
UINT32 DecodeFlk_ov13855main2mipiraw(VOID* const pData);
...
impCamsvBufSize(CAMSV_CUSTOM_DECODE_ENUM const CamsvCusDecodeFeature) const
{
    ...
    switch(CamsvCusDecodeFeature)
    {
        case CAMSV_CUSTOM_DECODE_AE:
            buf_size = getAeBufSize_ov13855main2mipiraw();
            break;
        case CAMSV_CUSTOM_DECODE_FLK:
            buf_size = getFlkBufsize_ov13855main2mipiraw();
            break;
        default:
...
impCamsvCustomDecode(CAMSV_CUSTOM_DECODE_ENUM const CamsvCusDecodeFeature, VOID* const pData) const
{
    ...
    {
        case CAMSV_CUSTOM_DECODE_AE:
            DecodeAe_ov13855main2mipiraw(pData);
            break;
        case CAMSV_CUSTOM_DECODE_FLK:
            DecodeFlk_ov13855main2mipiraw(pData);
            break;
        default:
