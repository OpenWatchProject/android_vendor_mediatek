...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     561, // AWBGAIN_HORIZON_R
                     512, // AWBGAIN_HORIZON_G
                    1507  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     684, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    ...
                    -794, // TUNGSTEN LeftBound
                    -331, // TUNGSTEN UpperBound
                    -396  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -123, // WARM FLUORESCENT RightBound
                    -794, // WARM FLUORESCENT LeftBound
                    -396, // WARM FLUORESCENT UpperBound
                    -591  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                      35, // FLUORESCENT RightBound
                    -123, // FLUORESCENT LeftBound
                    -364, // FLUORESCENT UpperBound
                    -468  // FLUORESCENT LowerBound
                },
                // CWF
                {
                      64, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     222, // DAYLIGHT RightBound
                      35, // DAYLIGHT LeftBound
                    -364, // DAYLIGHT UpperBound
                    -468  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     552, // SHADE RightBound
                     222, // SHADE LeftBound
                    -364, // SHADE UpperBound
                    -455  // SHADE LowerBound
                },
                // DF
                {
                     222, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                ...
                // CLOUDY_D
                {
                     347, // CLOUDY_D RightBound
                     172, // CLOUDY_D LeftBound
                    -364, // CLOUDY_D UpperBound
                    -468  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     447, // SHADE RightBound
                     172, // SHADE LeftBound
                    -364, // SHADE UpperBound
                    -468  // SHADE LowerBound
                },
                // TWILIGHT
                {
                      35, // TWILIGHT RightBound
                    -125, // TWILIGHT LeftBound
                    -364, // TWILIGHT UpperBound
                    -468  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     242, // FLUORESCENT RightBound
                    -128, // FLUORESCENT LeftBound
                    -374, // FLUORESCENT UpperBound
                    -551  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -168, // WARM FLUORESCENT RightBound
                    -368, // WARM FLUORESCENT LeftBound
                    -374, // WARM FLUORESCENT UpperBound
                    -551  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -168, // INCANDESCENT RightBound
                    -368, // INCANDESCENT LeftBound
                    -364, // INCANDESCENT UpperBound
                    -468  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                    1074, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                     843  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     714, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1350  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     668, // PWB_INCANDESCENT_R
                     512, // PWB_INCANDESCENT_G
                    1273  // PWB_INCANDESCENT_B
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                        ...
                        -107,    //i4FaceRawXrR_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -157,    //i4FaceRawXrL_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
    ...
    /******************************************************************************/
                    ...
                    //rRefTarget - Reference Target Setting
                    {
                        ...
                        // i4RefTargetThr
                        {
                            ...
                            {{-586, -334}, {-586, -334}, {-586, -334}},  // HORIZON
                            {{-460, -361}, {-460, -361}, {-460, -361}},  // A
                            {{-230, -367}, {-230, -367}, {-230, -367}},  // TL84
                            {{-218, -456}, {-218, -456}, {-218, -456}},  // CWF
                            {{-126, -388}, {-126, -388}, {-126, -388}},  // DNP
                            {{   1, -349}, {   1, -349}, {   1, -349}},  // D65
                            {{  -9, -425}, {  -9, -425}, {  -9, -425}},  // DF
                        },
                    },
