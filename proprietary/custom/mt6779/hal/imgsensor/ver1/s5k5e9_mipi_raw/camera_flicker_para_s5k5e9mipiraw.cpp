...
#include "camera_AE_PLineTable_s5k5e9mipiraw.h"
#include "camera_info_s5k5e9mipiraw.h"
...
static void get_flicker_para_by_Preview_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L60 = {750, 620, 1158, -496};
    ...
    para->flickerGradThreshold = 1442;
...
static void get_flicker_para_by_Preview_Bin2(FLICKER_CUST_PARA* para)
{
    int freq[9] = {70, 100, 120, 140, 160, 170, 190, 210, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {688, 675, 1262, -518};
    FLICKER_CUST_STATISTICS EV60_L50 = {1090, 535, 1414, -519};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1769;
...
static void get_flicker_para_by_Capture_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV60_L50 = {1309, 446, 1178, -473};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1420;
...
static void get_flicker_para_by_Capture_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1747;
    para->flickerSearchRange = 16;
    para->minPastFrames = 3;
    para->maxPastFrames = 14;
    para->EV50_L50 = EV50_L50;
...
static void get_flicker_para_by_Video_Bin1(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1004, 463, 864, -421};
    FLICKER_CUST_STATISTICS EV60_L50 = {1193, 489, 1291, -496};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1434;
...
static void get_flicker_para_by_Video_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1005, 462, 863, -421};
    FLICKER_CUST_STATISTICS EV60_L50 = {1360, 429, 1133, -463};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 1754;
...
// using [Preview_Bin1] parameters for [Video2_Bin1]
...
// using [Preview_Bin1] parameters for [Video2_Bin2]
