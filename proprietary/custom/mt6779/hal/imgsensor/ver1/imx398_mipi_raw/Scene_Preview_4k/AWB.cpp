...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB gain of AWB light source
            {
                ...
                // HORIZON
                {
                     526, // AWBGAIN_HORIZON_R
                     512, // AWBGAIN_HORIZON_G
                    1854  // AWBGAIN_HORIZON_B
                },
                // A
                {
                     659, // AWBGAIN_A_R
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                    -174, // TUNGSTEN RightBound
                    -873, // TUNGSTEN LeftBound
                    -423, // TUNGSTEN UpperBound
                    -503  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                    -174, // WARM FLUORESCENT RightBound
                    -873, // WARM FLUORESCENT LeftBound
                    -503, // WARM FLUORESCENT UpperBound
                    -727  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                      -7, // FLUORESCENT RightBound
                    -174, // FLUORESCENT LeftBound
                    -429, // FLUORESCENT UpperBound
                    -578  // FLUORESCENT LowerBound
                },
                // CWF
                {
                      25, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     214, // DAYLIGHT RightBound
                      -7, // DAYLIGHT LeftBound
                    -429, // DAYLIGHT UpperBound
                    -578  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     544, // SHADE RightBound
                     214, // SHADE LeftBound
                    -429, // SHADE UpperBound
                    -548  // SHADE LowerBound
                },
                // DF
                {
                     214, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                ...
                // CLOUDY_D
                {
                     339, // CLOUDY_D RightBound
                     164, // CLOUDY_D LeftBound
                    -429, // CLOUDY_D UpperBound
                    -578  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     439, // SHADE RightBound
                     164, // SHADE LeftBound
                    -429, // SHADE UpperBound
                    -578  // SHADE LowerBound
                },
                // TWILIGHT
                {
                      -7, // TWILIGHT RightBound
                    -167, // TWILIGHT LeftBound
                    -429, // TWILIGHT UpperBound
                    -578  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     234, // FLUORESCENT RightBound
                    -186, // FLUORESCENT LeftBound
                    -439, // FLUORESCENT UpperBound
                    -687  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -213, // WARM FLUORESCENT RightBound
                    -413, // WARM FLUORESCENT LeftBound
                    -439, // WARM FLUORESCENT UpperBound
                    -687  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -213, // INCANDESCENT RightBound
                    -413, // INCANDESCENT LeftBound
                    -429, // INCANDESCENT UpperBound
                    -578  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                    1146, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                    1049  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     732, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1667  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     674, // PWB_INCANDESCENT_R
                     512, // PWB_INCANDESCENT_G
                    1540  // PWB_INCANDESCENT_B
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // AWB daylight locus probability (Statistic Weighting) look-up table (Max: 100; Min: 0)
            {
                ...
                {{ 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100, 100,  75,  50,  25,  25,  25,   0,   0,   0}}, // WARM FLUORESCENT
