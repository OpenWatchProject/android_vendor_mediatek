...
#define YNR_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, YNR_0096)
#define YNR_LCE_LINK_ISP_YUV_BASE                                    M_CONC(TARGET_SENSOR, YNR_LCE_LINK_0032)
#define YNR_FD_ISP_YUV_BASE                                          M_CONC(TARGET_SENSOR, YNR_FD_0032)
#define CNR_CNR_ISP_YUV_BASE                                         M_CONC(TARGET_SENSOR, CNR_CNR_0080)
#define EE_ISP_YUV_BASE                                              M_CONC(TARGET_SENSOR, EE_0064)
#define NR3D_ISP_YUV_BASE                                            M_CONC(TARGET_SENSOR, NR3D_0016)
#define HFG_ISP_YUV_BASE                                             M_CONC(TARGET_SENSOR, HFG_0016)
#define OBC_ISP_RAW_BASE                                             M_CONC(TARGET_SENSOR, OBC_0008)
#define BPC_BPC_ISP_RAW_BASE                                         M_CONC(TARGET_SENSOR, BPC_BPC_0008)
#define BPC_CT_ISP_RAW_BASE                                          M_CONC(TARGET_SENSOR, BPC_CT_0008)
#define BPC_PDC_ISP_RAW_BASE                                         M_CONC(TARGET_SENSOR, BPC_PDC_0008)
#define LDNR_ISP_RAW_BASE                                            M_CONC(TARGET_SENSOR, LDNR_0008)
