...
#define Flash_AE_BASE                                                Flash_AE_Flash_AE_BASE

const FLASH_AE_NVRAM_T Flash_AE_BASE[1] = {
    // IDX_0
    {
        .tuningPara = {
            160,   // yTarget
            5,     // fgWIncreaseLevelbySize
            ...
            1,     // isFollowCapPline
            380,   // histStretchMaxFgYTarget
            560,   // histStretchBrightestYTarget
            0,     // fgSizeShiftRatio
