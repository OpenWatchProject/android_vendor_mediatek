...
#include "camera_AE_Sync_param_imx519mipiraw.h"
#include "camera_AWB_Sync_param_imx519mipiraw.h"
#include "camera_info_imx519mipiraw.h"
...
#include INCLUDE_FILENAME_ISP_TONEMAP_PARAM
    ...
    DngMetadata:
    {
        ...
        3,  //i4RefereceIlluminant2
        {
            // rNoiseProfile[4]
            {
                {1.13181684574e-06, -6.80726372346e-06},
                {4.7860330176e-12, 4.80927393449e-07},
            },
            {
                {1.09388424675e-06, -4.56232015326e-06},
                {5.76106136392e-12, 3.42159917692e-07},
            },
            {
                {1.10447005273e-06, -6.99563906103e-06},
                {4.84901793251e-12, 3.91201593132e-07},
            },
            {
                {1.10774263638e-06, -5.25596430419e-06},
                {4.52912553375e-12, 4.91385730801e-07},
            },
        },
    }
}};
