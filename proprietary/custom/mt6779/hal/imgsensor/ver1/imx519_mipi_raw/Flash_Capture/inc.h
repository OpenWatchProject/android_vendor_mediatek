...
#define LCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, LCE_0007)
#define GMA_TONE_BASE                                                M_CONC(TARGET_SENSOR, GMA_0007)
#define DCE_TONE_BASE                                                M_CONC(TARGET_SENSOR, DCE_0007)
#define LTM_TONE_BASE                                                M_CONC(TARGET_SENSOR, LTM_0007)
#define HLR_TONE_BASE                                                M_CONC(TARGET_SENSOR, HLR_0007)
#define CA_LTM_CA_LTM_BASE                                           M_CONC(TARGET_SENSOR, CA_LTM_0011)
#define CCM_CCM_BASE                                                 M_CONC(TARGET_SENSOR, CCM_0024)
#define COLOR_PARAM_COLOR_BASE                                       M_CONC(TARGET_SENSOR, COLOR_PARAM_0004)
#define COLOR_COLOR_BASE                                             M_CONC(TARGET_SENSOR, COLOR_0240)
