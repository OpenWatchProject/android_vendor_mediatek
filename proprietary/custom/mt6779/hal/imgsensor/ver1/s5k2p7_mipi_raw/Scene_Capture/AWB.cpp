...
const AWB_NVRAM_T AWB_BASE[1] = {
    ...
    /******************************************************************************/
            // AWB light area
            {
                ...
                // TUNGSTEN
                {
                     -92, // TUNGSTEN RightBound
                    -780, // TUNGSTEN LeftBound
                    -362, // TUNGSTEN UpperBound
                    -427  // TUNGSTEN LowerBound
                },
                // WARM FLUORESCENT
                {
                     -92, // WARM FLUORESCENT RightBound
                    -780, // WARM FLUORESCENT LeftBound
                    -427, // WARM FLUORESCENT UpperBound
                    -656  // WARM FLUORESCENT LowerBound
                },
                // FLUORESCENT
                {
                      82, // FLUORESCENT RightBound
                     -92, // FLUORESCENT LeftBound
                    -388, // FLUORESCENT UpperBound
                    -521  // FLUORESCENT LowerBound
                },
                // CWF
                {
                     101, // CWF RightBound
                ...
                // DAYLIGHT
                {
                     238, // DAYLIGHT RightBound
                      82, // DAYLIGHT LeftBound
                    -388, // DAYLIGHT UpperBound
                    -521  // DAYLIGHT LowerBound
                },
                // SHADE
                {
                     568, // SHADE RightBound
                     238, // SHADE LeftBound
                    -388, // SHADE UpperBound
                    -495  // SHADE LowerBound
                },
                // DF
                {
                     238, // DF RightBound
    ...
    /******************************************************************************/
            ...
            // PWB light area
            {
                ...
                // CLOUDY_D
                {
                     363, // CLOUDY_D RightBound
                     188, // CLOUDY_D LeftBound
                    -388, // CLOUDY_D UpperBound
                    -521  // CLOUDY_D LowerBound
                },
                // SHADE
                {
                     463, // SHADE RightBound
                     188, // SHADE LeftBound
                    -388, // SHADE UpperBound
                    -521  // SHADE LowerBound
                },
                // TWILIGHT
                {
                      82, // TWILIGHT RightBound
                     -78, // TWILIGHT LeftBound
                    -388, // TWILIGHT UpperBound
                    -521  // TWILIGHT LowerBound
                },
                // FLUORESCENT
                {
                     258, // FLUORESCENT RightBound
                    -100, // FLUORESCENT LeftBound
                    -398, // FLUORESCENT UpperBound
                    -616  // FLUORESCENT LowerBound
                },
                // WARM FLUORESCENT
                {
                    -130, // WARM FLUORESCENT RightBound
                    -330, // WARM FLUORESCENT LeftBound
                    -398, // WARM FLUORESCENT UpperBound
                    -616  // WARM FLUORESCENT LowerBound
                },
                // INCANDESCENT
                {
                    -130, // INCANDESCENT RightBound
                    -330, // INCANDESCENT LeftBound
                    -388, // INCANDESCENT UpperBound
                    -521  // INCANDESCENT LowerBound
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
            // PWB default gain
            {
                ...
                // FLUORESCENT
                {
                    1086, // PWB_FLUORESCENT_R
                     512, // PWB_FLUORESCENT_G
                     966  // PWB_FLUORESCENT_B
                },
                // WARM FLUORESCENT
                {
                     694, // PWB_WARM FLUORESCENT_R
                     512, // PWB_WARM FLUORESCENT_G
                    1424  // PWB_WARM FLUORESCENT_B
                },
                // INCANDESCENT
                {
                     650, // PWB_INCANDESCENT_R
                     512, // PWB_INCANDESCENT_G
                    1320  // PWB_INCANDESCENT_B
                },
                // GRAY_WORLD
                {
    ...
    /******************************************************************************/
                ...
                {
                    -588,  // RotatedXCoordinate0
                    -438,  // RotatedXCoordinate1
                    -208,  // RotatedXCoordinate2
                     -86,  // RotatedXCoordinate3
    ...
    /******************************************************************************/
                    ...
                    // rSceneJudge
                    {
                         ...
                         -77,    //i4FaceRawXrR_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        -127,    //i4FaceRawXrL_HM for Indoor Hi CT & Mid CT dynamic, Unit = 1000
                        ...
                        -412,    //i4FaceRawYrU for Indoor Greenish CT dynamic, Unit = 1000
                        -462     //i4FaceRawYrD for Indoor Greenish CT dynamic, Unit = 1000
                    },
    /******************************************************************************/
    //Feature name:
    ...
    /******************************************************************************/
                    ...
                    //rRefTarget - Reference Target Setting
                    {
                        ...
                        // i4RefTargetThr
                        {
                            ...
                            {{-572, -365}, {-572, -365}, {-572, -365}},  // HORIZON
                            {{-422, -382}, {-422, -382}, {-422, -382}},  // A
                            {{-204, -408}, {-204, -408}, {-204, -408}},  // TL84
                            {{-173, -521}, {-173, -521}, {-173, -521}},  // CWF
                            {{ -69, -401}, { -69, -401}, { -69, -401}},  // DNP
                            {{  17, -373}, {  17, -373}, {  17, -373}},  // D65
                            {{  18, -485}, {  18, -485}, {  18, -485}},  // DF
                        },
                    },
