...
#include "camera_awb_tuning_para_ov16885mipiraw.h"

#define NVRAM_TUNING_PARAM_NUM  6511001

template <>
AWB_NVRAM_T const&
getAWBNVRAM_ov16885mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
        ...
        // PWB light area
        {
            // Reference area
		        ...
		        // Warm fluorescent
		        {
		            -75, // PWFluoRightBound
		            -275, // PWFluoLeftBound
		            -333, // PWFluoUpperBound
		            -505  // PWFluoLowerBound
		        },
		        // Incandescent
		        {
		            -75, // PIncaRightBound
