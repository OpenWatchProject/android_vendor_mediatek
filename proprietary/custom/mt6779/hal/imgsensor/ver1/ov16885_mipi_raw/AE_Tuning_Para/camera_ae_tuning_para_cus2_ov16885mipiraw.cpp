//Gionee <Amigo_Skip> <jinshiqiang> <20170318> SW17G04 Rear Main2 Camera OV16885 Tuning begin
#include "camera_custom_nvram.h"
#include "camera_ae_tuning_para_ov16885mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_ov16885mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
		...
		32,//150,  // u4PrvMaxFlareThres
        0,                 // u4PrvMinFlareThres
		32,//150,  // u4VideoMaxFlareThres
        ...
        //rMeteringSpec
        {
            ...
            //rABL_Spec
            {
                FALSE,//TRUE,//bEnableBlackLigh
                1024,//u4BackLightWeigh
				400,  // u4Pcent
				12,  // u4Thd
				255,  // u4CenterHighBnd
				256,  // u4TargetStrength
				// sFgBgEVRatio
				{
					2200,  // u4X1
                    0,    //i4Y1
            ...
            //rNS_Spec
            {
				...
				168,//175,  // u4Thd
				60,  // u4FlatThd
				200,//180,  // u4BrightTonePcent
				48,//50,//60,  // u4BrightToneThd
				500,  // u4LowBndPcent
				5,  // u4LowBndThd
				20,//30,  // u4LowBndThdLimit
            ...
            // rTOUCHFD_Spec
            {
				...
				45,//40,  // uFaceYLowBound
				55,//50,  // uFaceYHighBound
