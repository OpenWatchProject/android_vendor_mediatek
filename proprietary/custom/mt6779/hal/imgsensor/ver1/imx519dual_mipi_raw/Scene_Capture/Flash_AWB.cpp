...
#define Flash_AWB_BASE                                               Flash_AWB_Flash_AWB_BASE

const FLASH_AWB_NVRAM_T Flash_AWB_BASE[1] = {
    // IDX_0
    {
        ...
        10,  //FgPercentage_Th3
        15,  //FgPercentage_Th4
        120, //FgPercentage_Th1_Val
        150, //FgPercentage_Th2_Val
        200, //FgPercentage_Th3_Val
