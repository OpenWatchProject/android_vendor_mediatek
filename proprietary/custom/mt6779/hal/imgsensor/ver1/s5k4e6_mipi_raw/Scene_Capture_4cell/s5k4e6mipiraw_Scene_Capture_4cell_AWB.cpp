...
#include "s5k4e6mipiraw_Scene_Capture_4cell.h"

#define NVRAM_AWB_TUNING_PARAM_NUM 7522001

const AWB_NVRAM_T s5k4e6mipiraw_AWB_0001 =
AWB_NVRAM_START
{
...
/******************************************************************************/
                ...
                //rRefTarget - Reference Target Setting
                {
                    ...
                    // i4RefTargetThr
                    {
                        ...
                        {{-586, -334}, {-586, -334}, {-586, -334}},  // TUNGSTEN
                        {{-460, -361}, {-460, -361}, {-460, -361}},  // WARM FLUORESCENT
                        {{-230, -367}, {-230, -367}, {-230, -367}},  // FLUORESCENT
                        {{-218, -456}, {-218, -456}, {-218, -456}},  // CWF
                        {{-126, -388}, {-126, -388}, {-126, -388}},  // DAYLIGHT
                        {{   1, -349}, {   1, -349}, {   1, -349}},  // SHADE
