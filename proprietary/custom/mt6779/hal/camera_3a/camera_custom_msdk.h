...
void GetLensDefaultPara(MUINT32 SensorId, MUINT32 ModuleId, PNVRAM_LENS_PARA_STRUCT pLensParaDefault);

int msdkGetFlickerPara(MUINT32 SensorId, MUINT32 ModuleId, int SensorMode, void* buf, int binRatio = 1);
