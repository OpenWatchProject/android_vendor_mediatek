...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
template <> AE_PARAM_TEMP_T const& getAEParamData<ESensorDev_None, CAM_SCENARIO_PREVIEW>() {
    return getAEParam<ESensorDev_None>();
}
template <> AE_PARAM_TEMP_T const& getAEParamData<ESensorDev_None, CAM_SCENARIO_VIDEO>() {
    return getAEParam<ESensorDev_None>();
}
template <> AE_PARAM_TEMP_T const& getAEParamData<ESensorDev_None, CAM_SCENARIO_CAPTURE>() {
    return getAEParam<ESensorDev_None>();
}
template <> AE_PARAM_TEMP_T const& getAEParamData<ESensorDev_None, CAM_SCENARIO_CUSTOM1>() {
    return getHDRAEParam<ESensorDev_None>();
}
template <> AE_PARAM_TEMP_T const& getAEParamData<ESensorDev_None, CAM_SCENARIO_CUSTOM2>() {
    return getAUTOHDRAEParam<ESensorDev_None>();
}
template <> AE_PARAM_TEMP_T const& getAEParamData<ESensorDev_None, CAM_SCENARIO_CUSTOM3>() {
    return getVTAEParam<ESensorDev_None>();
}
template <> AE_PARAM_TEMP_T const& getAEParamData<ESensorDev_None, CAM_SCENARIO_CUSTOM4>() {
    return getAEParam<ESensorDev_None>();
}
