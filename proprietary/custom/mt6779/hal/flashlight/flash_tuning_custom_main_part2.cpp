#define LOG_TAG "flash_tuning_custom_main_part2.cpp"
...
#if FLASH_NVRAM
#else
static void copyTuningPara_main_part2(FLASH_TUNING_PARA* p, NVRAM_FLASH_TUNING_PARA* nv_p)
{
...
static void copyTuningParaDualFlash_main_part2(FLASH_TUNING_PARA* p, NVRAM_CAMERA_STROBE_STRUCT* nv)
{
...
static int currentMaskFunc_main_part2(int c, int cLt)
{
...
FLASH_PROJECT_PARA& cust_getFlashProjectPara_main_part2(int aeScene, int isForceFlash, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
    ...
    (void)isForceFlash;
        ...
        copyTuningPara_main_part2(&para.tuningPara, &nvrame->tuningPara[ind]);
        copyTuningParaDualFlash_main_part2(&para.tuningPara, nvrame);
#endif
    }
    ...
    para.currentAvailableMaskFunc = currentMaskFunc_main_part2;
