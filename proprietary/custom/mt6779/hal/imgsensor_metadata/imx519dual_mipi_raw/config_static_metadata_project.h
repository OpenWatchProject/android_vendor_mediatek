...
STATIC_METADATA2_BEGIN(PLATFORM, PROJECT, SENSOR_DRVNAME_IMX519DUAL_MIPI_RAW)
   //==========================================================================
...
STATIC_METADATA2_BEGIN(PLATFORM, PRO_OVERWRITE, SENSOR_DRVNAME_IMX519DUAL_MIPI_RAW)
