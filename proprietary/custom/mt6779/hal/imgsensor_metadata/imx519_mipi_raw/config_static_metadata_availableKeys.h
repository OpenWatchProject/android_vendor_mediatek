...
//------------------------------------------------------------------------------
    ...
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        ...
        // Streaming
        CONFIG_ENTRY_VALUE(MTK_STREAMING_FEATURE_HFPS_MODE, MINT32)
    APPEND_METADATA_END()
    //==========================================================================
    ...
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
        ...
        // Streaming
        CONFIG_ENTRY_VALUE(MTK_STREAMING_FEATURE_AVAILABLE_HFPS_MODES, MINT32)
        CONFIG_ENTRY_VALUE(MTK_STREAMING_FEATURE_AVAILABLE_HFPS_MAX_RESOLUTIONS, MINT32)
    APPEND_METADATA_END()
    //==========================================================================
