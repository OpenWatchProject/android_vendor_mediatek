...
#define MAXIMUM_NVRAM_CAMERA_ISP_FILE_SIZE         (640000) // 640K byte (621796 byte )
//#define MAXIMUM_NVRAM_CAMERA_ISP_FILE_SIZE         (143360) // 140K bytes = 140*1024 = 143360
#define MAXIMUM_NVRAM_CAMERA_3A_FILE_SIZE          (70552) // 31K bytes
#define MAXIMUM_NVRAM_CAMERA_SENSOR_FILE_SIZE      (4096)
#define MAXIMUM_NVRAM_CAMERA_LENS_FILE_SIZE        (22528)
#define MAXIMUM_NVRAM_CAMERA_VERSION_FILE_SIZE     (1024)
#define MAXIMUM_NVRAM_CAMERA_FEATURE_FILE_SIZE      (32768)
