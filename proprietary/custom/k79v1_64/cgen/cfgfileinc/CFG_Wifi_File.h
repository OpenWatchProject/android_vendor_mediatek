...
*  Part1OwnVersion:0002
*  Part1PeerVersion:0002
...
typedef struct _WIFI_NVRAM_2G4_WF_PATH_T
{
...
}  WIFI_NVRAM_2G4_WF_PATH_T, *P_WIFI_NVRAM_2G4_WF_PATH_T;
...
typedef struct _WIFI_NVRAM_5G_WF_PATH_T
{
...
}  WIFI_NVRAM_5G_WF_PATH_T, *P_WIFI_NVRAM_5G_WF_PATH_T;
...
typedef struct _WIFI_NVRAM_CO_ANT_T
{
    UINT_8  aucData[64];
} WIFI_NVRAM_CO_ANT_T, *P_WIFI_NVRAM_CO_ANT_T;

typedef struct _WIFI_SOC2_0_NVRAM_PARAM_STRUCT_T
{
    ...
    UINT_8 ucTypeID3;
    UINT_8 ucTypeLen3;
    WIFI_NVRAM_2G4_WF_PATH_T r2G4WF0path;
    UINT_8 ucTypeID4;
    UINT_8 ucTypeLen4;
    WIFI_NVRAM_5G_WF_PATH_T  r5GWF0path;
    UINT_8 ucTypeID5;
    UINT_8 ucTypeLen5;
    ...
    UINT_8 ucTypeID8;
    UINT_8 ucTypeLen8;
    WIFI_NVRAM_2G4_WF_PATH_T r2G4WF1path;
    UINT_8 ucTypeID9;
    UINT_8 ucTypeLen9;
    WIFI_NVRAM_5G_WF_PATH_T  r5GWF1path;
    WIFI_NVRAM_CO_ANT_T rCoAnt;
    /* NVRAM offset[1280] ~ offset[1535] */
    /* NVRAM offset[1536] ~ offset[1791] */
    /* NVRAM offset[1792] ~ offset[2047] */
    UINT_8 aucReserved1[712];
} WIFI_SOC2_0_NVRAM_PARAM_STRUCT_T, *P_WIFI_SOC2_0_NVRAM_PARAM_STRUCT_T,
