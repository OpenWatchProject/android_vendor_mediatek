...
#include "camera_ae_tuning_para_sp250amipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_sp250amipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
    // rDevicesInfo
