...
typedef enum
{
    ...
    CAMERA_CAM_CAL_DATA_PDAF,                               //LukeHu 150729 return none or PDAF
...
typedef struct/*LukeHu++*/
{
    //MUINT8 Data[CAM_CAL_N3D_NUM][CAM_CAL_MAX_LSC_SIZE];
    MUINT8 Data[CAM_CAL_PDAF_SIZE];
...
typedef enum
{
    ...
    CAM_CAL_DOUBLE_EEPROM_DATA,/*LukeHu++151111=For Double EEPRom Data*/
...
typedef struct
{
    ...
    MUINT32 sensorID;/*LukeHu++151106=For Multi-Sensor Calibration*/
    MUINT32 deviceID;
...
{
    CAM_CAL_SUCCESS = 0,
    CAM_CAL_EXCEED_BUFFER,
    CAM_CAL_BAD_ARGUMENT
} CAM_CAL_DEV_NAME_STATUS;
