...
int cust_fillDefaultStrobeNVRam_main (void* data)
{
    ...
    //{ 892,1284,1653,2338,2966,3564,4103,4573,4972,5260};
	  ...
	  //{662,1281,1853,2383,3366,4266,5106,5904,6662,7381,8075,8760,9378,9999};
	  {670,1280,1840,2354,3305,4182,5105,5905,6676,7391,8095,8767,9409,9999};
	//version
	...
	for(i=0;i<8;i++)
    {
        ...
        p->tuningPara[i].ambientRefAccuracyRatio = 10;
        p->tuningPara[i].flashRefAccuracyRatio = 15;
