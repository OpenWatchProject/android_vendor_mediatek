...
#define MAXIMUM_NVRAM_CAMERA_ISP_FILE_SIZE         (236000) // 236K bytes
...
#define MAXIMUM_NVRAM_CAMERA_FEATURE_FILE_SIZE      (7808)
#define MAXIMUM_NVRAM_CAMERA_GEOMETRY_FILE_SIZE     (48000)
