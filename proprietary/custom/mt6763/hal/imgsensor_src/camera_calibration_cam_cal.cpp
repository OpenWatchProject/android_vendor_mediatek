...
#define CAM_CAL_VER "ver1017~"   //2017.10.17
...
UINT32 DoCamCal2AGain(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData)
{
	...
	UINT8 tempGain=1, CalR=1, CalGr=1, CalGb=1, CalG=1, CalB=1, FacR=1, FacGr=1, FacGb=1, FacG=1, FacB=1;
...
UINT32 DoCamCalSingleLsc(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData)
{
    ...
    {
        //if(pCamCalData->sensorID == 0x2107) DoCamCal_Dump(CamcamFID, 0, 6207, pGetSensorCalData);
        ...
        if(pCamCalData->sensorID == 0x0386 || pCamCalData->sensorID == 0x2107)
        {
                table_size = 1868;
        }
...
#if 1	//it have to print!!!!!!!!!!!!!!!20170210
