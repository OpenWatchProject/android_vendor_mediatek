...
#define CAM_CAL_VER "camcal_ver9900~"	//99 mean that chip  00 is our sw ver
...
static UINT32 Is_Read_To_Buffer = 0;	//it will |= deviceID 1,2,4
...
static pthread_mutex_t mEEPROM_Mutex0 = PTHREAD_MUTEX_INITIALIZER;
