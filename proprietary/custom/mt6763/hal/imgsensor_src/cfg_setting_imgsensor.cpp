...
static SensorViewAngle_T const fov_inst = {
    .MainSensorHorFOV  = 67,
    .MainSensorVerFOV  = 49,
    .SubSensorHorFOV   = 65,
    .SubSensorVerFOV   = 40,
    .Main2SensorHorFOV = 75,   //not support
    .Main2SensorVerFOV = 60,
    .Sub2SensorHorFOV = 75,   //not support
    .Sub2SensorVerFOV = 60,
};
...
getSensorViewAngle_H(IMGSENSOR_SENSOR_IDX const idx)
{
    switch (idx) {
        case IMGSENSOR_SENSOR_IDX_MAIN:
            return fov_inst.MainSensorHorFOV;
        case IMGSENSOR_SENSOR_IDX_SUB:
            return fov_inst.SubSensorHorFOV;
        case IMGSENSOR_SENSOR_IDX_MAIN2:
            return fov_inst.Main2SensorHorFOV;
        case IMGSENSOR_SENSOR_IDX_SUB2:
            return fov_inst.Sub2SensorHorFOV;
        default:
            return 0;
    }
}
...
getSensorViewAngle_V(IMGSENSOR_SENSOR_IDX const idx)
{
    switch (idx) {
        case IMGSENSOR_SENSOR_IDX_MAIN:
            return fov_inst.MainSensorVerFOV;
        case IMGSENSOR_SENSOR_IDX_SUB:
            return fov_inst.SubSensorVerFOV;
        case IMGSENSOR_SENSOR_IDX_MAIN2:
            return fov_inst.Main2SensorVerFOV;
        case IMGSENSOR_SENSOR_IDX_SUB2:
            return fov_inst.Sub2SensorVerFOV;
        default:
            return 0;
    }
}
