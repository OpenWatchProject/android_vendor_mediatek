...
GET_LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>() // binning-size vdo record
{
    const static NVRAM_LENS_DATA_PARA_STRUCT LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE =
    {
        {
            //============================================================================================/
    ...
    return LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE;
}
