...
#include "camera_ae_tuning_para_s5k3m3mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_s5k3m3mipiraw<CAM_SCENARIO_CAPTURE>() // CAPTURE
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
                ...
                -24,    // i4BVOffset delta BV = value/10
