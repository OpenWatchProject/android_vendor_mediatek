...
#include "camera_awb_tuning_para_s5k3m3mipiraw.h"

#define NVRAM_TUNING_PARAM_NUM  6511001

template <>
AWB_NVRAM_T const&
getAWBNVRAM_s5k3m3mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
...
/******************************************************************************/
        // PWB light area
        {
            ...
            // Cloudy daylight
            {
                 363, // PCloudyRightBound
                 188, // PCloudyLeftBound
                -388, // PCloudyUpperBound
                -521  // PCloudyLowerBound
            },
            // Shade
            {
                 463, // PShadeRightBound
                 188, // PShadeLeftBound
                -388, // PShadeUpperBound
                -521  // PShadeLowerBound
            },
            // Twilight
            {
                  82, // PTwiRightBound
            ...
            // Warm fluorescent
            {
                ...
                -330, // PWFluoLeftBound
                -398, // PWFluoUpperBound
                -616  // PWFluoLowerBound
            },
            // Incandescent
            {
                -130, // PIncaRightBound
