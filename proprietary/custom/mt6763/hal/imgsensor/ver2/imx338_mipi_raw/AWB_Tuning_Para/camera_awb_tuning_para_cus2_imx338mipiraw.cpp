...
#include "camera_awb_tuning_para_imx338mipiraw.h"

#define NVRAM_TUNING_PARAM_NUM  6511001

template <>
AWB_NVRAM_T const&
getAWBNVRAM_imx338mipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
    ...
    /******************************************************************************/
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                     307, // PCloudyRightBound
                     132, // PCloudyLeftBound
                    -405, // PCloudyUpperBound
                    -558  // PCloudyLowerBound
                },
                // Shade
                {
                     407, // PShadeRightBound
                     132, // PShadeLeftBound
                    -405, // PShadeUpperBound
                    -558  // PShadeLowerBound
                },
                // Twilight
                {
                      -3, // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    ...
                    -426, // PWFluoLeftBound
                    -415, // PWFluoUpperBound
                    -667  // PWFluoLowerBound
                },
                // Incandescent
                {
                    -226, // PIncaRightBound
    ...
    /******************************************************************************/
                ...
                {
                    -635,  // RotatedXCoordinate0
                    -478,  // RotatedXCoordinate1
                    -252,  // RotatedXCoordinate2
    ...
    /******************************************************************************/
                 // Sunset Prop
                 {
                     ...
                     {
                           79, // i4Sunset_BoundXr_Thr
                         -470, // i4Sunset_BoundYr_Thr
                     },
                 },
    /******************************************************************************/
    //Feature name:
