...
STATIC_METADATA2_BEGIN(DEVICE, SCALER, SENSOR_DRVNAME_IMX258_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.scaler
//------------------------------------------------------------------------------
    //==========================================================================
...
/*
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //ADD
...
*/
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_IMPLEMENTATION_DEFINED, MINT32) //ADD
                CONFIG_ENTRY_VALUE(4208, MINT32)
                CONFIG_ENTRY_VALUE(3120, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_INPUT, MINT32)

#if 1
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_RAW16, MINT32) //ADD
                CONFIG_ENTRY_VALUE(4208, MINT32)
                CONFIG_ENTRY_VALUE(3120, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)

                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //ADD
                CONFIG_ENTRY_VALUE(4208, MINT32)
                CONFIG_ENTRY_VALUE(3120, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT32) //WK17.08 add
                CONFIG_ENTRY_VALUE(3840, MINT32)
                CONFIG_ENTRY_VALUE(2160, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_MIN_FRAME_DURATIONS)//new hidden
                /*
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64) //ADD
                ...
                */
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64) //WK17.08 add
                CONFIG_ENTRY_VALUE(3264, MINT64)
                CONFIG_ENTRY_VALUE(2448, MINT64)
                CONFIG_ENTRY_VALUE(50000000, MINT64)
