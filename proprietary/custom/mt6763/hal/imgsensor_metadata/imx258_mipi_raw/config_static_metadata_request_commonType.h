...
STATIC_METADATA2_BEGIN(DEVICE, REQUEST, SENSOR_DRVNAME_IMX258_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_CONTROL_AE_LOCK_AVAILABLE, MINT32) //WK17.08 add
        ...
        CONFIG_ENTRY_VALUE(MTK_SHADING_AVAILABLE_MODES, MINT32)//WK17.08 add
