...
STATIC_METADATA2_BEGIN(DEVICE, SCALER, SENSOR_DRVNAME_IMX386_MIPI_RAW_bayerbayer)
//------------------------------------------------------------------------------
//  android.scaler
//------------------------------------------------------------------------------
    //==========================================================================
...
//    { "cropRegion",                    TYPE_INT32  },
    ...
    //==========================================================================
     CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS)//new hidden
                ...
                CONFIG_ENTRY_VALUE(4000, MINT32)
                CONFIG_ENTRY_VALUE(2256, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT32) //4k2k
                ...
                CONFIG_ENTRY_VALUE(3016, MINT32)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT32)
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_MIN_FRAME_DURATIONS)//new hidden
                ...
                CONFIG_ENTRY_VALUE(4000, MINT64)
                CONFIG_ENTRY_VALUE(2256, MINT64)
                CONFIG_ENTRY_VALUE(66666666, MINT64)
