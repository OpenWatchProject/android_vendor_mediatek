...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_INFO_VERSION)
        CONFIG_ENTRY_VALUE(((MUINT8)'M'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'T'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'K'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'_'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'I'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'S'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'P'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'3'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'5'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'\0'), MUINT8)
    CONFIG_METADATA_END()
...
//------------------------------------------------------------------------------
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_LOGICAL_MULTI_CAMERA_PHYSICAL_IDS)
        CONFIG_ENTRY_VALUE(((MUINT8)'0'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'\0'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'2'), MUINT8)
        CONFIG_ENTRY_VALUE(((MUINT8)'\0'), MUINT8)
    CONFIG_METADATA_END()
    //==========================================================================
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
    ...
    case 2:
        ...
        CONFIG_METADATA_BEGIN(MTK_HAL_VERSION)
            CONFIG_ENTRY_VALUE(MTK_HAL_VERSION_3_4, MINT32)
        CONFIG_METADATA_END()
        //======================================================================
        break;
