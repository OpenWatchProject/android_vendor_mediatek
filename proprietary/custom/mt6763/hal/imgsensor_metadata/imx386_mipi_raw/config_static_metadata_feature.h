...
STATIC_METADATA2_BEGIN(DEVICE, FEATURE, SENSOR_DRVNAME_IMX386_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.control
//------------------------------------------------------------------------------
    //==========================================================================
...
//        CONFIG_ENTRY_VALUE(MTK_STATISTICS_FACE_DETECT_MODE_FULL,MUINT8)
    ...
    CONFIG_METADATA_BEGIN(MTK_HDR_FEATURE_AVAILABLE_VHDR_MODES)
        CONFIG_ENTRY_VALUE(MTK_HDR_FEATURE_VHDR_MODE_OFF,  MINT32)
    CONFIG_METADATA_END()
#endif
    //==========================================================================
    //==========================================================================
...
//------------------------------------------------------------------------------
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_CONTROL_CAPTURE_JPEG_FLIP_MODE)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_CAPTURE_JPEG_FLIP_MODE_OFF, MINT32)
        CONFIG_ENTRY_VALUE(MTK_CONTROL_CAPTURE_JPEG_FLIP_MODE_ON, MINT32)
    CONFIG_METADATA_END()
   //==========================================================================
