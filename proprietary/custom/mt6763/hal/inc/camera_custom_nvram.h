...
#define NVRAM_UDM_TBL_NUM               (1180)
#define NVRAM_GGM_TBL_NUM               (5)
#define NVRAM_IHDR_GGM_TBL_NUM          (16)
#define NVRAM_ANR_TBL_NUM               (1420)
#define NVRAM_ANR2_TBL_NUM              (1420)
#define NVRAM_CCR_TBL_NUM               (480)
#define NVRAM_BOK_TBL_NUM               (60)
#define NVRAM_HFG_TBL_NUM               (1280)
#define NVRAM_EE_TBL_NUM                (1400)
...
typedef struct {
    ...
    MINT32 i4FaceLCEPara[ISP_NVRAM_LCE_DETAIL_TBL_NUM];
