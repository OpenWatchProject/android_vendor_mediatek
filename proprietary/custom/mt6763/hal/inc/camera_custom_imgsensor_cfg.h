...
typedef enum
{
	...
	EMipiPort_CSI1A, 	 // 2D1C
	EMipiPort_CSI1B, 	 // 2D1C
...
typedef struct SensorOrientation_S
{
    ...
    MUINT32 u4Degree_3;     //  sub2 sensor in degree (0, 90, 180, 270)
} SensorOrientation_T;
...
typedef struct SensorViewAngle_S
{
    ...
    MUINT32 Sub2SensorHorFOV;     //  sub2 sensor horizontal view angle, 0: not support
    MUINT32 Sub2SensorVerFOV;     //  sub2 sensor vertical view angle, 0: not support
} SensorViewAngle_T;
