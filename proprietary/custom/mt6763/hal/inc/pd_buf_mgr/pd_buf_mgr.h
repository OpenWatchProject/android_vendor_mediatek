...
protected:
    ...
    */
    MBOOL pdoPixelPos(MUINT32 pPdoPixPos[][2], MUINT32 pdNum, MUINT32 subBlkH);
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    */
    virtual MBOOL SetPDBlockInfo( SET_PD_BLOCK_INFO_T &iPDBlockInfo, SPDProfile_t &iPdProfile);
    /**
    * @brief send command.
    */
