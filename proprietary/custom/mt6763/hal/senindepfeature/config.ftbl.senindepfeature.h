...
//==========================================================================
    ...
    //  EIS25 ON/OFF
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_EIS_SUPPORTED_FRAMES),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("0"),
            ITEM_AS_VALUES_(
                "0",
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_EIS25_MODE),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("0"),
            ITEM_AS_VALUES_(
             "0",
...
//==========================================================================
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_STEREO_VSDOF_MODE),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::OFF),
            ITEM_AS_VALUES_(
                MtkCameraParameters::ON,
...
//  STEREO CAMERA ON/OFF
#if (1 == STEREO_CAMERA_SUPPORTED)
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_STEREO_CAPTURE_MODE),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::OFF),
            ITEM_AS_VALUES_(
                MtkCameraParameters::ON,
...
//==========================================================================
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_DISPLAY_ROTATION_SUPPORTED),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::TRUE),
            ITEM_AS_VALUES_(
                MtkCameraParameters::TRUE,
