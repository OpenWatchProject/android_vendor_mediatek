...
#define LINK_ONE_SENSOR_ONE_SCENE_ISOs(link, sensor, scene)\
    link(sensor, scene, eIDX_ISO_0);\
    link(sensor, scene, eIDX_ISO_1);\
    link(sensor, scene, eIDX_ISO_2);\
    link(sensor, scene, eIDX_ISO_3);\
    link(sensor, scene, eIDX_ISO_4);\
    link(sensor, scene, eIDX_ISO_5);\
    link(sensor, scene, eIDX_ISO_6);\
    link(sensor, scene, eIDX_ISO_7);\
    link(sensor, scene, eIDX_ISO_8);\
    link(sensor, scene, eIDX_ISO_9);\
    link(sensor, scene, eIDX_ISO_10);\
    link(sensor, scene, eIDX_ISO_11);\
    link(sensor, scene, eIDX_ISO_12);\
    link(sensor, scene, eIDX_ISO_13);\
    link(sensor, scene, eIDX_ISO_14);\
    link(sensor, scene, eIDX_ISO_15);\
    link(sensor, scene, eIDX_ISO_16);\
    link(sensor, scene, eIDX_ISO_17);\
    link(sensor, scene, eIDX_ISO_18);\
    link(sensor, scene, eIDX_ISO_19);
