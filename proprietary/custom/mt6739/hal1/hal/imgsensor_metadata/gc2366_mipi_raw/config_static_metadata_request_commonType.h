...
STATIC_METADATA2_BEGIN(DEVICE, REQUEST, SENSOR_DRVNAME_GC2366_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
...
//        CONFIG_ENTRY_VALUE(MTK_REQUEST_AVAILABLE_CAPABILITIES_RAW, MUINT8)
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        ...
        // Stereo
        CONFIG_ENTRY_VALUE(MTK_STEREO_FEATURE_DOF_LEVEL, MINT32)
        CONFIG_ENTRY_VALUE(MTK_STEREO_FEATURE_DEPTH_AF_ON, MINT32)
        CONFIG_ENTRY_VALUE(MTK_STEREO_FEATURE_DISTANCE_MEASURE_ON, MINT32)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_RESULT_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_NR_FEATURE_3DNR_MODE, MINT32)
        // Stereo
        CONFIG_ENTRY_VALUE(MTK_STEREO_FEATURE_RESULT_DOF_LEVEL, MINT32)
        CONFIG_ENTRY_VALUE(MTK_STEREO_FEATURE_WARNING, MINT32)
        CONFIG_ENTRY_VALUE(MTK_STEREO_FEATURE_RESULT_DISTANCE, MINT32)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
        ...
        // Stereo
        CONFIG_ENTRY_VALUE(MTK_STEREO_FEATURE_SUPPORTED_DOF_LEVEL, MINT32)
     CONFIG_METADATA_END()
    //==========================================================================
//------------------------------------------------------------------------------
STATIC_METADATA_END()
