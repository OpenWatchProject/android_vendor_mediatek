...
#define NVRAM_CUSTOM_REVISION   6511001
...
typedef struct
{
    ...
    UINT8 reserved[MAXIMUM_NVRAM_CAMERA_3A_FILE_SIZE-sizeof(UINT32)*2-sizeof(AE_NVRAM_T)*CAM_SCENARIO_NUM-sizeof(AWB_NVRAM_T)*CAM_SCENARIO_NUM-sizeof(FLASH_AWB_NVRAM_T)];
...
* ISP NVRAM parameter
********************************************************************************/
#define NVRAM_DBS_TBL_NUM               (640)
#define NVRAM_OBC_TBL_NUM               (128)
#define NVRAM_BPC_TBL_NUM               (640)
#define NVRAM_NR1_TBL_NUM               (640)
#define NVRAM_PDC_TBL_NUM               (640)
#define NVRAM_LSC_TBL_NUM               (SHADING_SUPPORT_OP_NUM)
#define NVRAM_SL2_TBL_NUM               (NVRAM_LSC_TBL_NUM*SHADING_SUPPORT_CT_NUM)
#define NVRAM_CFA_TBL_NUM               (640) // +1: default for disable
#define NVRAM_CCM_TBL_NUM               (4)
#define NVRAM_GGM_TBL_NUM               (5)
#define NVRAM_IHDR_GGM_TBL_NUM          (16)
#define NVRAM_ANR_TBL_NUM               (680)//(410)
#define NVRAM_CCR_TBL_NUM               (100)//(70)
#define NVRAM_EE_TBL_NUM                (640)//(370)
...
typedef struct
{
    ...
    ISP_NVRAM_NSL2A_T           SL2[NVRAM_SL2_TBL_NUM];
...
public:     ////    Set Index
    ...
    inline bool setIdx_DBS(UINT16 const idx)        { return setIdx(m_rIdx.DBS, idx, NUM_OBC); }
...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    ...
    inline ISP_NVRAM_NSL2A_T&       getSL2() { return m_rRegs.SL2[getIdx_SL2()]; }
    ...
    inline ISP_NVRAM_NSL2A_T&       getSL2(UINT16 const idx) { return m_rRegs.SL2[idx]; }
...
typedef struct
{
    ...
    UINT8 reserved[MAXIMUM_NVRAM_CAMERA_LENS_FILE_SIZE-sizeof(UINT32)-sizeof(FOCUS_RANGE_T)-sizeof(NVRAM_LENS_DATA_PARA_STRUCT)*AF_CAM_SCENARIO_NUM];
...
typedef union
{
    struct
    {
        short ispVer[5]; //main, sub, sub2, main2, main3
        short aaaVer[5];
        short shadingVer[5];
        short lensVer[5];
        short aePlineVer[5];
...
typedef struct NVRAM_CAMERA_FEATURE_STRUCT_t
{
    ...
    UINT8 reserved[MAXIMUM_NVRAM_CAMERA_FEATURE_FILE_SIZE-sizeof(NVRAM_CAMERA_FEATURE_GIS_STRUCT)-sizeof(NVRAM_CAMERA_FEATURE_MFLL_STRUCT)-sizeof(NVRAM_CAMERA_FEATURE_SWNR_STRUCT)*NVRAM_SWNR_TBL_NUM];
