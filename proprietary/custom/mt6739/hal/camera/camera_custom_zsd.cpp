...
int get_zsd_cap_stored_frame_cnt(void)
{
    ...
    if (atoi(value)) {
        ...
        int skipGMO = property_get_int32("vendor.debug.camera.skipgmozsd", 1);
        if(skipGMO!=0)
            return 3;
        else
            return 1;
...
int get_zsd_cap_stored_delay_time_ms(void)
{
    return 100;
}
int get_zsd_cap_stored_delay_toleration_ms(void)
{
    return 20;
}
