...
ifeq ($(MTK_PROJECT),tb8765ap1_bsp)
    LOCAL_CFLAGS += -DMTKCAM_SUB_FLASHLIGHT_SUPPORT=1
endif

ifeq ($(MTK_PROJECT),tb8765ap1_64_bsp)
    LOCAL_CFLAGS += -DMTKCAM_SUB_FLASHLIGHT_SUPPORT=1
endif

ifeq ($(MTK_PROJECT),tb8765ap1_bsp_1g)
    LOCAL_CFLAGS += -DMTKCAM_SUB_FLASHLIGHT_SUPPORT=1
endif
...
LOCAL_SRC_FILES += \
  ...
  flash_tuning_custom_cct_default.cpp \
  flash_tuning_2ndPart_cct_default2.cpp \
...
#-----------------------------------------------------------
LOCAL_HEADER_LIBRARIES += libcutils_headers liblog_headers libutils_headers
#-----------------------------------------------------------
