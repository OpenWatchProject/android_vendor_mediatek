...
STATIC_METADATA2_BEGIN(PLATFORM, AVAILABLE_KEYS, SENSOR_DRVNAME_GC2365_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
    ...
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)
        ...
        APPEND_ENTRY_VALUE(MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS, MINT32)
    APPEND_METADATA_END()
    //==========================================================================
