...
STATIC_METADATA2_BEGIN(PLATFORM, MODULE, SENSOR_DRVNAME_OV8856_MIPI_RAW_5MP)
...
STATIC_METADATA2_BEGIN(PLATFORM, MOD_OVERWRITE, SENSOR_DRVNAME_OV8856_MIPI_RAW_5MP)
