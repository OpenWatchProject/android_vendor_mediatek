...
STATIC_METADATA2_BEGIN(DEVICE, REQUEST, SENSOR_DRVNAME_S5K3L8_MIPI_RAW_bayerbayer)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)//new hidden
        ...
        // multi cam
        CONFIG_ENTRY_VALUE(MTK_MULTI_CAM_FEATURE_MODE, MINT32)
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_RESULT_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_3A_FEATURE_AWB_AVAILABL_RANGE, MINT32)        // vendor tag
        //p2done callback
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS, MINT32)
