...
STATIC_METADATA2_BEGIN(PLATFORM, PROJECT, DEFAULT)
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS_CANDIDATES)//new hidden
                ...
                CONFIG_ENTRY_VALUE(4192, MINT64)
                CONFIG_ENTRY_VALUE(3136, MINT64)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT64)
                ...
                CONFIG_ENTRY_VALUE(   0, MINT64)
    CONFIG_METADATA_END()
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_RECOMMENDED_STREAM_CONFIGURATIONS_CANDIDATES)//new hidden
