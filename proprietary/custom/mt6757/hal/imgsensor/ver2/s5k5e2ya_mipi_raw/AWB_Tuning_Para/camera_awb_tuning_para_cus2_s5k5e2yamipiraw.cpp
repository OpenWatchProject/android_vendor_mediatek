...
#include "camera_awb_tuning_para_s5k5e2yamipiraw.h"

#define NVRAM_TUNING_PARAM_NUM  6511001

template <>
AWB_NVRAM_T const&
getAWBNVRAM_s5k5e2yamipiraw<CAM_SCENARIO_CUSTOM2>() // AUTO HDR
{
