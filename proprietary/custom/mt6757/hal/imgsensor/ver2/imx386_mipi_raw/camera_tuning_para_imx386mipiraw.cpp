...
#include "AWB_Tuning_Para/camera_awb_tuning_para_imx386mipiraw.h"
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    AWB_NVRAM_START
    {
        getAWBNVRAM_imx386mipiraw<CAM_SCENARIO_PREVIEW>(),
        getAWBNVRAM_imx386mipiraw<CAM_SCENARIO_VIDEO>(),
        getAWBNVRAM_imx386mipiraw<CAM_SCENARIO_CAPTURE>(),
        getAWBNVRAM_imx386mipiraw<CAM_SCENARIO_CUSTOM1>(),
        getAWBNVRAM_imx386mipiraw<CAM_SCENARIO_CUSTOM2>(),
        getAWBNVRAM_imx386mipiraw<CAM_SCENARIO_CUSTOM3>(),
        getAWBNVRAM_imx386mipiraw<CAM_SCENARIO_CUSTOM4>()
    },
