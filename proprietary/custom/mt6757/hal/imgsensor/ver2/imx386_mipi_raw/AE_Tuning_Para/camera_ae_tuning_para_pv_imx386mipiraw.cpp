...
#include "camera_ae_tuning_para_imx386mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_imx386mipiraw<CAM_SCENARIO_PREVIEW>() // PREVIEW
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
                ...
                //rMeteringSpec
                {
                    ...
                    //rABL_Spec
                    {
                        ...
                        200, //256, // final target limitation, 256/128 = 2x
                        //sFgBgEVRatio
                        {
                            3600,//2200, //i4X1
                            0,    //i4Y1
