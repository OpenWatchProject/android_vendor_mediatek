...
#include "camera_AE_PLineTable_s5k2l7mipiraw.h"
#include "camera_info_s5k2l7mipiraw.h"
...
{
    int freq[9] = {80, 90, 100, 110, 120, 130, 140, 160, 230};
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1110, 418, 782, -395};
    FLICKER_CUST_STATISTICS EV60_L50 = {1280, 456, 1204, -478};
    FLICKER_CUST_STATISTICS EV60_L60 = {-162, 2898, 247, -642};
    for (int i = 0; i < 9; i++)
        para->flickerFreq[i] = freq[i];
    para->flickerGradThreshold = 24;
...
static void get_flicker_para_by_Custom1_Bin2(FLICKER_CUST_PARA* para)
{
    ...
    FLICKER_CUST_STATISTICS EV50_L50 = {-194, 4721, 381, -766};
    FLICKER_CUST_STATISTICS EV50_L60 = {1094, 424, 793, -399};
