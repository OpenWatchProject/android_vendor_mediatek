...
#include "lens_para_LC898212XDAF_MONO.h"
...
const NVRAM_LENS_PARA_STRUCT LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // SCENARIO NVRAM
    {
        GET_LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_VIDEO>(),
        GET_LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CAPTURE>(),
        GET_LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>(),
        GET_LC898212XDAF_MONO_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>()
    },
