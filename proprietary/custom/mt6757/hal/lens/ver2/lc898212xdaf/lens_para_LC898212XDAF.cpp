...
#include "lens_para_LC898212XDAF.h"
...
const NVRAM_LENS_PARA_STRUCT LC898212XDAF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
        ...
        20, //i4AFC_STEP_SIZE;
        12, // i4SPOT_PERCENT_W;        // AFC window location
        16, // i4SPOT_PERCENT_H;        // AFC window location
    ...
    // SCENARIO NVRAM
    {
        GET_LC898212XDAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_VIDEO>(),
        GET_LC898212XDAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CAPTURE>(),
        GET_LC898212XDAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>(),
        GET_LC898212XDAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>()
    },
