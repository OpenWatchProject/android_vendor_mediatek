...
#include "lens_para_LC898212XDAF_BAYER.h"

const NVRAM_LENS_PARA_STRUCT LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // SCENARIO NVRAM
    {
        GET_LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_VIDEO>(),
        GET_LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CAPTURE>(),
        GET_LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>(),
        GET_LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>()
    },
...
UINT32 LC898212XDAF_BAYER_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &LC898212XDAF_BAYER_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pLC898212XDAF_BAYER_getDefaultData = LC898212XDAF_BAYER_getDefaultData;
