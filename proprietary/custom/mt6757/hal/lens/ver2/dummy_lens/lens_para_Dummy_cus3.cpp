...
template <>
AF_NVRAM_T const&
GET_DUMMY_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>() // binning-size vdo record
{
    static AF_NVRAM_T DUMMY_LENS_PARA_DEFAULT_VALUE =
    {
        // AF NVRAM
        // ------------------------------ sAF_Coef -----------------------------------------
        {
    ...
    return DUMMY_LENS_PARA_DEFAULT_VALUE;
}
