...
#include "lens_para_AK7371AF.h"

const NVRAM_LENS_PARA_STRUCT AK7371AF_LENS_PARA_DEFAULT_VALUE =
{
    //Version
    ...
    // AF NVRAM
    {
        ...
        {0,
         ...
         //================================================================================/
         //[1] name: enable full scan searching if AP ROI is too large
         //--------------------------------------------------------------------------------/
         1} //[256]
    },
    {
    ...
    // SCENARIO NVRAM
    {
        GET_AK7371AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_AK7371AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_VIDEO>(),
        GET_AK7371AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CAPTURE>(),
        GET_AK7371AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_AK7371AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_AK7371AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>(),
        GET_AK7371AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>()
    },
...
UINT32 AK7371AF_getDefaultData(VOID *pDataBuf, UINT32 size)
{
    ...
    memcpy(pDataBuf, &AK7371AF_LENS_PARA_DEFAULT_VALUE, dataSize);

    return 0;
}

PFUNC_GETLENSDEFAULT pAK7371AF_getDefaultData = AK7371AF_getDefaultData;
