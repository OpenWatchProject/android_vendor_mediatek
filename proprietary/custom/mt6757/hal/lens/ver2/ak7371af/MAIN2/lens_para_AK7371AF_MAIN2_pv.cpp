...
template <>
AF_NVRAM_T const&
GET_AK7371AF_MAIN2_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>() // PREVIEW
{
    static AF_NVRAM_T AK7371AF_MAIN2_LENS_PARA_DEFAULT_VALUE =
    {
        // ------------------------------ sAF_Coef -----------------------------------------
        {
            {
        ...
        // -------------------- sAF_TH ---------------------
        {
				    ...
				    // SGG1~7
				    {21, 21, 21, 21, 20, 20, 20, 11,
				     31, 31, 30, 30, 30, 29, 29, 19,
				     44, 44, 44, 44, 43, 43, 42, 32,
				     63, 63, 63, 62, 62, 62, 61, 51,
				     90, 89, 89, 89, 89, 89, 88, 79,
				     127, 127, 127, 127, 127, 127, 126, 119,
				     181, 181, 180, 180, 180, 180, 180, 175},
    ...
    return AK7371AF_MAIN2_LENS_PARA_DEFAULT_VALUE;
}
