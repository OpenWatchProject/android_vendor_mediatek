...
const NVRAM_LENS_PARA_STRUCT BU6429AF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // SCENARIO NVRAM
    {
        GET_BU6429AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_BU6429AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_VIDEO>(),
        GET_BU6429AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CAPTURE>(),
        GET_BU6429AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_BU6429AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>(),
        GET_BU6429AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_CUSTOM3>(),
        GET_BU6429AF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>()
    },
