...
const NVRAM_LENS_PARA_STRUCT FM50AF_LENS_PARA_DEFAULT_VALUE =
{
    ...
    // AF NVRAM
    {
        ...
        // -------------------- sAF_TH ---------------------
        {
            ...
            {7000,7000,7000,7000,7000,7000,7000,7000}, // i4MIN_TH1[ISO_MAX_NUM];

            {3,3,3,4,4,4,4,5}, // i4HW_TH1[ISO_MAX_NUM];
        ...
        // ------------------- sZSDAF_TH -----------------------------------
        {
            ...
            {10000,10000,10000,10000,10000,9000,9000,9000}, // i4MIN_TH1[ISO_MAX_NUM];

            {5,6,9,9,11,11,11,12}, // i4HW_TH1[ISO_MAX_NUM];
