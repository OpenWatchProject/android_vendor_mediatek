...
#define DBG_AWB_PARAM_REVISION 	6181001
...
enum
{
    ...
    AWB_TAG_STAT_MO_COUNT,    // AWB statistics motion count
    AWB_TAG_STAT_ERR_MO_COUNT,    // AWB statistics error & motion count
...
#define AWB_DEBUG_TAG_VERSION   (AWB_TAG_OLYMPUS)
