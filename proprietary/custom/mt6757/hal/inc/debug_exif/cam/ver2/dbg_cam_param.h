...
#define CHKSUM_DBG_MF_PARAM CHKSUM_DBG_CAM_MF_PARAM5
#define CHKSUM_DBG_N3D_PARAM CHKSUM_DBG_CAM_N3D_PARAM3
#define CHKSUM_DBG_SENSOR_PARAM CHKSUM_DBG_CAM_SENSOR_PARAM0
#define CHKSUM_DBG_RESERVEA_PARAM CHKSUM_DBG_CAM_RESERVEA_PARAM2
#define CHKSUM_DBG_RESERVEB_PARAM CHKSUM_DBG_CAM_RESERVEB_PARAM0
//
using namespace dbg_cam_common_param_1;
using namespace dbg_cam_mf_param_5;
