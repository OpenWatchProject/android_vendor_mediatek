...
} ISP_DIP_X_ANR_MED1_T; //  /* 0x1502444C */

typedef union {
    typedef ISP_DIP_X_ANR_MED1_T reg_t;
    reg_t   bits;
    MUINT32 val;
...
typedef struct {
    ...
    FIELD  rsv_29                                :  3;    /* 29..31, 0xE0000000 */
} ISP_DIP_X_ANR_MED2_T; //  /* 0x15024450 */

typedef union {
    typedef ISP_DIP_X_ANR_MED2_T reg_t;
    reg_t   bits;
    MUINT32 val;
...
typedef struct {
    ...
    FIELD  rsv_30                                :  2;    /* 30..31, 0xC0000000 */
} ISP_DIP_X_ANR_MED3_T; //  /* 0x15024454 */

typedef union {
    typedef ISP_DIP_X_ANR_MED3_T reg_t;
    reg_t   bits;
    MUINT32 val;
...
typedef struct {
    ...
    FIELD  rsv_30                                :  2;    /* 30..31, 0xC0000000 */
} ISP_DIP_X_ANR_MED4_T; //  /* 0x15024458 */

typedef union {
    typedef ISP_DIP_X_ANR_MED4_T reg_t;
    reg_t   bits;
    MUINT32 val;
...
typedef struct {
    ...
    FIELD  rsv_24                                :  8;    /* 24..31, 0xFF000000 */
} ISP_DIP_X_ANR_MED5_T; //  /* 0x1502445C */

typedef union {
    typedef ISP_DIP_X_ANR_MED5_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR_MED5_T;
...
} ISP_DIP_X_ANR_HP1_T; // /* 0x15024460 */

typedef union {
    typedef ISP_DIP_X_ANR_HP1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR_HP1_T;
...
} ISP_DIP_X_ANR_HP2_T; // /* 0x15024464 */

typedef union {
    typedef ISP_DIP_X_ANR_HP2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR_HP2_T;
...
} ISP_DIP_X_ANR_HP3_T; // /* 0x15024468 */

typedef union {
    typedef ISP_DIP_X_ANR_HP3_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR_HP3_T;
...
} ISP_DIP_X_ANR_ACT3_T; //  /* 0x15024474 */

typedef union {
    typedef ISP_DIP_X_ANR_ACT3_T reg_t;
    reg_t   bits;
    MUINT32 val;
...
} ISP_DIP_X_ANR_RSV1_T; //  /* 0x150244B0 */

typedef union {
    typedef ISP_DIP_X_ANR_RSV1_T reg_t;
    reg_t   bits;
    MUINT32 val;
...
// DIP_X_ANR2_CON1 CAM+A20H
typedef struct {
		FIELD ANR2_ENC 					: 1;		
		FIELD ANR2_ENY 					: 1;		
		FIELD rsv_2						: 2;		
		FIELD ANR2_SCALE_MODE			: 2;		
		FIELD rsv_6						: 6;		
		FIELD ANR2_MODE					: 1;		
		FIELD rsv_13					: 3;		
		FIELD ANR2_TILE_EDGE			: 4;		
		FIELD rsv_20					: 4;		
		FIELD ANR2_LCE_LINK				: 1;		
		FIELD rsv_25					: 7;
} ISP_DIP_X_ANR2_CON1_T;

typedef union {
    enum { MASK     = 0x010F1033 };
    typedef ISP_DIP_X_ANR2_CON1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR2_CON1_T;

// DIP_X_ANR2_CON2 CAM+A24H
typedef struct {
		FIELD rsv_0						: 4;		
		FIELD ANR2_C_MED_EN				: 2;		
		FIELD rsv_6						: 2;		
		FIELD ANR2_C_SM_EDGE			: 2;	
		FIELD rsv_10					: 2;		
		FIELD ANR2_FLT_C				: 1;		
		FIELD rsv_13					: 19;
} ISP_DIP_X_ANR2_CON2_T;

typedef union {
    enum { MASK     = 0x00001330 };
    typedef ISP_DIP_X_ANR2_CON2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR2_CON2_T;

// DIP_X_ANR2_YAD1 CAM+A2CH
typedef struct {	
		FIELD rsv_0						: 28;		
		FIELD ANR2_K_TH_C				: 4;
} ISP_DIP_X_ANR2_YAD1_T;

typedef union {
    enum { MASK     = 0xF0000000 };
    typedef ISP_DIP_X_ANR2_YAD1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR2_YAD1_T;

// DIP_X_ANR2_Y4LUT1 CAM+A34H
typedef struct {
		FIELD ANR2_Y_CPX1				: 8;		
		FIELD ANR2_Y_CPX2				: 8;		
		FIELD ANR2_Y_CPX3				: 8;		
		FIELD rsv_24					: 8;
} ISP_DIP_X_ANR2_Y4LUT1_T;
...
// DIP_X_ANR2_Y4LUT2 CAM+A38H
typedef struct {
		FIELD ANR2_Y_SCALE_CPY0			: 5;		
		FIELD rsv_5						: 3;		
		FIELD ANR2_Y_SCALE_CPY1			: 5;		
		FIELD rsv_13					: 3;	
		FIELD ANR2_Y_SCALE_CPY2			: 5;	
		FIELD rsv_21					: 3;		
		FIELD ANR2_Y_SCALE_CPY3			: 5;		
		FIELD rsv_29					: 3;
} ISP_DIP_X_ANR2_Y4LUT2_T;
...
// DIP_X_ANR2_Y4LUT3 CAM+A3CH
typedef struct {
        FIELD ANR2_Y_SCALE_SP0          : 5;
        FIELD rsv_5                     : 3;
        FIELD ANR2_Y_SCALE_SP1          : 5;
        FIELD rsv_13                    : 3;
        FIELD ANR2_Y_SCALE_SP2          : 5;
        FIELD rsv_21                    : 3;
        FIELD ANR2_Y_SCALE_SP3          : 5;
        FIELD rsv_29                    : 3;
} ISP_DIP_X_ANR2_Y4LUT3_T;
...
// DIP_X_ANR2_L4LUT2
typedef struct {
		FIELD ANR2_LCE_GAIN0			 : 6;		
		FIELD rsv_6					     : 2;		
		FIELD ANR2_LCE_GAIN1			 : 6;		
		FIELD rsv_14					 : 2;		
		FIELD ANR2_LCE_GAIN2			 : 6;		
		FIELD rsv_22					 : 2;		
		FIELD ANR2_LCE_GAIN3			 : 6;		
		FIELD rsv_30					 : 2;
} ISP_DIP_X_ANR2_L4LUT2_T;
...
// DIP_X_ANR2_L4LUT3
typedef struct {
		FIELD ANR2_LCE_SP0 				 : 6;		
		FIELD rsv_6						 : 2;		
		FIELD ANR2_LCE_SP1 				 : 6;		
		FIELD rsv_14					 : 2;		
		FIELD ANR2_LCE_SP2 				 : 6;		
		FIELD rsv_22					 : 2;		
		FIELD ANR2_LCE_SP3 				 : 6;		
		FIELD rsv_30					 : 2;		
} ISP_DIP_X_ANR2_L4LUT3_T;
...
// DIP_X_ANR2_CAD CAM+A44H
typedef struct {
		FIELD ANR2_PTC_VGAIN			: 4;		
		FIELD ANR2_C_GAIN				: 4;	
		FIELD ANR2_PTC_GAIN_TH 			: 5;	
		FIELD rsv_13					: 3;	
		FIELD ANR2_C_L_DIFF_TH 			: 8;
        FIELD ANR2_C_MODE               : 1;
		FIELD rsv_25					: 7;
} ISP_DIP_X_ANR2_CAD_T;

typedef union {
    enum { MASK     = 0x01FF1FFF };
    typedef ISP_DIP_X_ANR2_CAD_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR2_CAD_T;

// DIP_X_ANR2_PTC CAM+A48H
typedef struct {
        FIELD ANR2_PTC1                  : 8;
        FIELD ANR2_PTC2                  : 8;
        FIELD ANR2_PTC3                  : 8;
        FIELD ANR2_PTC4                  : 8;
} ISP_DIP_X_ANR2_PTC_T;
...
// DIP_X_ANR2_LCE CAM+A4CH
typedef struct {
        FIELD  ANR2_LCE_C_GAIN           :  4;      
        FIELD  rsv_4                     : 12;     
        FIELD  ANR2_LM_WT                :  4;     
        FIELD  rsv_20                    : 12;     
} ISP_DIP_X_ANR2_LCE_T;

typedef union {
    enum { MASK     = 0x000F000F };
...
// DIP_X_ANR2_MED5
typedef struct {
        FIELD ANR2_LCL_OFT              : 8;
        FIELD ANR2_SCL_OFT              : 6;
        FIELD rsv_14                    : 2;
        FIELD ANR2_NCL_OFT              : 8;
        FIELD rsv_24                    : 8;
} ISP_DIP_X_ANR2_MED5_T;
...
// DIP_X_ANR2_ACTY CAM+A60H
typedef struct {
        FIELD ANR2_ACT_TH_Y             : 8;
        FIELD ANR2_ACT_BLD_BASE_Y       : 7;
        FIELD rsv_15                    : 1;
        FIELD ANR2_ACT_SLANT_Y          : 5;
        FIELD rsv_21                    : 3;
        FIELD ANR2_ACT_BLD_TH_Y         : 7;
        FIELD rsv_31                    : 1;
} ISP_DIP_X_ANR2_ACTY_T;

typedef union {
    enum { MASK     = 0x7F1F7FFF };
    typedef ISP_DIP_X_ANR2_ACTY_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR2_ACTY_T;

// DIP_X_ANR2_ACTC CAM+A64H
typedef struct {
        FIELD ANR2_ACT_TH_C             : 8;
        FIELD ANR2_ACT_BLD_BASE_C       : 7;
        FIELD rsv_15                    : 1;
        FIELD ANR2_ACT_SLANT_C          : 5;
        FIELD rsv_21                    : 3;
        FIELD ANR2_ACT_BLD_TH_C         : 7;
        FIELD rsv_31                    : 1;
} ISP_DIP_X_ANR2_ACTC_T;
...
typedef struct {
		FIELD ANR2_RSV1					: 32;
} ISP_DIP_X_ANR2_RSV1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_ANR2_RSV1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR2_RSV1_T;

// DIP_X_ANR2_RSV2 
typedef struct {
		FIELD ANR2_RSV2					: 32;
} ISP_DIP_X_ANR2_RSV2_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_ANR2_RSV2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_ANR2_RSV2_T;
