...
#define NVRAM_DBS_TBL_NUM               (940)
#define NVRAM_OBC_TBL_NUM               (188)
#define NVRAM_BPC_TBL_NUM               (940)
#define NVRAM_NR1_TBL_NUM               (940)
#define NVRAM_PDC_TBL_NUM               (940)
#define NVRAM_RMM_TBL_NUM               (200)
#define NVRAM_RNR_TBL_NUM               (940)
#define NVRAM_SL2_TBL_NUM               (50)
#define NVRAM_UDM_TBL_NUM               (1160)
#define NVRAM_GGM_TBL_NUM               (5)
#define NVRAM_IHDR_GGM_TBL_NUM          (16)
#define NVRAM_ANR_TBL_NUM               (1360)
#define NVRAM_ANR2_TBL_NUM              (1360)
#define NVRAM_CCR_TBL_NUM               (460)
#define NVRAM_BOK_TBL_NUM               (60)
#define NVRAM_HFG_TBL_NUM               (1240)
#define NVRAM_EE_TBL_NUM                (1340)
#define NVRAM_NR3D_TBL_NUM              (760)
#define NVRAM_MFB_TBL_NUM               (100)
#define NVRAM_MIXER3_TBL_NUM            (100)
...
static MUINT32 AFNVRAMMapping[AF_CAM_SCENARIO_NUM] = {
    ...
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW),   // HDR     (N/A)
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW),   // AUTO HDR(N/A)
    static_cast<MUINT32>(CAM_SCENARIO_CUSTOM3),   // VT      (binning-size vdo record)
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW)    // STEREO  (N/A)
};
...
typedef struct
{
    ...
    AF_NVRAM_T      rSCENARIONVRAM[AF_CAM_SCENARIO_NUM];
    UINT8 reserved[MAXIMUM_NVRAM_CAMERA_LENS_FILE_SIZE-sizeof(UINT32)-sizeof(FOCUS_RANGE_T)-sizeof(AF_NVRAM_T)-sizeof(PD_NVRAM_T)-sizeof(rDualCamNVRAM)-sizeof(AF_NVRAM_T)*AF_CAM_SCENARIO_NUM];
...
typedef union
{
    struct
    {
            short ispVer[4]; //main, sub, main2, sub2
            short aaaVer[4];
            short shadingVer[4];
            short lensVer[4];
            short aePlineVer[4];
...
{
    // MFLL/AIS (20 bytes, total: 20 bytes)
    ...
    // MEMC level map (44 bytes, total 132 bytes) , since MEMC v1.1
    ...
    // reserved space (479*4 = 1916 bytes)
    MUINT32 reserved[479];
