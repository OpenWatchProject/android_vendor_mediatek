...
#define NVRAM_CUSTOM_REVISION   6181001
...
typedef enum
{
    AE_NVRAM_IDX_NORMAL=0,
    AE_NVRAM_IDX_HDR_ON,
    AE_NVRAM_IDX_HDR_AUTO,
    AE_NVRAM_IDX_VT,
    AE_NVRAM_IDX_NUM
}AE_NVRAM_IDX_T;
...
typedef struct {
    MINT32 i4Enable;
    MINT32 i4SingleColorWeight;
    MINT32 i4ColorCheckerWeight;
    MINT32 i4SubWindowProcWeight;
    MINT32 Reserved1;
    MINT32 Reserved2;
    MINT32 Reserved3;
    MINT32 Reserved4;
    MINT32 Reserved5;
} AWB_CONFUSION_COLOR_COMP_T;

typedef struct {
    MINT32 i4Enable;
    MINT32 i4CompWeighting;
    MINT32 i4CompLimit;
    MINT32 Reserved1;
    MINT32 Reserved2;
    MINT32 Reserved3;
...
typedef struct {
    MINT32 i4Enable;
    MINT32 i4StatWinScaling[AWB_LIGHTSOURCE_NUM];
    MINT32 Reserved1;
    MINT32 Reserved2;
    MINT32 Reserved3;
    MINT32 Reserved4;
...
typedef struct {
    MINT32 i4Enable;
    MINT32 i4WeightingLUT[AWB_LUT_SIZE];
    AWB_GAIN_T rPreferenceGainLUT[AWB_LIGHTSOURCE_NUM][AWB_LUT_SIZE];
    MINT32 Reserved1;
    MINT32 Reserved2;
    MINT32 Reserved3;
    MINT32 Reserved4;
...
typedef struct {
    AWB_CONFUSION_COLOR_COMP_T  rConfusionColorComp;
...
typedef enum
{
    ...
    AWB_NVRAM_IDX_VT,
    AWB_NVRAM_IDX_NUM,
    CAM_SCENARIO_NUM = AWB_NVRAM_IDX_NUM
} AWB_NVRAM_IDX_T;
...
typedef struct
{
    ...
    //data content
    AE_NVRAM_T rAENVRAM[AE_NVRAM_IDX_NUM];
    ...
    UINT8 reserved[MAXIMUM_NVRAM_CAMERA_3A_FILE_SIZE-sizeof(UINT32)-sizeof(AE_NVRAM_T)*AE_NVRAM_IDX_NUM-sizeof(AWB_NVRAM_T)*CAM_SCENARIO_NUM-sizeof(FLASH_AWB_NVRAM_T)];
...
typedef enum
{
  NVRAM_FLASH_CHOOSE_WARM,
  NVRAM_FLASH_CHOOSE_COLD,
}ENVRAM_FLASH_CHOOSE_TYPE;
...
typedef struct
{
    ...
    ENVRAM_FLASH_CHOOSE_TYPE ChooseColdOrWarm;
...
#define NVRAM_DBS_TBL_NUM               (840)
#define NVRAM_OBC_TBL_NUM               (172)
#define NVRAM_BPC_TBL_NUM               (840)
#define NVRAM_NR1_TBL_NUM               (840)
#define NVRAM_PDC_TBL_NUM               (840)
#define NVRAM_RMM_TBL_NUM               (220)
#define NVRAM_RNR_TBL_NUM               (840)
#define NVRAM_SL2_TBL_NUM               (NVRAM_SUPPORT_SENSOR*SHADING_SUPPORT_CT_NUM)
#define NVRAM_UDM_TBL_NUM               (980)
#define NVRAM_CCM_TBL_NUM               (4)
#define NVRAM_GGM_TBL_NUM               (5)
#define NVRAM_IHDR_GGM_TBL_NUM          (16)
#define NVRAM_ANR_TBL_NUM               (1080)
#define NVRAM_ANR2_TBL_NUM              (1080)
#define NVRAM_CCR_TBL_NUM               (300)
//#define NVRAM_BOK_TBL_NUM               (100)
#define NVRAM_HFG_TBL_NUM               (1020)
#define NVRAM_EE_TBL_NUM                (1020)
//#define NVRAM_NR3D_TBL_NUM              (460)
#define NVRAM_MFB_TBL_NUM               (40)
#define NVRAM_MIXER3_TBL_NUM            (40)
//#define NVRAM_LCE_TBL_NUM               (630)
...
typedef struct {
    ...
    INT16 IDX_Part_Middle[NVRAM_ISP_REGS_ISO_SUPPORT_NUM];
} ISP_NVRAM_ISO_INTERVAL_STRUCT, *PISP_NVRAM_ISO_INTERVAL_STRUCT;
...
typedef struct
{
    ...
    //ISP_NVRAM_CCM_CTL_T         CCM_CFC[NVRAM_CCM_CFC_TBL_NUM];
...
typedef struct{
    MUINT32 uPCA_SAT_FLAT;    //(-127~127)
    MUINT32 uPCA_HUE_FLAT;    //(-127~127)
    MUINT32 uPCA_SAT_FLAT_STR;    //(0~16)
    MUINT32 uPCA_HUE_FLAT_STR;    //(0~16)
    MUINT32 uPCA_R_MIN;    //(0~64)
    MUINT32 u4PCA_LV_L;  //
    MUINT32 u4PCA_LV_H;  //
...
typedef union
{
    struct  {
        ...
        ISP_NVRAM_ISO_INTERVAL_STRUCT   ISO_Env;
        ...
        ISP_NVRAM_ANR_LUT_T             ANR_TBL[ANR_SUPPORT_CT_NUM][ANR_SUPPORT_ISO_NUM];
        ISP_NVRAM_PCA_PARAM_T           rPcaParam;
    };
...
//  Data.
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    inline ISP_NVRAM_SL2_T&         getSL2F() { return m_rRegs.SL2F[getIdx_SL2F()]; }
    inline ISP_NVRAM_DBS_T&         getDBS() { return m_rRegs.DBS[getIdx_DBS()]; }
    inline ISP_NVRAM_OBC_T&         getOBC() { return m_rRegs.OBC[getIdx_OBC()]; }
    inline ISP_NVRAM_BNR_BPC_T&         getBPC() { return m_rRegs.BNR_BPC[getIdx_BPC()]; }
    inline ISP_NVRAM_BNR_NR1_T&         getNR1() { return m_rRegs.BNR_NR1[getIdx_NR1()]; }
    inline ISP_NVRAM_BNR_PDC_T&         getPDC() { return m_rRegs.BNR_PDC[getIdx_PDC()]; }
    inline ISP_NVRAM_RMM_T&         getRMM()  { return m_rRegs.RMM[getIdx_RMM()]; }
    inline ISP_NVRAM_RNR_T&         getRNR()  { return m_rRegs.RNR[getIdx_RNR()]; }
    inline ISP_NVRAM_SL2_T&         getSL2() { return m_rRegs.SL2[getIdx_SL2()]; }
    inline ISP_NVRAM_UDM_T&         getUDM() { return m_rRegs.UDM[getIdx_UDM()]; }
    inline ISP_NVRAM_CCM_T&         getCCM() { return m_rRegs.CCM[getIdx_CCM()]; }
    //inline ISP_NVRAM_CCM_CTL_T&     getCCM_CFC()  { return m_rRegs.CCM_CFC[getIdx_CCM_CFC()]; }
    ...
    inline ISP_NVRAM_ANR2_T&        getANR2() { return m_rRegs.ANR2[getIdx_ANR2()]; }
    inline ISP_NVRAM_CCR_T&         getCCR() { return m_rRegs.CCR[getIdx_CCR()]; }
    //inline ISP_NVRAM_BOK_T&         getBOK() { return m_rRegs.BOK[getIdx_BOK()]; }
    inline ISP_NVRAM_HFG_T&          getHFG()  { return m_rRegs.HFG[getIdx_HFG()]; }
    ...
    inline ISP_NVRAM_MIXER3_T&      getMIX3()  { return m_rRegs.MIXER3[getIdx_MIX3()]; }
...
//____AF NVRAM____
#define AF_CAM_SCENARIO_NUM 0

// AF NVRAM Mapping Table by Scenario
static MUINT32 AFNVRAMMapping[7] = {
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW),   // PREVIEW
    static_cast<MUINT32>(CAM_SCENARIO_VIDEO),     // VIDEO
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW),   // CAPTURE
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW),   // HDR
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW),   // AUTO HDR
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW),   // VT
    static_cast<MUINT32>(CAM_SCENARIO_PREVIEW)    // STEREO
};
...
typedef struct
{
    ...
    UINT32          rSCENARIONVRAM[7];
    UINT8 reserved[MAXIMUM_NVRAM_CAMERA_LENS_FILE_SIZE-sizeof(UINT32)-sizeof(FOCUS_RANGE_T)-sizeof(AF_NVRAM_T)-sizeof(PD_NVRAM_T)-sizeof(rDualCamNVRAM)-sizeof(UINT32)*7];
...
typedef struct __attribute__((packed)) // maximum 64 bytes
{
    // MFLL/AIS (5 bytes, total: 5)
    ...
    // MFLL (2 bytes, total: 7)
    MUINT16 mfll_iso_th;                //default=800, range=0~65535, step=1

    // Adaptive frame number (22 bytes, total: 29)
    MUINT16 iso_level1;
    MUINT16 iso_level2;
    MUINT16 iso_level3;
    MUINT16 iso_level4;
