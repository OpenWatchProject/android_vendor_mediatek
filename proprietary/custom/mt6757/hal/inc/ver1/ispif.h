...
#define F_SL2FG_EN(fgOnOff)  ((fgOnOff) << F_SL2FG)
#define F_DBS_EN(fgOnOff)    ((fgOnOff) << F_DBS)
#define F_OBC_EN(fgOnOff)    ((fgOnOff) << F_OBC)
#define F_BPC_EN(fgOnOff)    ((fgOnOff) << F_BPC)
#define F_NR1_EN(fgOnOff)    ((fgOnOff) << F_NR1)
#define F_RMM_EN(fgOnOff)    ((fgOnOff) << F_RMM)
#define F_RMG_EN(fgOnOff)    ((fgOnOff) << F_RMG)
#define F_SL2H_EN(fgOnOff)   ((fgOnOff) << F_SL2H)
#define F_RNR_EN(fgOnOff)    ((fgOnOff) << F_RNR)
#define F_RPGN_EN(fgOnOff)   ((fgOnOff) << F_RPGN)
#define F_SL2_EN(fgOnOff)    ((fgOnOff) << F_SL2)
#define F_UDM_EN(fgOnOff)    ((fgOnOff) << F_UDM)
#define F_CCM_EN(fgOnOff)    ((fgOnOff) << F_CCM)
#define F_GGM_EN(fgOnOff)    ((fgOnOff) << F_GGM)
#define F_G2C_EN(fgOnOff)    ((fgOnOff) << F_G2C)
#define F_SL2B_EN(fgOnOff)   ((fgOnOff) << F_SL2B)
#define F_ANR_EN(fgOnOff)    ((fgOnOff) << F_ANR)
#define F_SL2C_EN(fgOnOff)   ((fgOnOff) << F_SL2C)
#define F_ANR2_EN(fgOnOff)   ((fgOnOff) << F_ANR2)
#define F_CCR_EN(fgOnOff)    ((fgOnOff) << F_CCR)
#define F_PCA_EN(fgOnOff)    ((fgOnOff) << F_PCA)
#define F_SL2I_EN(fgOnOff)   ((fgOnOff) << F_SL2I)
#define F_HFG_EN(fgOnOff)    ((fgOnOff) << F_HFG)
#define F_SL2D_EN(fgOnOff)   ((fgOnOff) << F_SL2D)
#define F_EE_EN(fgOnOff)     ((fgOnOff) << F_EE)
#define F_LCE_EN(fgOnOff)    ((fgOnOff) << F_LCE)
...
typedef union {
    ...
    struct {
        ...
        ISP_NVRAM_ANR2_Y4LUT1_T lut1;
        ISP_NVRAM_ANR2_Y4LUT2_T lut2;
        ISP_NVRAM_ANR2_Y4LUT3_T lut3;
		ISP_NVRAM_ANR2_L4LUT1_T llut1;
		ISP_NVRAM_ANR2_L4LUT2_T llut2;
		ISP_NVRAM_ANR2_L4LUT3_T llut3;
...
// DIP_X_NR3D_ON_CON CAM+CC0H
typedef struct {
    FIELD  NR3D_FB_BSTMT_THR                     :  3;
    FIELD  rsv_3                                 :  1;
    FIELD  NR3D_ON_EN                            :  1;
    FIELD  rsv_5                                 :  3;
    FIELD  NR3D_TILE_EDGE                        :  4;
    FIELD  NR3D_UV_INK_SEL                       :  1;
    FIELD  NR3D_YMT_INK_EN                       :  1;
    FIELD  NR3D_OVL_INK_EN                       :  1;
    FIELD  NR3D_UV_INK_EN                        :  1;
    FIELD  NR3D_WR_PV_FRM                        :  1;
    FIELD  rsv_17                                :  3;
    FIELD  NR3D_SL2_OFF                          :  1;
    FIELD  rsv_21                                : 11;
} ISP_DIP_X_NR3D_ON_CON_T;
...
typedef struct {
    ...
    FIELD  rsv_30                                :  2;
} ISP_DIP_X_NR3D_FBCNT_OFF_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_FBCNT_OFF_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_FBCNT_OFF_T;


//DIP_X_NR3D_FBCNT_SIZ
typedef struct {
    FIELD  rsv_0                                 :  1;
    ...
    FIELD  rsv_30                                :  2;
} ISP_DIP_X_NR3D_FBCNT_SIZ_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_FBCNT_SIZ_T reg_t;
    reg_t   bits;
    MUINT32 val;
...
//DIP_X_NR3D_FB_COUNT
typedef struct {
    FIELD  NR3D_FB_BSTMT_CNT                     : 28;
    FIELD  rsv_28                                :  4;
} ISP_DIP_X_NR3D_FB_COUNT_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_FB_COUNT_T reg_t;
    reg_t   bits;
    MUINT32 val;
...
//DIP_X_NR3D_AY_CON1
typedef struct {
    FIELD  NR3D_ALPHA_Y_X1                       :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_ALPHA_Y_X2                       :  6;
    FIELD  rsv_14                                :  2;
    FIELD  NR3D_ALPHA_Y_X3                       :  6;
    FIELD  rsv_22                                :  2;
    FIELD  NR3D_ALPHA_Y_X4                       :  6;
    FIELD  rsv_30                                :  2;
} ISP_DIP_X_NR3D_AY_CON1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AY_CON1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AY_CON1_T;


//DIP_X_NR3D_AY_CON2
typedef struct {
    FIELD  NR3D_ALPHA_Y_Y0                       :  5;
    FIELD  rsv_5                                 :  3;
    FIELD  NR3D_ALPHA_Y_Y1                       :  5;
    FIELD  rsv_13                                :  3;
    FIELD  NR3D_ALPHA_Y_Y2                       :  5;
    FIELD  rsv_21                                :  3;
    FIELD  NR3D_ALPHA_Y_Y3                       :  5;
    FIELD  rsv_29                                :  3;
} ISP_DIP_X_NR3D_AY_CON2_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AY_CON2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AY_CON2_T;



//DIP_X_NR3D_AY_CON3
typedef struct {
    FIELD  NR3D_ALPHA_Y_Y4                       :  5;
    FIELD  rsv_5                                 : 27;
} ISP_DIP_X_NR3D_AY_CON3_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AY_CON3_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AY_CON3_T;


//DIP_X_NR3D_AY_CON4
typedef struct {
    FIELD  NR3D_ALPHA_Y_S0                       :  9;
    FIELD  rsv_9                                 :  7;
    FIELD  NR3D_ALPHA_Y_S1                       :  9;
    FIELD  rsv_25                                :  7;
} ISP_DIP_X_NR3D_AY_CON4_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AY_CON4_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AY_CON4_T;


//DIP_X_NR3D_AY_CON5
typedef struct {
    FIELD  NR3D_ALPHA_Y_S2                       :  9;
    FIELD  rsv_9                                 :  7;
    FIELD  NR3D_ALPHA_Y_S3                       :  9;
    FIELD  rsv_25                                :  7;
} ISP_DIP_X_NR3D_AY_CON5_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AY_CON5_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AY_CON5_T;

//IP_X_NR3D_AC_CON1
typedef struct {
    FIELD  NR3D_ALPHA_C_X1                       :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_ALPHA_C_X2                       :  6;
    FIELD  rsv_14                                :  2;
    FIELD  NR3D_ALPHA_C_X3                       :  6;
    FIELD  rsv_22                                :  2;
    FIELD  NR3D_ALPHA_C_X4                       :  6;
    FIELD  rsv_30                                :  2;
} ISP_DIP_X_NR3D_AC_CON1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AC_CON1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AC_CON1_T;

//IP_X_NR3D_AC_CON2
typedef struct {
    FIELD  NR3D_ALPHA_C_Y0                       :  5;
    FIELD  rsv_5                                 :  3;
    FIELD  NR3D_ALPHA_C_Y1                       :  5;
    FIELD  rsv_13                                :  3;
    FIELD  NR3D_ALPHA_C_Y2                       :  5;
    FIELD  rsv_21                                :  3;
    FIELD  NR3D_ALPHA_C_Y3                       :  5;
    FIELD  rsv_29                                :  3;
} ISP_DIP_X_NR3D_AC_CON2_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AC_CON2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AC_CON2_T;

//IP_X_NR3D_AC_CON3
typedef struct {
    FIELD  NR3D_ALPHA_C_Y4                       :  5;
    FIELD  rsv_5                                 : 27;
} ISP_DIP_X_NR3D_AC_CON3_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AC_CON3_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AC_CON3_T;

//IP_X_NR3D_AC_CON4
typedef struct {
    FIELD  NR3D_ALPHA_C_S0                       :  9;
    FIELD  rsv_9                                 :  7;
    FIELD  NR3D_ALPHA_C_S1                       :  9;
    FIELD  rsv_25                                :  7;
} ISP_DIP_X_NR3D_AC_CON4_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AC_CON4_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AC_CON4_T;

//IP_X_NR3D_AC_CON5
typedef struct {
    FIELD  NR3D_ALPHA_C_S2                       :  9;
    FIELD  rsv_9                                 :  7;
    FIELD  NR3D_ALPHA_C_S3                       :  9;
    FIELD  rsv_25                                :  7;
} ISP_DIP_X_NR3D_AC_CON5_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_AC_CON5_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_AC_CON5_T;

//DIP_X_NR3D_B1Y_CON1
typedef struct {
    FIELD  NR3D_BETA1_Y_X1                       :  5;
    FIELD  rsv_5                                 :  3;
    FIELD  NR3D_BETA1_Y_X2                       :  5;
    FIELD  rsv_13                                :  3;
    FIELD  NR3D_BETA1_Y_X3                       :  5;
    FIELD  rsv_21                                :  3;
    FIELD  NR3D_BETA1_Y_X4                       :  5;
    FIELD  rsv_29                                :  3;
} ISP_DIP_X_NR3D_B1Y_CON1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_B1Y_CON1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_B1Y_CON1_T;

//DIP_X_NR3D_B1Y_CON2
typedef struct {
    FIELD  NR3D_BETA1_Y_Y1                       :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_BETA1_Y_Y2                       :  6;
    FIELD  rsv_14                                :  2;
    FIELD  NR3D_BETA1_Y_Y3                       :  6;
    FIELD  rsv_22                                :  2;
    FIELD  NR3D_BETA1_Y_Y4                       :  6;
    FIELD  rsv_30                                :  2;
} ISP_DIP_X_NR3D_B1Y_CON2_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_B1Y_CON2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_B1Y_CON2_T;


//DIP_X_NR3D_B1Y_CON3
typedef struct {
    FIELD  NR3D_BETA1_Y_S1                       :  7;
    FIELD  rsv_7                                 :  1;
    FIELD  NR3D_BETA1_Y_S2                       :  7;
    FIELD  rsv_15                                :  1;
    FIELD  NR3D_BETA1_Y_S3                       :  7;
    FIELD  rsv_23                                :  9;
} ISP_DIP_X_NR3D_B1Y_CON3_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_B1Y_CON3_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_B1Y_CON3_T;


//DIP_X_NR3D_B1C_CON1
typedef struct {
    FIELD  NR3D_BETA1_C_X1                       :  5;
    FIELD  rsv_5                                 :  3;
    FIELD  NR3D_BETA1_C_X2                       :  5;
    FIELD  rsv_13                                :  3;
    FIELD  NR3D_BETA1_C_X3                       :  5;
    FIELD  rsv_21                                :  3;
    FIELD  NR3D_BETA1_C_X4                       :  5;
    FIELD  rsv_29                                :  3;
} ISP_DIP_X_NR3D_B1C_CON1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_B1C_CON1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_B1C_CON1_T;


//DIP_X_NR3D_B1C_CON2
typedef struct {
    FIELD  NR3D_BETA1_C_Y1                       :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_BETA1_C_Y2                       :  6;
    FIELD  rsv_14                                :  2;
    FIELD  NR3D_BETA1_C_Y3                       :  6;
    FIELD  rsv_22                                :  2;
    FIELD  NR3D_BETA1_C_Y4                       :  6;
    FIELD  rsv_30                                :  2;
} ISP_DIP_X_NR3D_B1C_CON2_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_B1C_CON2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_B1C_CON2_T;



//DIP_X_NR3D_B1C_CON3
typedef struct {
    FIELD  NR3D_BETA1_C_S1                       :  7;
    FIELD  rsv_7                                 :  1;
    FIELD  NR3D_BETA1_C_S2                       :  7;
    FIELD  rsv_15                                :  1;
    FIELD  NR3D_BETA1_C_S3                       :  7;
    FIELD  rsv_23                                :  9;
} ISP_DIP_X_NR3D_B1C_CON3_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_B1C_CON3_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_B1C_CON3_T;

//DIP_X_NR3D_LSCG1_XCON
typedef struct {
    FIELD  NR3D_LSCG1_Y_X1                       :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_LSCG1_Y_X2                       :  6;
    FIELD  rsv_14                                :  2;
    FIELD  NR3D_LSCG1_Y_X3                       :  6;
    FIELD  rsv_22                                :  2;
    FIELD  NR3D_LSCG1_Y_X4                       :  6;
    FIELD  rsv_30                                :  2;
} ISP_DIP_X_NR3D_LSCG1_XCON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_LSCG1_XCON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_LSCG1_XCON_T;

//DIP_X_NR3D_LSCG1_YCON
typedef struct {
    FIELD  NR3D_LSCG1_Y_Y0                       :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_LSCG1_Y_Y1                       :  6;
    FIELD  rsv_14                                :  2;
    FIELD  NR3D_LSCG1_Y_Y2                       :  6;
    FIELD  rsv_22                                :  2;
    FIELD  NR3D_LSCG1_Y_Y3                       :  6;
    FIELD  rsv_30                                :  2;
} ISP_DIP_X_NR3D_LSCG1_YCON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_LSCG1_YCON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_LSCG1_YCON_T;


//DIP_X_NR3D_LSCG1_CON
typedef struct {
    FIELD  NR3D_LSCG1_Y_Y4                       :  6;
    FIELD  rsv_6                                 : 10;
    FIELD  NR3D_LSCG1_DLT_GAIN_Y                 :  4;
    FIELD  NR3D_LSCG1_DLT_GAIN_C                 :  4;
    FIELD  rsv_24                                :  8;
} ISP_DIP_X_NR3D_LSCG1_CON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_LSCG1_CON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_LSCG1_CON_T;


//DIP_X_NR3D_LSCG1_SCON
typedef struct {
    FIELD  NR3D_LSCG1_Y_S0                       :  8;
    FIELD  NR3D_LSCG1_Y_S1                       :  8;
    FIELD  NR3D_LSCG1_Y_S2                       :  8;
    FIELD  NR3D_LSCG1_Y_S3                       :  8;
} ISP_DIP_X_NR3D_LSCG1_SCON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_LSCG1_SCON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_LSCG1_SCON_T;

//DIP_X_NR3D_NLY_CON1
typedef struct {
    FIELD  NR3D_MPNL_Y_Y0                        :  4;
    FIELD  rsv_4                                 :  4;
    FIELD  NR3D_EPNL1_MAX_Y                      :  4;
    FIELD  NR3D_EPNL1_COR_Y                      :  3;
    FIELD  rsv_15                                :  1;
    FIELD  NR3D_EPNL2_MAX_Y                      :  4;
    FIELD  NR3D_EPNL2_COR_Y                      :  3;
    FIELD  rsv_23                                :  1;
    FIELD  NR3D_MPNL1_MAX_Y                      :  4;
    FIELD  NR3D_MPNL1_COR_Y                      :  3;
    FIELD  rsv_31                                :  1;
} ISP_DIP_X_NR3D_NLY_CON1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_NLY_CON1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_NLY_CON1_T;

//DIP_X_NR3D_NLY_CON2
typedef struct {
    FIELD  NR3D_MPNL2_MAX_Y                      :  4;
    FIELD  NR3D_MPNL2_COR_Y                      :  3;
    FIELD  rsv_7                                 :  1;
    FIELD  NR3D_MPNL3_MAX_Y                      :  3;
    FIELD  rsv_11                                :  1;
    FIELD  NR3D_MPNL4_MAX_Y                      :  4;
    FIELD  NR3D_PVAI1_GAIN_Y                     :  4;
    FIELD  NR3D_PVAR1_MIN_Y                      :  3;
    FIELD  rsv_23                                :  1;
    FIELD  NR3D_PVAR1_MAX_Y                      :  5;
    FIELD  rsv_29                                :  3;
} ISP_DIP_X_NR3D_NLY_CON2_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_NLY_CON2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_NLY_CON2_T;

//DIP_X_NR3D_MLY_CON
typedef struct {
    FIELD  NR3D_MTLVL_COR_Y                      :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_MTLVL_GAIN_Y                     :  4;
    FIELD  NR3D_MTLVL_VASEL_Y                    :  1;
    FIELD  NR3D_MTLVL_DFSEL_Y                    :  1;
    FIELD  rsv_14                                :  2;
    FIELD  NR3D_DDIF2_GPSEL_Y                    :  1;
    FIELD  rsv_17                                : 15;
} ISP_DIP_X_NR3D_MLY_CON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_MLY_CON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_MLY_CON_T;

//DIP_X_NR3D_NLC_CON1
typedef struct {
    FIELD  NR3D_MPNL_C_Y0                        :  4;
    FIELD  rsv_4                                 :  4;
    FIELD  NR3D_EPNL1_MAX_C                      :  4;
    FIELD  NR3D_EPNL1_COR_C                      :  3;
    FIELD  rsv_15                                :  1;
    FIELD  NR3D_EPNL2_MAX_C                      :  4;
    FIELD  NR3D_EPNL2_COR_C                      :  3;
    FIELD  rsv_23                                :  1;
    FIELD  NR3D_MPNL1_MAX_C                      :  4;
    FIELD  NR3D_MPNL1_COR_C                      :  3;
    FIELD  rsv_31                                :  1;
} ISP_DIP_X_NR3D_NLC_CON1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_NLC_CON1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_NLC_CON1_T;

//DIP_X_NR3D_NLC_CON2
typedef struct {
    FIELD  NR3D_MPNL2_MAX_C                      :  4;
    FIELD  NR3D_MPNL2_COR_C                      :  3;
    FIELD  rsv_7                                 :  1;
    FIELD  NR3D_MPNL3_MAX_C                      :  3;
    FIELD  rsv_11                                :  1;
    FIELD  NR3D_MPNL4_MAX_C                      :  4;
    FIELD  NR3D_PVAI1_GAIN_C                     :  4;
    FIELD  NR3D_PVAR1_MIN_C                      :  3;
    FIELD  rsv_23                                :  1;
    FIELD  NR3D_PVAR1_MAX_C                      :  5;
    FIELD  rsv_29                                :  3;
} ISP_DIP_X_NR3D_NLC_CON2_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_NLC_CON2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_NLC_CON2_T;

//DIP_X_NR3D_MLC_CON
typedef struct {
    FIELD  NR3D_MTLVL_COR_C                      :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_MTLVL_GAIN_C                     :  4;
    FIELD  rsv_12                                : 20;
} ISP_DIP_X_NR3D_MLC_CON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_MLC_CON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_MLC_CON_T;

//DIP_X_NR3D_SLY_CON
typedef struct {
    FIELD  NR3D_SVLVL_M1_LS1_Y                   :  1;
    FIELD  NR3D_SVLVL_M2_LS1_Y                   :  1;
    FIELD  NR3D_STLVL_M3_LS1_Y                   :  1;
    FIELD  rsv_3                                 :  5;
    FIELD  NR3D_SVLVL_M1_ADD_Y                   :  3;
    FIELD  rsv_11                                :  1;
    FIELD  NR3D_SVLVL_M1_MAX_Y                   :  4;
    FIELD  NR3D_SVLVL_M2_ADD_Y                   :  3;
    FIELD  rsv_19                                :  1;
    FIELD  NR3D_SVLVL_M2_MAX_Y                   :  4;
    FIELD  NR3D_STLVL_M3_ADD_Y                   :  3;
    FIELD  rsv_27                                :  1;
    FIELD  NR3D_STLVL_M3_MAX_Y                   :  4;
} ISP_DIP_X_NR3D_SLY_CON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_SLY_CON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_SLY_CON_T;

//DIP_X_NR3D_SLC_CON
typedef struct {
    FIELD  NR3D_SVLVL_M1_LS1_C                   :  1;
    FIELD  NR3D_SVLVL_M2_LS1_C                   :  1;
    FIELD  NR3D_STLVL_M3_LS1_C                   :  1;
    FIELD  rsv_3                                 :  5;
    FIELD  NR3D_SVLVL_M1_ADD_C                   :  3;
    FIELD  rsv_11                                :  1;
    FIELD  NR3D_SVLVL_M1_MAX_C                   :  4;
    FIELD  NR3D_SVLVL_M2_ADD_C                   :  3;
    FIELD  rsv_19                                :  1;
    FIELD  NR3D_SVLVL_M2_MAX_C                   :  4;
    FIELD  NR3D_STLVL_M3_ADD_C                   :  3;
    FIELD  rsv_27                                :  1;
    FIELD  NR3D_STLVL_M3_MAX_C                   :  4;
} ISP_DIP_X_NR3D_SLC_CON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_SLC_CON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_SLC_CON_T;

//DIP_X_NR3D_DIFG_CON
typedef struct {
    FIELD  NR3D_DDIF_GAIN_Y                      :  5;
    FIELD  rsv_5                                 :  3;
    FIELD  NR3D_DDIF_GAIN_C                      :  5;
    FIELD  rsv_13                                :  3;
    FIELD  NR3D_BDIF_GAIN_Y                      :  5;
    FIELD  rsv_21                                :  3;
    FIELD  NR3D_BDIF_GAIN_C                      :  5;
    FIELD  rsv_29                                :  3;
} ISP_DIP_X_NR3D_DIFG_CON_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_DIFG_CON_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_DIFG_CON_T;

//DIP_X_NR3D_YCJC_CON1
typedef struct {
    FIELD  NR3D_YCJC_TH1_Y                       :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_YCJC_TH3_Y                       :  6;
    FIELD  rsv_14                                :  2;
    FIELD  NR3D_YCJC_TH1_C                       :  6;
    FIELD  rsv_22                                :  2;
    FIELD  NR3D_YCJC_TH2_C                       :  5;
    FIELD  rsv_29                                :  3;
} ISP_DIP_X_NR3D_YCJC_CON1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_YCJC_CON1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_YCJC_CON1_T;

//DIP_X_NR3D_YCJC_CON2
typedef struct {
    FIELD  NR3D_YCJC_TH3_C                       :  6;
    FIELD  rsv_6                                 :  2;
    FIELD  NR3D_YCJC_GAIN_Y                      :  3;
    FIELD  rsv_11                                :  1;
    FIELD  NR3D_YCJC_GAIN_C                      :  3;
    FIELD  rsv_15                                :  1;
    FIELD  NR3D_YCJC_RS_Y                        :  2;
    FIELD  rsv_18                                :  2;
    FIELD  NR3D_YCJC_RS_C                        :  2;
    FIELD  rsv_22                                : 10;
} ISP_DIP_X_NR3D_YCJC_CON2_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_YCJC_CON2_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_YCJC_CON2_T;

//DIP_X_NR3D_SPARE0
typedef struct {
    FIELD  NR3D_SPARE_0                          : 32;
} ISP_DIP_X_NR3D_SPARE0_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_SPARE0_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_SPARE0_T;

//DIP_X_NR3D_SPARE1
typedef struct {
    FIELD  NR3D_SPARE_1                          : 32;
} ISP_DIP_X_NR3D_SPARE1_T;

typedef union {
    enum { MASK     = 0xFFFFFFFF };
    typedef ISP_DIP_X_NR3D_SPARE1_T reg_t;
    reg_t   bits;
    MUINT32 val;
} ISP_NVRAM_NR3D_SPARE1_T;
...
typedef union {
    ...
    struct {
        ...
        ISP_NVRAM_NR3D_AY_CON1_T  ay_con1;
        ISP_NVRAM_NR3D_AY_CON2_T  ay_con2;
        ISP_NVRAM_NR3D_AY_CON3_T  ay_con3;
        ISP_NVRAM_NR3D_AY_CON4_T  ay_con4;
        ISP_NVRAM_NR3D_AY_CON5_T  ay_con5;
        ISP_NVRAM_NR3D_AC_CON1_T  ac_con1;
        ISP_NVRAM_NR3D_AC_CON2_T  ac_con2;
        ISP_NVRAM_NR3D_AC_CON3_T  ac_con3;
        ISP_NVRAM_NR3D_AC_CON4_T  ac_con4;
        ISP_NVRAM_NR3D_AC_CON5_T  ac_con5;
        ISP_NVRAM_NR3D_B1Y_CON1_T  b1y_con1;
        ISP_NVRAM_NR3D_B1Y_CON2_T  b1y_con2;
        ISP_NVRAM_NR3D_B1Y_CON3_T  b1y_con3;
        ISP_NVRAM_NR3D_B1C_CON1_T  b1c_con1;
        ISP_NVRAM_NR3D_B1C_CON2_T  b1c_con2;
        ISP_NVRAM_NR3D_B1C_CON3_T  b1c_con3;
        ISP_NVRAM_NR3D_LSCG1_XCON_T  lscg1_xcon;
        ISP_NVRAM_NR3D_LSCG1_YCON_T  lscg1_ycon;
        ISP_NVRAM_NR3D_LSCG1_CON_T  lscg1_con;
        ISP_NVRAM_NR3D_LSCG1_SCON_T  lscg1_scon;
        ISP_NVRAM_NR3D_NLY_CON1_T  nly_con1;
        ISP_NVRAM_NR3D_NLY_CON2_T  nly_con2;
        ISP_NVRAM_NR3D_MLY_CON_T  mly_con;
        ISP_NVRAM_NR3D_NLC_CON1_T  nlc_con1;
        ISP_NVRAM_NR3D_NLC_CON2_T  nlc_con2;
        ISP_NVRAM_NR3D_MLC_CON_T  mlc_con;
        ISP_NVRAM_NR3D_SLY_CON_T  sly_con;
        ISP_NVRAM_NR3D_SLC_CON_T  slc_con;
        ISP_NVRAM_NR3D_DIFG_CON_T  difg_con;
        ISP_NVRAM_NR3D_YCJC_CON1_T  ycjc_con1;
        ISP_NVRAM_NR3D_YCJC_CON2_T  ycjc_con2;
        //ISP_NVRAM_NR3D_SPARE0_T  spare0;
        //ISP_NVRAM_NR3D_SPARE1_T  spare1;
    };
} ISP_NVRAM_NR3D_T;
