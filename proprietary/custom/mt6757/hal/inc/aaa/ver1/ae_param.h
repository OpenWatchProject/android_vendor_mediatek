...
#define AE_PARAM_REVISION 	6535010
...
#define AAO_SEP_AWB_SIZE_COEF  4       // AAO AWB size coefficient
...
typedef struct
{
	...
	MINT32  i4AutoDetectRatio;
    MINT32  i4AutoPvRatio;
    MINT32  i4AutoFinalRatio[SUPPORTED_MAX_HDR_EXPNUM - 1];     /* [0]: Ratio btw LongExp & ShortExp [1]: Ratio btw LongExp & VeryShortExp [2]: Ratio btw LongExp & Reserved */
    MINT32  i4AutoBrightLVProb;
    MINT32  i4AutoExposure[SUPPORTED_MAX_HDR_EXPNUM];           /* [0]: Long Exp [1]: Short Expo [2]: Very Ehort Expo [3]: Reserved */
    MINT32  i4AutoAfeGain[SUPPORTED_MAX_HDR_EXPNUM];            /* [0]: AfeGain for Long Exp [1]: AfeGain for Short Expo [2]: AfeGain for Very Short Expo [3]: Reserved */
    MINT32  i4AutoIspGain[SUPPORTED_MAX_HDR_EXPNUM];            /* [0]: IspGain for Long Exp [1]: IspGain for Short Expo [2]: IspGain for Very Short Expo [3]: Reserved */
    MINT32  i4AutoHdrFrom;
} HDR_AUTO_ENHANCE_INFO_T;

typedef struct {
	MINT32 i4NormalAETargetY;
	MINT32 i4DefHdrAETargetY;
	MINT32 i4AutoEVWeight;
	MINT32 i4AutoABLWeight;
    MINT32 i4AutoLVWeight;
	MINT32 i4AutoWeight;
	MINT32 i4CurrAoeY;
	MINT32 i4TargetAoeY;
...
typedef struct
{
    ...
    MINT32              i4HdrHistP0, i4HdrHistP1, i4HdrHistP2, i4HdrHistP3;
    MINT32              i4HdrHistW0, i4HdrHistW1, i4HdrHistW2, i4HdrHistW3;
...
typedef struct
{
    ...
    AE_TARGET_PROB_T		rAutoLVWeight;
...
typedef struct
{
    ...
    MINT32  i4RatioUnit[2];       // [0]:normal, [1]:motion
...
typedef struct {
	MINT32 i4RMGt;
	MINT32 i4RMGk;
    MINT32 i4HdrExposure[SUPPORTED_MAX_HDR_EXPNUM];         /* [0]: Long Exp [1]: Short Expo [2]: Very Ehort Expo [3]: Reserved */
    MINT32 i4HdrAfeGain[SUPPORTED_MAX_HDR_EXPNUM];          /* [0]: AfeGain for Long Exp [1]: AfeGain for Short Expo [2]: AfeGain for Very Short Expo [3]: Reserved */
    MINT32 i4HdrIspGain[SUPPORTED_MAX_HDR_EXPNUM];          /* [0]: IspGain for Long Exp [1]: IspGain for Short Expo [2]: IspGain for Very Short Expo [3]: Reserved */
    MINT32 i4HdrOnOff;
    MINT32 i4HdrRatio[SUPPORTED_MAX_HDR_EXPNUM - 1];        /* [0]: Ratio btw LongExp & ShortExp [1]: Ratio btw LongExp & VeryShortExp [2]: Ratio btw LongExp & Reserved */
