...
#define AF_PARAM_REVISION 6491001
...
typedef struct AREA_t
{
    ...
    AREA_t()
    {
        i4X=0; i4Y=0; i4W=0; i4H=0; i4Info=AF_MARK_NONE;
    }
    AREA_t( MINT32 i4X_, MINT32 i4Y_, MINT32 i4W_, MINT32 i4H_, MINT32 i4Info_)
    {
        i4X=i4X_; i4Y=i4Y_; i4W=i4W_; i4H=i4H_; i4Info=i4Info_;
    }
    AREA_t operator =(const AREA_t &in)
    {
        i4X=in.i4X; i4Y=in.i4Y; i4W=in.i4W; i4H=in.i4H; i4Info=in.i4Info;
        return (*this);
    }
} AREA_T;
...
typedef struct
{
    ...
    MINT64 TS_AFDone;           // (unit: us)    Time stamp of AFDone. (from Hal3A)
    MINT64 TS_MLStart;          // (unit: us)    Time stamp of start of move lens.
