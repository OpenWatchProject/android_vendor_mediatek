...
#define EPDBuf_Type_Open_MSK    0x10
#define EPDBuf_Type_DualPD_MSK  0x20
#define EPDBuf_Type_VC_MSK      0x01
#define EPDBuf_Type_Raw_MSK     0x02
#define EPDBuf_Type_PDO_MSK     0x04
typedef enum
{
    EPDBuf_NotDef       = 0x00,
    EPDBuf_VC           = 0x01,
