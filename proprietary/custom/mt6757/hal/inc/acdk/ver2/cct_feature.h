...
typedef enum
{
    ...
    ACDK_CCT_MCU_NAME_INIT, //for Cct get lens name use
    ACDK_CCT_MCU_NAME_UNINIT,//for Cct get lens name use
...
typedef enum {
    ACDK_AUTOMATION_START = ACDK_CCT_CDVT_END,
    ACDK_AUTOMATION_SET_INFO,
    ACDK_AUTOMATION_APPLY_ISP_PARAMS,
    ACDK_AUTOMATION_RUN,
    ACDK_AUTOMATION_END
} ACDK_AUTOMATION_ENUM;
...
{
    EIsp_Category_SL2F = 0,
    EIsp_Category_DBS,
    EIsp_Category_OBC,
    EIsp_Category_BNR_BPC,
    EIsp_Category_BNR_NR1,
    EIsp_Category_BNR_PDC,
    EIsp_Category_RMM,
    EIsp_Category_RNR,
    EIsp_Category_SL2,
    EIsp_Category_UDM,
...
{
    //ACDK_CCT_ISP_NVRAM_REG  stIspNvramRegs; //before RO_ME
    //new for RO_ME
    ACDK_CCT_ISP_REG_CATEGORY   eCategory;
...
{
    ACDK_CCT_CCM_STRUCT         ccm[ISP_NVRAM_DYNAMIC_CCM_NUM];
};
...
typedef struct
{
    ...
    char    pOutput[128];
       ...
       MUINT32 u4Height;
    MUINT32 u4JpegWidth;
       MUINT32 u4JpegHeight;
    MUINT32 u4Pixel;
    MBOOL   bUnpack2PackEn;
} AUTOMATION_IMAGE_INFO, *PAUTOMATION_IMAGE_INFO;

typedef struct
{
       ISP_NVRAM_CTL_EN_P1_T P1;
///       ISP_NVRAM_CTL_EN_P1_D_T P1_D;
       ISP_NVRAM_CTL_EN_P2_T P2;
} AUTOMATION_ISP_NVRAM_CTRL, *PAUTOMATION_ISP_NVRAM_CTRL;

typedef struct
{
       unsigned int    Buffer[4096];
} AUTOMATION_ISP_SHADING_TABLE, *PAUTOMATION_ISP_SHADING_TABLE;
#if 0
typedef struct
{
       ISP_NVRAM_DBS_T             DBS;
...
///       ISP_NVRAM_NSL2_T            NSL2;
       ...
       ISP_NVRAM_UDM_T             UDM;
       ISP_NVRAM_CCM_T             CCM;
       ISP_NVRAM_CCM_T             MDP_CCM;
       ISP_NVRAM_GGM_T             GGM;
       ISP_NVRAM_GGM_T             IHDR_GGM;
       ISP_NVRAM_G2C_T                         G2C;
       ISP_NVRAM_ANR_T             ANR;
       ISP_NVRAM_ANR2_T            ANR2;
       ISP_NVRAM_CCR_T             CCR;
///       ISP_NVRAM_BOK_T             BOK;
       ISP_NVRAM_EE_T              EE;
       ISP_NVRAM_SE_T                          SE;
///       ISP_NVRAM_NR3D_T            NR3D;
       ISP_NVRAM_MFB_T             MFB;
       ISP_NVRAM_LCE_T             LCE;
} AUTOMATION_ISP_NVRAM_REGISTER, *PAUTOMATION_ISP_NVRAM_REGISTER;

typedef struct
{
       AUTOMATION_ISP_NVRAM_CTRL       ISPCtrl;
    AUTOMATION_ISP_SHADING_TABLE    ISPShading;
       ISP_NVRAM_PCA_STRUCT            ISPPca;
       AUTOMATION_ISP_NVRAM_REGISTER   ISPRegs;
       ISP_NVRAM_MIXER3_T              ISPMfbMixer;
       ISP_NVRAM_MULTI_CCM_STRUCT      ISPMulitCCM;
       float                           ISPCCMRadio;
       MINT32                          InvokeSmoothCCM;
       ISP_NVRAM_DNG_METADATA_T        DngMetadata;
       ISP_NVRAM_ANR_TBL_T             ANR_TBL[ANR_HW_TBL_NUM];
} AUTOMATION_NVRAM_ISP_PARAM, *PAUTOMATION_NVRAM_ISP_PARAM;
#endif
