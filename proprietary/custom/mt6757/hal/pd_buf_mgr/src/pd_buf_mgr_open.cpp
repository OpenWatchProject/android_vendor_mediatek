...
MBOOL PDBufMgrOpen::SetDataBuf( MUINT32  i4Size, MUINT8 *ptrBuf, MUINT32 &i4FrmCnt)
{
    ...
    MBOOL bEnable = property_get_int32("vc.dump.enable", 0);
    if (bEnable)
    {
        char fileName[64];
...
{
    oPDOhwInfo.pu1Bpci_tbl     = NULL;
    oPDOhwInfo.phyAddrBpci_tbl = NULL;
    oPDOhwInfo.virAddrBpci_tbl = NULL;
...
MBOOL PDBufMgrOpen::sendCommand( MUINT32  i4Cmd, MVOID* arg1, MVOID* arg2)
{
    return MFALSE;
}
