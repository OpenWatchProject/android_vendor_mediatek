...
PDBuf_List_t PDList_main[MAX_SIZE_OF_PD_SENSOR_LIST] =
{
    ...
    {IMX258_SENSOR_ID,  (EPDBuf_VC | EPDBuf_PDO | EPDBuf_Raw)},
#endif
...
UINT32 GetPDBuf_Type( unsigned int a_u4CurrSensorDev, unsigned int a_u4CurrSensorId)
{
    ...
    {
        AAA_LOGD("ID 0x%04x, Type %x", ptrlist[i].SensorId, ptrlist[i].type);
