...
MBOOL PD_IMX258MIPIRAW::IsSupport( SPDProfile_t &iPdProfile)
{
    ...
    else if( iPdProfile.uSensorType==_IMX258_BINNING_TYPE_) //Binning type.
    {
    ...
    else if( iPdProfile.uSensorType==_IMX258_RAW_TYPE_) //Raw type.
    {
        if( iPdProfile.u4IsZSD!=0 )
        {
            ret = MTRUE;
    ...
    else if( iPdProfile.uSensorType==_IMX258_PURE_RAW_TYPE_) //Pure raw type.
    {
        if( iPdProfile.u4IsZSD!=0 )
        {
            ret = MTRUE;
