...
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
MBOOL SonyIMX338PdafLibraryWrapper::SetPDCLData( MUINT32 u4PDCLDaSz, MUINT8 *pPDCLDaBuf)
{
    MBOOL ret = MFALSE;
...
MBOOL SonyIMX338PdafLibraryWrapper::GetDefocus( SPDROIInput_T &iPDInputData, SPDROIResult_T &oPdOutputData)
{
    ...
    if( m_pfunGetDefocus && m_bLdDn && m_bInitDn)
    {
        ...
        WinAddr_I.sta.x = m_u8PDArea_XOffset + idxx*m_u8PDArea_Width; //iPDInputData.ROI.i4XStart;
        WinAddr_I.sta.y = m_u8PDArea_YOffset + idxy*m_u8PDArea_Height; //iPDInputData.ROI.i4YStart;
        WinAddr_I.end.x = m_u8PDArea_XOffset + (idxx+1)*m_u8PDArea_Width; //iPDInputData.ROI.i4XEnd;
        WinAddr_I.end.y = m_u8PDArea_YOffset + (idxy+1)*m_u8PDArea_Height; //iPDInputData.ROI.i4YEnd;
