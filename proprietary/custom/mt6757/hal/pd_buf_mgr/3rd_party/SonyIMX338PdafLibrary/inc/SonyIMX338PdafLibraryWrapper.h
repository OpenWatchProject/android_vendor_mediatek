#ifndef __SONY_IMX338_PDAF_LIBRARY_WRAPPER_H__
#define __SONY_IMX338_PDAF_LIBRARY_WRAPPER_H__
...
#define D_IMX338_ALL_PIXEL_SIZE_W (5344)
#define D_IMX338_ALL_PIXEL_SIZE_H (4016)

/* ============================================================
 * Define PD block number.
 * Please reference kernel driver setting of register of 0x31B0.
 * ============================================================ */
#define D_IMX338_PD_BLK_NUM_W (8)
#define D_IMX338_PD_BLK_NUM_H (6)
 ...
 * ============================================================ */
#define D_IMX338_DCC_IN_EEPROM_BLK_NUM_W (16)
#define D_IMX338_DCC_IN_EEPROM_BLK_NUM_H (12)
#define D_IMX338_DCC_IN_EEPROM_BLK_NUM_TOTAL (D_IMX338_DCC_IN_EEPROM_BLK_NUM_W*D_IMX338_DCC_IN_EEPROM_BLK_NUM_H)
 ...
 * ============================================================ */
#define D_IMX338_SLOPE_OFFSET_BLK_NUM_W (8)
#define D_IMX338_SLOPE_OFFSET_BLK_NUM_H (6)
#define D_IMX338_SLOPE_OFFSET_BLK_NUM_TOTAL (D_IMX338_SLOPE_OFFSET_BLK_NUM_W*D_IMX338_SLOPE_OFFSET_BLK_NUM_H)

#define D_IMX338_PD_AREA_OFFSET_X (112)
#define D_IMX338_PD_AREA_OFFSET_Y (88)
#define D_IMX338_PD_AREA_SIZE_X   ((D_IMX338_ALL_PIXEL_SIZE_W-2*D_IMX338_PD_AREA_OFFSET_X)/D_IMX338_SLOPE_OFFSET_BLK_NUM_W)
#define D_IMX338_PD_AREA_SIZE_Y   ((D_IMX338_ALL_PIXEL_SIZE_H-2*D_IMX338_PD_AREA_OFFSET_Y)/D_IMX338_SLOPE_OFFSET_BLK_NUM_H)

/* ============================================================
 *  Define OK/NG knot number.
 *  Define threshold line in each knot.
 * ============================================================ */
#define D_IMX338_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W (5)
#define D_IMX338_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H (5)
#define D_IMX338_DEFOCUS_OKNG_THR_LINE_BLK_NUM_TOTAL (D_IMX338_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W*D_IMX338_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H)
#define D_IMX338_DEFOCUS_OKNG_THR_LINE_ONE_BLK_POINT_NUM (2)
 ...
 * ============================================================ */
#define D_IMX338_AF_MOTOR_DRV_CONT_CODE_RESOLUTION (10)
#define D_IMX338_EXTRA_SHIFT_BIT (10-D_IMX338_AF_MOTOR_DRV_CONT_CODE_RESOLUTION)

class SonyIMX338PdafLibraryWrapper
{
private :
    /* ============================================================
     *  Operations.
    ...
    SonyIMX338PdafLibraryWrapper( SonyIMX338PdafLibraryWrapper const&);

    // Copy-assignment operator is disallowed.
    SonyIMX338PdafLibraryWrapper& operator=( SonyIMX338PdafLibraryWrapper const&);
    ...
    signed long    m_aData_Slope[D_IMX338_SLOPE_OFFSET_BLK_NUM_TOTAL]; // DCC
    signed long    m_aData_Offset[D_IMX338_SLOPE_OFFSET_BLK_NUM_TOTAL];
    unsigned short m_aXAddress_Knot_Slope_Offset[D_IMX338_SLOPE_OFFSET_BLK_NUM_W];
    unsigned short m_aYAddress_Knot_Slope_Offset[D_IMX338_SLOPE_OFFSET_BLK_NUM_H];
    ...
    unsigned short  m_aXAddress_Knot_DefocusOKNG[D_IMX338_DEFOCUS_OKNG_THR_LINE_BLK_NUM_W];
    unsigned short  m_aYAddress_Knot_DefocusOKNG[D_IMX338_DEFOCUS_OKNG_THR_LINE_BLK_NUM_H];
...
public:
    ...
    MBOOL SetPDCLData( MUINT32 u4PDCLDaSz, MUINT8 *pPDCLDaBuf);
...
#endif //__SONY_IMX338_PDAF_LIBRARY_WRAPPER_H__
