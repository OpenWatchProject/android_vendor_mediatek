...
MVOID IspTuningCustom::userSetting_EE(
	...
	MINT32	LOCK_EE_CLIP	= rEE.clip_ctrl_2.bits.SEEE_RESP_CLIP;		// 0~255
	...
	rEE.clip_ctrl_2.bits.SEEE_RESP_CLIP		= static_cast<MUINT32>(USM_CLIP);
...
)
{
    ...
    // Write back: SE
    rSE.edge_ctrl.bits.SEEE_OUT_EDGE_SEL = SE_EDGE;
