...
#define AWB_PARAM_TUNING_NUM	6221001
    ...
    static AWB_PARAM_T rAWBParam =
    {
    	    	...
    	    	// AWB gain prediction parameter
    	{
            {   
                ...
                // Tungsten
        		{
        			20, // i4IntermediateSceneLvThr_L2
        		...
        		{
        			20, // i4IntermediateSceneLvThr_L2
                    75, // i4IntermediateSceneLvThr_H2
        			0,      // i4DaylightLocusLvThr_L: useless
                    0       // i4DaylightLocusLvThr_H: useless
        		},
                // CWF
        		{
        			20, //110, //100,    // i4IntermediateSceneLvThr_L2
                    75, //150, //140,    // i4IntermediateSceneLvThr_H2
        			0,      // i4DaylightLocusLvThr_L: useless
                    0       // i4DaylightLocusLvThr_H: useless
        		},
                // Daylight
        		{
        			20, //130, //120,    // i4IntermediateSceneLvThr_L2
                    150, //160,    // i4IntermediateSceneLvThr_H2
        			0,      // i4DaylightLocusLvThr_L: useless
                    0       // i4DaylightLocusLvThr_H: useless
        		},
                // Shade
        		{
        			20, //110, //100,    // i4IntermediateSceneLvThr_L2
                    150, //140, //130,    // i4IntermediateSceneLvThr_H2
        			50,     // i4DaylightLocusLvThr_L
                    100     // i4DaylightLocusLvThr_H
        		},
        		...
        		{
        			20, //110, //100,    // i4IntermediateSceneLvThr_L2
                    150, //150, //140 ,   // i4IntermediateSceneLvThr_H2
        			0,      // i4DaylightLocusLvThr_L: useless
                    0       // i4DaylightLocusLvThr_H: useless
        		}
            }
