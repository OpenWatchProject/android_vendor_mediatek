...
int get_3dnr_iso_enable_threshold_low(void)
{
    ...
    unsigned int i4TempInputValue = ::property_get_int32("camera.3dnr.lowiso", 0);
...
int get_3dnr_iso_enable_threshold_high(void)
{
    ...
    unsigned int i4TempInputValue = ::property_get_int32("camera.3dnr.highiso", 0);
...
int get_3dnr_max_iso_increase_percentage(void)
{
    ...
    unsigned int i4TempInputValue = ::property_get_int32("camera.3dnr.forceisolimit", 0);
...
int get_3dnr_gmv_threshold(int force3DNR)
{
    ...
    if (force3DNR)
    {
        i4GmvThreshold = ::property_get_int32("debug.3dnr.gmv.threshold", NR3D_GMV_THRESHOLD);
    }
...
MINT32 NR3DCustom::get_3dnr_off_iso_threshold(MUINT8 ispProfile, MBOOL useAdbValue)
{
    ...
    if (useAdbValue)
    {
        ...
        i4IsoThreshold = ::property_get_int32("debug.3dnr.iso.threshold", i4IsoThreshold);
    }
