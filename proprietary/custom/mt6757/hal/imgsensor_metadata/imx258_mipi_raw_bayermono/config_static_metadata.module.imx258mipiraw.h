...
STATIC_METADATA2_BEGIN(PLATFORM, MODULE, SENSOR_DRVNAME_IMX258_MIPI_RAW_bayermono)
//------------------------------------------------------------------------------
//  android.control
//------------------------------------------------------------------------------
    //==========================================================================
    ...
    CONFIG_METADATA_END()
    //========================================================================== WK17.08 add
    CONFIG_METADATA_BEGIN(MTK_CONTROL_AE_LOCK_AVAILABLE)//WK17.08 add
    ...
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_CONTROL_AWB_LOCK_AVAILABLE)//WK17.08 add
    ...
    CONFIG_METADATA_END()
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_CONTROL_POST_RAW_SENSITIVITY_BOOST_RANGE)//WK17.08 add
...
//------------------------------------------------------------------------------
    //==========================================================================
    CONFIG_METADATA_BEGIN(MTK_STATISTICS_INFO_AVAILABLE_LENS_SHADING_MAP_MODES) //WK17.08 add
...
STATIC_METADATA2_BEGIN(PLATFORM, MOD_OVERWRITE, SENSOR_DRVNAME_IMX258_MIPI_RAW_bayermono)
