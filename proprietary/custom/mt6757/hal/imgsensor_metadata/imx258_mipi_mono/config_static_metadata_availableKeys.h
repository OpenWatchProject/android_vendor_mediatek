...
STATIC_METADATA2_BEGIN(PLATFORM, AVAILABLE_KEYS, SENSOR_DRVNAME_IMX258_MIPI_MONO)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)//new hidden
        ...
        CONFIG_ENTRY_VALUE(MTK_LENS_FACING, MINT32)
        ...
        CONFIG_ENTRY_VALUE(MTK_REQUEST_AVAILABLE_SESSION_KEYS, MINT32)
    ...
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_REQUEST_KEYS)
        ...
        APPEND_ENTRY_VALUE(MTK_FACE_FEATURE_ASD_MODE, MINT32)
#endif
#if MTKCAM_HAVE_FD_SUPPORT
        APPEND_ENTRY_VALUE(MTK_FACE_FEATURE_FORCE_FACE_3A, MINT32)
#endif
        // MFNR feature
        APPEND_ENTRY_VALUE(MTK_MFNR_FEATURE_MFB_MODE, MINT32)
        APPEND_ENTRY_VALUE(MTK_MFNR_FEATURE_AIS_MODE, MINT32)
        // 3DNR
        APPEND_ENTRY_VALUE(MTK_NR_FEATURE_3DNR_MODE, MINT32)
        // CSHOT
        APPEND_ENTRY_VALUE(MTK_CSHOT_FEATURE_CAPTURE, MINT32)
        // init request
        APPEND_ENTRY_VALUE(MTK_CONFIGURE_SETTING_INIT_REQUEST, MINT32)
        // fast s2s
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_EARLY_NOTIFICATION_TRIGGER, MINT32)
        // postview
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_POSTVIEW_SIZE, MINT32)
        // bgservice prelease
        APPEND_ENTRY_VALUE(MTK_BGSERVICE_FEATURE_PRERELEASE, MINT32)
        APPEND_ENTRY_VALUE(MTK_BGSERVICE_FEATURE_IMAGEREADERID, MINT32)
        // 3A Feature(Move to constuctStaticMetadata)
        // jpeg flip
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_JPEG_FLIP_MODE, MINT32)
        // flash feature calibration enable
        APPEND_ENTRY_VALUE(MTK_FLASH_FEATURE_CALIBRATION_ENABLE, MINT32)
        // raw reprocessing hint
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_HINT_FOR_RAW_REPROCESS, MINT32)
        // isp tuning hint
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING, MINT32)
        // flash feature - customized torch duty
        APPEND_ENTRY_VALUE(MTK_FLASH_FEATURE_CUSTOMIZED_TORCH_DUTY, MINT32)
        // AE feature - customized ae PlineIndex
        APPEND_ENTRY_VALUE(MTK_3A_FEATURE_AE_PLINE_INDEX, MINT32)
        // AE feature - customized ae CustomPlineMode
        APPEND_ENTRY_VALUE(MTK_3A_FEATURE_AE_CUSTOM_PLINE_MODE, MINT32)

    APPEND_METADATA_END()
    //==========================================================================
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_RESULT_KEYS)
        // face feature
#if MTKCAM_HAVE_ASD_SUPPORT
        APPEND_ENTRY_VALUE(MTK_FACE_FEATURE_ASD_MODE, MINT32)
        APPEND_ENTRY_VALUE(MTK_FACE_FEATURE_ASD_RESULT, MINT32)
#endif
#if MTKCAM_HAVE_FD_SUPPORT
        APPEND_ENTRY_VALUE(MTK_FACE_FEATURE_FORCE_FACE_3A, MINT32)
#endif
        // MFNR feature
        APPEND_ENTRY_VALUE(MTK_MFNR_FEATURE_AIS_MODE, MINT32)
        APPEND_ENTRY_VALUE(MTK_MFNR_FEATURE_AIS_RESULT, MINT32)
        APPEND_ENTRY_VALUE(MTK_MFNR_FEATURE_MFB_MODE, MINT32)
        APPEND_ENTRY_VALUE(MTK_MFNR_FEATURE_MFB_RESULT, MINT32)
        // 3DNR
        APPEND_ENTRY_VALUE(MTK_NR_FEATURE_3DNR_MODE, MINT32)
        // 3A FEATUR(Partially Move to constuctStaticMetadata)
        APPEND_ENTRY_VALUE(MTK_3A_FEATURE_AE_ROI, MINT32)
        APPEND_ENTRY_VALUE(MTK_3A_FEATURE_AF_ROI, MINT32)
        APPEND_ENTRY_VALUE(MTK_3A_FEATURE_AWB_ROI, MINT32)
        APPEND_ENTRY_VALUE(MTK_3A_FEATURE_AE_SENSOR_GAIN_VALUE, MINT32)
        APPEND_ENTRY_VALUE(MTK_3A_FEATURE_AE_ISP_GAIN_VALUE, MINT32)
        APPEND_ENTRY_VALUE(MTK_3A_FEATURE_AE_LUX_INDEX_VALUE, MINT32)
        // fast s2s
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_NEXT_READY, MINT32)
        // flash feature - calibration result
        APPEND_ENTRY_VALUE(MTK_FLASH_FEATURE_CALIBRATION_RESULT, MINT32)
        // flash feature - customization result
        APPEND_ENTRY_VALUE(MTK_FLASH_FEATURE_CUSTOMIZED_RESULT, MINT32)
        // raw reprocessing hint
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_HINT_FOR_RAW_REPROCESS, MINT32)
        // isp tuning hint
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_HINT_FOR_ISP_TUNING, MINT32)
    APPEND_METADATA_END()
    //==========================================================================
    APPEND_METADATA_BEGIN(MTK_REQUEST_AVAILABLE_CHARACTERISTICS_KEYS)
        // face feature
#if MTKCAM_HAVE_ASD_SUPPORT
        APPEND_ENTRY_VALUE(MTK_FACE_FEATURE_AVAILABLE_ASD_MODES, MINT32)
#endif
#if MTKCAM_HAVE_FD_SUPPORT
        APPEND_ENTRY_VALUE(MTK_FACE_FEATURE_AVAILABLE_FORCE_FACE_3A, MINT32)
#endif
        // MFNR feature
        APPEND_ENTRY_VALUE(MTK_MFNR_FEATURE_AVAILABLE_MFB_MODES, MINT32)
        APPEND_ENTRY_VALUE(MTK_MFNR_FEATURE_AVAILABLE_AIS_MODES, MINT32)
        // 3DNR
        APPEND_ENTRY_VALUE(MTK_NR_FEATURE_AVAILABLE_3DNR_MODES, MINT32)
        // CSHOT
        APPEND_ENTRY_VALUE(MTK_CSHOT_FEATURE_AVAILABLE_MODES, MINT32)
        // fast s2s
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_EARLY_NOTIFICATION_SUPPORT, MINT32)
        // postview
        APPEND_ENTRY_VALUE(MTK_CONTROL_CAPTURE_AVAILABLE_POSTVIEW_MODES, MINT32)
        // bgservice prerelease
        APPEND_ENTRY_VALUE(MTK_BGSERVICE_FEATURE_PRERELEASE_AVAILABLE_MODES, MINT32)
        // flash feature - calibration available
        APPEND_ENTRY_VALUE(MTK_FLASH_FEATURE_CALIBRATION_AVAILABLE, MINT32)
        // flash feature - customization available
        APPEND_ENTRY_VALUE(MTK_FLASH_FEATURE_CUSTOMIZATION_AVAILABLE, MINT32)
    APPEND_METADATA_END()
    //==========================================================================
...
#ifdef EIS_SUPPORTED
        CONFIG_ENTRY_VALUE(MTK_EIS_FEATURE_EIS_MODE, MINT32)
        CONFIG_ENTRY_VALUE(MTK_EIS_FEATURE_PREVIEW_EIS, MINT32)
#endif
        //bgservice prerelease
