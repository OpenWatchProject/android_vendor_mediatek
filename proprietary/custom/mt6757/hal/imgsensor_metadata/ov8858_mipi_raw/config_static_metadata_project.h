...
STATIC_METADATA2_BEGIN(PLATFORM, PROJECT, SENSOR_DRVNAME_OV8858_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    //==========================================================================
...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS)
                ...
                CONFIG_ENTRY_VALUE(50000000, MINT64) //min frame duration
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64) //2mp 16:9
                CONFIG_ENTRY_VALUE(1920, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_BLOB, MINT64) //1mp 16:9
                CONFIG_ENTRY_VALUE(1280, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64) //4mp 16:9
                CONFIG_ENTRY_VALUE(2560, MINT64)
                CONFIG_ENTRY_VALUE(1440, MINT64)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT64)
                CONFIG_ENTRY_VALUE(33333333, MINT64)
                ...
                CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64) //2mp 16:9
                CONFIG_ENTRY_VALUE(1920, MINT64)
                CONFIG_ENTRY_VALUE(1440, MINT64)
                CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT64)
                CONFIG_ENTRY_VALUE(33333333, MINT64)
...
STATIC_METADATA2_BEGIN(PLATFORM, PRO_OVERWRITE, SENSOR_DRVNAME_OV8858_MIPI_RAW)
