...
UINT32 DoCamCal2AGainOP(INT32 CamcamFID, UINT32 start_addr, UINT32 BlockSize, UINT32* pGetSensorCalData)
{
    ...
    UINT16 AFInf, AFMacro, AFMid;
    UINT16 tempMin = 255, tempMax = 0;
    UINT16 tempGain=1, CalR=1, CalGr=1, CalGb=1, CalG=1, CalB=1, FacR=1, FacGr=1, FacGb=1, FacG=1, FacB=1;
...
{/* dump all EEPROM info */
    ...
    int m_bDebugEnable = property_get_int32("debug.eeprom.enable", 0);
