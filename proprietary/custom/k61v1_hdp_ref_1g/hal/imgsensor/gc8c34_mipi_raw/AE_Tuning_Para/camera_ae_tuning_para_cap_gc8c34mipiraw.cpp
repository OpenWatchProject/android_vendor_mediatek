...
#include "camera_ae_tuning_para_gc8c34mipiraw.h"

template <>
AE_NVRAM_T const&
getAENVRAM_gc8c34mipiraw<CAM_SCENARIO_CAPTURE>() // CAPTURE
{
    // rDevicesInfo
    ...
    static AE_CCT_CFG_T  g_rCCTConfig =
    {
        ...
        //rMeteringSpec
        {
            //rHS_Spec
            {
                    ...
                    768,//1024,//u4HistStretchWeight          // Histogram weighting value
                    20,//u4Pcent                      // 1%=10, 0~1000
                    176,//120,//160, //166,//176,//u4Thd                        // 0~255
