...
//
//==============================================================================
//ITD:modify by camera tuning team start
...
FLASH_PROJECT_PARA& cust_getFlashProjectPara_sub (int aeScene, int isForceFlash, NVRAM_CAMERA_STROBE_STRUCT* nvrame)
{
	...
	para.coolTimeOutPara.coolingTM[1]=2;
	...
	para.coolTimeOutPara.timOutMs[1]=300;//ENUM_FLASH_TIME_NO_TIME_OUT;
...
#endif
//ITD:modify by camera tuning team end
