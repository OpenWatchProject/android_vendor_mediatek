...
/*              #if (1 == LOMO_SUPPORTED) //Temp marked out for Gerrit Check FO
    ...
    FTABLE_CONFIG_AS_TYPE_OF_USER(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_USER_LIST_(
                ...
                "(24000,24000)", 
                "(30000,30000)",
/*  #if (1 == SLOW_MOTION_VIDEO_SUPPORTED) //Temp marked out for Gerrit Check FO
                "(60000,60000)",
                "(120000,120000)",
#endif
*/
...
/*                 #if (1 == MOTION_TRACK_SUPPORTED) //Temp marked out for Gerrit Check FO
    ...
    else
    {
        ...
        SCENE_AS_DEFAULT_SCENE(
               ...
               ITEM_AS_VALUES_(
                   ...
                   MtkCameraParameters::CAPTURE_MODE_SMILE_SHOT, 
                   MtkCameraParameters::CAPTURE_MODE_BEST_SHOT,
/*                 #if (1 == AUTORAMA_SUPPORTED) //Temp marked out for Gerrit Check FO
                   MtkCameraParameters::CAPTURE_MODE_AUTO_PANORAMA_SHOT, 
                   #endif
*/
/*                 #if (1 == MAV_SUPPORTED) //Temp marked out for Gerrit Check FO
...
*/
    ...
    //==========================================================================    
    //  Video Face Beauty
/*  #if (1 == VIDEO_FACEBEAUTY_SUPPORTED) //Temp marked out for Gerrit Check FO
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_SUPPORTED(
