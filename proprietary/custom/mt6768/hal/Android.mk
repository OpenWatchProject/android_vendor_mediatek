...
#####include only CUSTOM_HAL_IMGSENSOR without module id
all_sensor_modules := $(addsuffix _tuning,$(notdir $(foreach f,$(CUSTOM_HAL_IMGSENSOR),$(wildcard vendor/mediatek/proprietary/custom/mt6768/hal/imgsensor/ver1/$(f)*))))
all_sensor_idxMgr := $(addsuffix _IdxMgr,$(notdir $(foreach f,$(CUSTOM_HAL_IMGSENSOR),$(wildcard vendor/mediatek/proprietary/custom/mt6768/hal/imgsensor/ver1/$(f)*))))

$(info all sensor modules = $(all_sensor_modules))
#-----------------------------------------------------------
