...
STATIC_METADATA2_BEGIN(PLATFORM, LENS, SENSOR_DRVNAME_IMX386_MIPI_RAW_bayermono)
//------------------------------------------------------------------------------
//  android.lens.info
//------------------------------------------------------------------------------
    //==========================================================================
...
//    )
    ...
    CONFIG_METADATA_BEGIN(MTK_LENS_INTRINSIC_CALIBRATION)
        CONFIG_ENTRY_VALUE(3876.767170, MFLOAT)
        CONFIG_ENTRY_VALUE(3876.767170, MFLOAT)
        CONFIG_ENTRY_VALUE(2016, MFLOAT)
        CONFIG_ENTRY_VALUE(1508, MFLOAT)
        CONFIG_ENTRY_VALUE(0, MFLOAT)
    CONFIG_METADATA_END()
    //==========================================================================
