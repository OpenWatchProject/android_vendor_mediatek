...
STATIC_METADATA2_BEGIN(PLATFORM, PROJECT, SENSOR_DRVNAME_S5K2T7SP_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    //==========================================================================
...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS)
        ...
        CONFIG_ENTRY_VALUE(5176, MINT64)
        CONFIG_ENTRY_VALUE(3880, MINT64)
        ...
        CONFIG_ENTRY_VALUE(66666666, MINT64)    //Stall_Durations

        CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64) //16mp 4:3
        CONFIG_ENTRY_VALUE(5176, MINT64)
        CONFIG_ENTRY_VALUE(3880, MINT64)
        CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT64)
        CONFIG_ENTRY_VALUE(100000000, MINT64)    //Frame_Duration
        ...
        CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT64)
        CONFIG_ENTRY_VALUE(33333333, MINT64)    //Frame_Duration
        CONFIG_ENTRY_VALUE(0       , MINT64)    //Stall_Durations
...
STATIC_METADATA2_BEGIN(PLATFORM, PRO_OVERWRITE, SENSOR_DRVNAME_S5K2T7SP_MIPI_RAW)
