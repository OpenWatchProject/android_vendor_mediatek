...
STATIC_METADATA2_BEGIN(PLATFORM, PROJECT, SENSOR_DRVNAME_IMX519_MIPI_RAW)
//------------------------------------------------------------------------------
//  android.request
//------------------------------------------------------------------------------
    //==========================================================================
...
//------------------------------------------------------------------------------
    ...
    CONFIG_METADATA_BEGIN(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_WITH_DURATIONS)
            ...
            CONFIG_ENTRY_VALUE(3480, MINT64)
            ...
            CONFIG_ENTRY_VALUE(4656, MINT64)
            CONFIG_ENTRY_VALUE(3496, MINT64)
            CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT64)
            CONFIG_ENTRY_VALUE(33333333, MINT64)        //Frame duration
            CONFIG_ENTRY_VALUE(33333333, MINT64)

            CONFIG_ENTRY_VALUE(HAL_PIXEL_FORMAT_YCbCr_420_888, MINT64) //16mp 16:9
            CONFIG_ENTRY_VALUE(4656, MINT64)
            CONFIG_ENTRY_VALUE(3496, MINT64)
            CONFIG_ENTRY_VALUE(MTK_SCALER_AVAILABLE_STREAM_CONFIGURATIONS_OUTPUT, MINT64)
...
STATIC_METADATA2_BEGIN(PLATFORM, PRO_OVERWRITE, SENSOR_DRVNAME_IMX519_MIPI_RAW)
