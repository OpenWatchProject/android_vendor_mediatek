...
LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTKCAM_INCLUDE_ALGO_PLATFORM)
...
LOCAL_EXPORT_C_INCLUDE_DIRS += $(TOP)/$(MTK_PATH_SOURCE)/hardware/libcamera_3a/liblce_lib/lib3a.lce/$(PLATFORM)/include
...
LOCAL_SRC_FILES += \
  ...
  ae_tuning_custom_default.cpp \
  ae_flow_custom.cpp \
  awb_tuning_custom_main4.cpp \
...
LOCAL_HEADER_LIBRARIES += libcutils_headers libsystem_headers libui_headers
