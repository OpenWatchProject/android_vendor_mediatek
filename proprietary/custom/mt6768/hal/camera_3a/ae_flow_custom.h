...
struct AE_EXP_SETTING_INPUT_T {
    MINT32 u4TargetExposureTime;   // us sec
    MINT32 u4TargetSensitivity;    //ISO value
    MINT32 u4OriExposureTime;
    MINT32 u4OriSensorGain;
    MINT32 u4OriISPGain;
    MINT32 u41xGainISOvalue;       // 1x gain iso value
    MINT32 u4MinSensorGain;        // Min sensor gain
...
struct AE_EXP_SETTING_OUTPUT_T {
    MBOOL  bOverSpec;
    MINT32 u4NewExposureTime;
    MINT32 u4NewSensorGain;
    MINT32 u4NewISPGain;
    MINT32 i4DeltaIndex;
};
