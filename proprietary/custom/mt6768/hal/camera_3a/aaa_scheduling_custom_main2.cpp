...
WorkPerCycle getWorkPerCycle_Main2_M1() //M = fps/30 = 1, -> 30 fps
{
    ...
    /*frameidx 1*/    {    1,   1,   1,   1,   1,   E_AE_AE_CALC|E_AE_FLARE|E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
        ...
        {
            {
                    //format:
    /*frameidx  */  //{  AAO, AWB,  AF, Flk, Lsc,   AE&Flare
    /*frameidx 1*/    {    1,   1,   1,   1,   1,   E_AE_FLARE|E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
        ...
        {
            {
                    //format:
    /*frameidx  */  //{  AAO, AWB,  AF, Flk, Lsc,   AE&Flare
    /*frameidx 1*/    {    1,   0,   1,   1,   0,   E_AE_AE_CALC|E_AE_FLARE|E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
    /*frameidx 2*/    {    0,   1,   0,   1,   1,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
...
WorkPerCycle getWorkPerCycle_Main2_M3() //M = fps/30 = 3, -> 90 fps
{
    ...
    /*frameidx 2*/    {    0,   0,   0,   0,   0,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
    /*frameidx 3*/    {    0,   0,   0,   0,   1,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
...
WorkPerCycle getWorkPerCycle_Main2_M4() //M = fps/30 = 4, -> 120 fps
{
    ...
    /*frameidx 2*/    {    0,   0,   0,   0,   0,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
    /*frameidx 3*/    {    0,   0,   0,   0,   1,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
    /*frameidx 4*/    {    0,   0,   0,   0,   0,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
...
WorkPerCycle getWorkPerCycle_Main2_M5() //M = fps/30 = 5, -> 150 fps
{
    ...
    /*frameidx 3*/    {    0,   0,   0,   0,   1,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
    /*frameidx 4*/    {    0,   0,   0,   0,   0,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
    /*frameidx 5*/    {    0,   0,   0,   0,   0,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
...
WorkPerCycle getWorkPerCycle_Main2_M6() //M = fps/30 = 6, -> 180 fps
{
    ...
    /*frameidx 4*/    {    0,   0,   0,   0,   0,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
    /*frameidx 5*/    {    0,   0,   0,   0,   0,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
    /*frameidx 6*/    {    0,   0,   0,   0,   0,   E_AE_AE_MASTER_APPLY|E_AE_AE_SLAVE_APPLY},
                    //the following part is "don't care"
            },
            3 //mValidFrameIdx, idx start from 1
        },
