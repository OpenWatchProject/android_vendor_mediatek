...
GET_DW9718SAF_LENS_PARA_DEFAULT_VALUE<CAM_SCENARIO_PREVIEW>()
{
    static NVRAM_LENS_DATA_PARA_STRUCT DW9718SAF_LENS_PARA_DEFAULT_VALUE =
    {
        ...
        // AF NVRAM
        {
            ...
            //============================================================================================/
            {
                ...
                //    effect: see [4]name: g_sum_change_num_high and [5]name: g_sum_change_num_low
                //------------------------------------------------------------------------------------/
                2300,   // [9] fv_change_up_ratio
                3,    // [10] fv_change_down_ratio
                0,     // [11] fv_change_num_high
                0,     // [12] fv_change_num_low
                ...
                //   effect: see [4]name: g_sum_change_num_high and [5]name: g_sum_change_num_low
                //------------------------------------------------------------------------------------/
                1000,     // [13]fv_stable_thr
                0,      // [14]fv_stable_num_high
                0,      // [15]fv_stable_num_low
                ...
                //   effect: see [4]name: g_sum_change_num_high and [5]name: g_sum_change_num_low
                //------------------------------------------------------------------------------------/
                400,     // [31]g_hist_change_thr
                2,       // [32]g_hist_change_num_high
                4,       // [33]g_hist_change_num_low
                ...
                //   effect: see [4]name: g_sum_change_num_high and [5]name: g_sum_change_num_low
                //------------------------------------------------------------------------------------/
                60700,//60900,     //[34]g_hist_stable_thr
                3,       //[35]g_hist_stable_num_high
            ...
            //====================================================================================/
            {
                ...
                //     effect:
                //--------------------------------------------------------------------------------/
                230200,//150100, //[18] pd_converge_threshold_inf [0223 : 30 -> 100 table_sz 100%, 0301 : rescle for AF table 150100 ->  200133]
                200153,//150100, //[19] pd_converge_threshold_mac [0301 : rescle for AF table 150100 ->  200133]
                ...
                100, //[23] pd_change_thr
                3,  //[24] pd_stable_frame
                15,  //[25] pd_stable_thr [0224 Jason C :  change to PD scene change 60->15]
                40,   //[26] pd_valid_confidence_chg
                40,   //[27] pd_valid_confidence_stb
                1,    //[28]
