 ...
 *
 ******************************************************************************/
FTABLE_DEFINITION(SENSOR_DRVNAME_IMX338_MIPI_RAW)
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
FTABLE_SCENE_INDEP()
    //==========================================================================
#if 1
...
//                MtkCameraParameters::EFFECT_F1977 ,
    ...
    //  For XTS: the largest preview-size must have same aspect ratio as the largest picture-size
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_PICTURE_SIZE),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("2560x1920"),
            ITEM_AS_VALUES_(
                "320x240",      "640x360",      "640x480",      "720x480",      "1024x768",     "1280x720",     "1280x960",
                "1600x1200",    "2048x1536",    "2560x1440",    "2560x1920",    "3264x2448",    "3328x1872",
                "2880x1728",    "3600x2160",    "5120x2880",    "5120x3840",    "5344x3008",    "5344x4016"
            )
        ),
    )
#endif
...
FTABLE_SCENE_DEP()
    ...
    //  EXPOSURE TIME
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_EXPOSURE_TIME),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("auto"),
            ITEM_AS_VALUES_(
                "auto",
    ...
    //  MAX EXPOSURE TIME
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_MAX_EXPOSURE_TIME),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_("16000"),
            ITEM_AS_VALUES_(
                "16000",
            )
        ),
    ...
    //  MANUAL CAP
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        KEY_AS_(MtkCameraParameters::KEY_MANUAL_CAP),
        SCENE_AS_DEFAULT_SCENE(
            ITEM_AS_DEFAULT_(MtkCameraParameters::OFF),
            ITEM_AS_VALUES_(
                MtkCameraParameters::OFF,
