...
LOCAL_CFLAGS += -DMTK_COUNT_FEATURE -DMTK_STATISTICS_FEATURE -DMTK_RENAME_FEATURE
LOCAL_CFLAGS += -DMTK_ROHC_FEATURE
LOCAL_SHARED_LIBRARIES += libssl libcrypto libpcap_bak liblog libcutils
