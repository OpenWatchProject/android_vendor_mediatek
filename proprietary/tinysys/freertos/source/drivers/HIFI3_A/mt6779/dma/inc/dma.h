...
#define NUMBER_DMA_ID           (NUMS_DMA_ID)
...
#define DMA_CON_BURST_MAXBEAT DMA_CON_BURST_16BEAT
...
#define DMA_BASE_CH(n)      (ADSP_DMA_BASE + 0x0100 * (n + 1))
#define DMA_GLOBAL_INT_FLAG (ADSP_DMA_BASE + 0x0000)
#define DMA_GLBSTA           ADSP_DMA_BASE
/*
