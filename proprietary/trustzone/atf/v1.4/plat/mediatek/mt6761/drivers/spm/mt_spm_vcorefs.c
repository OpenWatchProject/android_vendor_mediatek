...
{
	if (__spmfw_idx == SPMFW_LP4X_2CH_3200 || __spmfw_idx == SPMFW_LP4_2CH_3200
		|| __spmfw_idx == SPMFW_LP4_2CH_2400) {
		mmio_write_32(SPM_DVS_LEVEL, (0x1 << 18) | (0x1 << 3));
		mmio_write_32(SPM_DFS_LEVEL, (0x1 << 2));
		mmio_write_32(SPM_SW_RSV_9, (0x1 << 31) | (0x1 << 13));
	} else if (__spmfw_idx == SPMFW_LP3_1CH_1866) {
		mmio_write_32(SPM_DVS_LEVEL, (0x1 << 18) | (0x1 << 3));
		mmio_write_32(SPM_DFS_LEVEL, (0x1 << 2));
		mmio_write_32(SPM_SW_RSV_9, (0x1 << 31) | (0x1 << 13));
	}
...
static void spm_vcorefs_freq_hopping(__uint64_t gps_on)
{
	int i = 0;
