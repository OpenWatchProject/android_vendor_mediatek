 ...
 **************************************/
/* SPM_POWER_ON_VAL1 */
#define POWER_ON_VAL1_DEF	0x00815838
/* PCM_FSM_STA */
...
struct pwr_ctrl {
	...
	__uint8_t conn_srcclkena_sel_mask;
	...
	__uint8_t mcu_apsrc_req_mask_b;
	__uint8_t mcu_ddren_mask_b;
	...
	__uint8_t ddren2_md32_apsrc_req_mask_b;
...
enum dyna_load_pcm_index {
	DYNA_LOAD_PCM_SUSPEND_LP4_TERM_3200 = 0,
	DYNA_LOAD_PCM_SUSPEND_LP4_3200,
	DYNA_LOAD_PCM_SUSPEND_LP3_1866,
	DYNA_LOAD_PCM_SUSPEND_LP4_TERM_2400,
	DYNA_LOAD_PCM_MAX,
};
