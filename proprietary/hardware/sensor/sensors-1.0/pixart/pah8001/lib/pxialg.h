...
typedef enum {
	...
	_hr_speed_mode, // 1
	_support_cal_motion_idx_enhancement_enh, // 2
	_rsv1, // 3
	_set_switch_mems_fft_max_energy_th, // 4
	...
	_max_hr_idx_th, // 9
	_min_hr_idx_th, // 10
	_ppg_fft_total_peak_num_th, // 11
	_mems_large_energy_num_th, // 12
	_mems_fft_max_energy_th, // 13
	_support_signal_grade_motion_detection_enh, // 14
	_support_signal_grade_check_signal_lelvel_enh, // 15
	_support_signal_grade_large_energy_num_enh, // 16
	_rsv2, // 17
	_rsv3, // 18
	_set_reg_shake_count_th0, // 19
} PXI_PARAM_SET;
...
typedef enum {
	...
	_cal_motion_idx, // 2
	_is_prediction_hr, // 3
	_get_switch_mems_fft_max_energy_th, // 4
	...
	_ppg_fft_max_energy_idx, // 11
	_ppg_fft_total_peak_num, // 12
	_mems_large_energy_num, // 13
	_mems_fft_max_energy, // 14
	_grade, // 15
	_signal_grade_hr_to_low_frm, // 16
...
/**
 * @brief Call this funtion to get Switch_Motion_Flag
 *
 * @return Return Switch_Motion_Flag
 */
PXIALG_API unsigned char PxiAlg_GetSwitchMotionFlag(void);

/**
 * @brief Call this funtion to get Hr_Idx
 *
 * @return Return Hr_Idx
 */
PXIALG_API int PxiAlg_GetHrIdx(void);
...
PXIALG_API uint8_t PxiAlg_Set_HR_Smmoth_Parameter(float fValue);
...
#if defined(_WIN32) || (ANDROID_JNI == 1)
PXIALG_API uint8_t PxiAlg_Get_ParameterName2(uint32_t index, const char **param) ;
#endif
