...
typedef union
{
        struct
        {
                ...
                MBOOL   DynamicTwin      :  1;       //ON/OFF dynamic twin flow.
                MUINT32 force_clk_level  :  1;       // 1: force to highest level
                MUINT32 rsv              : 16;
        } Bits;
        MUINT32 Raw;
}CAMIO_Func;
...
public:
    ...
    virtual MBOOL   getCamRes(const CamResIn MeterIn) = 0;
