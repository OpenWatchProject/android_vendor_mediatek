...
public:
    ...
    virtual MBOOL   get_isExecutable(NormalPipe_InputInfo const ResDataIn, MBOOL &bIsExe);
    ...
    MBOOL           getEfuseInfo(MUINT32 &tg_sum);
    ...
    inline MINT64   getTimeStamp_ns_B(MUINT32 i4TimeStamp_sec_B, MUINT32 i4TimeStamp_us_B) const
    {
...
public:
    ...
    fp_EventCB                  m_SofCB;
    void*                       m_SofCBCookie;
    vector<MUINT32>             mLMagicNum;

    IMemDrv*                    mpIMem;
    IMEM_BUF_INFO               mImgHeaderPool;
    MUINT32                     mImgHeaderSize[MaxPortIdx];
...
private:
    ...
    MBOOL                   tuningUpdate(vector<MUINT32>* pLMagicNum, vector<MUINT32>* pLPortNum);
