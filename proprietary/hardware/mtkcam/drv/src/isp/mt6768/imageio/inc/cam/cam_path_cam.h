...
public:
            ...
            MINT32  setP1RrzCfg(vector<IspRrzCfg>* pRrz_cfg_L);
            MINT32  setP1ImgoCfg(vector<DMACfg>* pImgo_cfg_L);
            MINT32  setP1UfeoCfg(vector<DMACfg>* pUfeo_cfg_L);
            MINT32  setP1TuneCfg(vector<IspP1TuningCfg>* pTune_L);
            ...
            MINT32  dropEnqueueBuf(vector<MUINT32>* pLPortNum, vector<MUINT32>* pLMagicNum);
