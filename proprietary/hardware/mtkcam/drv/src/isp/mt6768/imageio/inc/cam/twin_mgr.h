 ...
 **************************************************************************/
struct TWIN_MGR_PATH_CFG_IN_PARAM
{
    // tg
    MBOOL               bypass_tg;
    ...
    MBOOL               bDbn;
    MBOOL               force_clk_level;    // 1: force to highest level
...
struct TWIN_MGR_PATH_CFG_OUT_PARAM
{
    // pixel mode of mux
    T_XMXO  xmxo;
...
public:
    ...
    //
    virtual MBOOL                   initTwin(DupCmdQMgr* pMainCmdQMgr,const NSImageio::NSIspio::PortID* pInput,MUINT32 subSample,vector<MUINT32>* pChannle) = 0;
