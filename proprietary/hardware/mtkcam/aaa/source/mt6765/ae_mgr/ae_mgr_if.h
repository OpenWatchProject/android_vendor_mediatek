...
public:
    ...
    */
    MRESULT updateCaptureParams(MINT32 i4SensorDev, AE_MODE_CFG_T &a_rCaptureInfo,MBOOL bRemosaicEn = MFALSE);
    /**
    ...
    */
    ...
    /**
     * @brief update AF info to AE algo
    */
    MRESULT UpdateAF2AEInfo(MINT32 i4SensorDev, AF2AEInfo_T &rAFInfo);
};
