...
MERROR_ENUM
Paramctrl::
setEnableSuperNightMode(MBOOL bEnable)
{
    if(m_bIsSuperNightMode!=bEnable)
    {
        CAM_LOGD_IF(m_bDebugEnable, "[setEnableSuperNightMode] (old, new)=(%d, %d)", m_bIsSuperNightMode, bEnable);
        m_bIsSuperNightMode=bEnable;
    }
    return  MERR_OK;
}
