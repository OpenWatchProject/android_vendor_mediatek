...
public:
    ...
    MRESULT updateAEInitIndex(MINT32 i4LV9Offset);
    ...
    MRESULT IsEISRecording(MBOOL bEISRecording);
    ...
    MRESULT getStereoDenoiseInfo(AE_MODE_CFG_T& strStereoDenoiseInfo);
    ...
    MRESULT IsHDRShot(MBOOL bHDRShot);
    ...
    MRESULT prepareCapParams(MBOOL bRemosaicEn=MFALSE, MBOOL bIsEVChange=MFALSE);
...
private:
    ...
    MRESULT updatePreviewParamsByzVHDR(strAEOutput *sAEInfo);
    ...
    MRESULT updateAECycleInfo();
    MRESULT updatePreEvSettingQueue(MUINT32 newExpsuretime,MUINT32 newAfegain,MUINT32 newIspGain);
    ...
    // AAO Separation
    MRESULT aaoTgSeparation(void* aao, int w, int h, void* ae);
    // CCU control
    MRESULT initCCU();
    MRESULT uninitCCU();
    MRESULT startCCU();
    ...
    // CCU Status
    MRESULT IsCCUStart();
    MRESULT IsCCUAEWorking();
    MRESULT IsCCUWorking();

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//  Data member
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
private:
    NSCcuIf::NSCcuDrv::ICcu* m_pICcu;
    ...
    IThread* m_pSensorGainThread;
    MBOOL m_bSGainThdFlg;
