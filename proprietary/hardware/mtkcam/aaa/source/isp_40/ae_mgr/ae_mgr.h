...
#define INIT_WOF_WAIT_CYCLE 2
#define PV_CWVY_FLOOR 30
#define PV_CWVY_CEILING 230

// Manual AE Pline control
#define AE_PLINE_EISRECORD 25       //g_AE_SceneTable9   (Manual)
#define AE_PLINE_SM240FPS 26        //g_AE_High_Fps_240  (Manual)
...
#define AE_PLINE_SM120FPS 37        //g_AE_High_Fps_120  (Manual TBD)
