...
{
    return AeMgr::getInstance(i4SensorDev).setRestore(frm);
}
...
{
    return AeMgr::getInstance(i4SensorDev).updatePreviewParams(a_rPreviewInfo,i4AEidxNext);
}
...
{
    return AeMgr::getInstance(i4SensorDev).enableAISManualPline(bAISPline);
}
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
{
    return AeMgr::getInstance(i4SensorDev).UpdateAF2AEInfo(rAFInfo);
}
