...
applyToHw_PerFrame_P2(MINT32 flowType, const RAWIspCamInfo& rIspCamInfo, void* pRegBuf)
{
    ...
    ::memset((void*)pReg, 0, sizeof(isp_reg_t));
...
prepareHw_PerFrame_PGN(const RAWIspCamInfo& rIspCamInfo, const IndexMgr& rIdx)
{
    ...
    MBOOL lockFlare = (rIspCamInfo.eToneMapMode == MTK_TONEMAP_MODE_CONTRAST_CURVE);
    ISP_MGR_PGN_T::getInstance(m_eSensorDev).lockFlare(lockFlare);
